...
<title>Báo cáo tùy chọn bsc gprs-cs</title>
<content tag="heading">Báo cáo tùy chọn bsc gprs-cs</content>
...
<%-- 		<div class="pageSize">
			...
			<display:table name="${optionBscGprsCsList}" class="simple2" id="item" export = "true" requestURI="" pagesize="100">
