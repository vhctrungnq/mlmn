...
<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<title>CELL GPRS-CS YEARLY REPORT</title>
<content tag="heading">CELL GPRS-CS YEARLY REPORT</content>
<ul class="ui-tabs-nav">
	...
	<li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio/cell-gprs-cs/yr/list.htm"><span>Báo cáo năm</span></a></li>
</ul>
		...
		<tr>
			<td align="left">
				...
				<fmt:message key="option.cellgprscs.region"/>
					...
					</select> &nbsp;CELL <input value="${cellid}" name="cellid" id="cellid"
						size="10"> &nbsp;Từ năm <input value="${startYear}" name="startYear"
						id="startYear" size="4" maxlength="4"> &nbsp;tới Năm <input value="${endYear}"
...
<div  style="overflow: auto;" class="tableStandar" id = "doublescroll">
	<display:table style = "width: 150%"  name="${vRpYrCellGprsCsList}" id="item" requestURI="" pagesize="100" class="simple2" export="true" sort="list">
	    ...
	    <display:column property="cellid" titleKey="CELL" sortable="true" sortName="bscid" headerClass="master-header-1"/>
