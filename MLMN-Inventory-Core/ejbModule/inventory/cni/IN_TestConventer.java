...
import inventory.converter.IsoPortNokiaRNCConverter;
import inventory.util.IN_Setting;
import inventory.util.IN_TestUtil;
...
public class IN_TestConventer {

    public IN_TestConventer() {
    ...
    public static void main(String[] args) {
        IN_TestConventer tconvert = new IN_TestConventer();
    ...
    private void doConvert() {
        IN_IConverter convert = new IsoPortNokiaRNCConverter();
        String fileName =
        ...
        param.put(IN_Setting.SEPARATOR_KEY, "\t");
        param.put(IN_Setting.COMMENT_CHAR_KEY, "#");
        param.put(IN_Setting.FILE_ID_KEY, "66666");
        param.put(IN_Setting.NODE_NAME_KEY, "none");
    ...
    private void testPattern() { 
        String p = "([A-Z, a-z, 0-9]{8}).([A-Z, a-z, 0-9]{3})";
        String fileName =
            "20140120.csv";

        IN_TestUtil.checkPattern(p, fileName);
    }
