...
<title>district gprs cs monthly report</title>
<content tag="heading">GPRS CS DISTRICT MONTHLY ${district}/${province}</content>
<ul class="ui-tabs-nav">
  ...
  <li class=""><a href="${pageContext.request.contextPath}/report/radio/district-gprs-cs/mn/details.htm?province=${province}&district=${district}&endMonth=${endMonth}&endYear=${endYear}"><span>Báo cáo tháng</span></a></li>
  ...
  <li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio/district-gprs-cs/mn/bhDetails.htm?province=${province}&district=${district}&endMonth=${endMonth}&endYear=${endYear}"><span>Báo cáo BH tháng</span></a></li>
</ul>
<div class="ui-tabs-panel">
	...
	<br/>
	<div  id="doublescroll">
<display:table name="${vRpMnDistrictGprsCsBhDetails}" id="vRpMnDistrictGprsCsBhDetail" requestURI="" pagesize="100" class="simple2" export="true">
	    ...
	    <display:column titleKey="PROVINCE" media="html">
	    	<a href="${pageContext.request.contextPath}/report/radio/province-gprs-cs/mn/bhDetails.htm?province=${vRpMnDistrictGprsCsBhDetail.province}&endMonth=${vRpMnDistrictGprsCsBhDetail.month}&endYear=${vRpMnDistrictGprsCsBhDetail.year}">${vRpMnDistrictGprsCsBhDetail.province}</a>&nbsp;
	    </display:column>
	    ...
	    <display:column titleKey="DISTRICT" media="html">
	    	<a href="${pageContext.request.contextPath}/report/radio/district-gprs-cs/mn/details.htm?province=${vRpMnDistrictGprsCsBhDetail.province}&district=${vRpMnDistrictGprsCsBhDetail.district}&endMonth=${vRpMnDistrictGprsCsBhDetail.month}&endYear=${vRpMnDistrictGprsCsBhDetail.year}">${vRpMnDistrictGprsCsBhDetail.district}</a>&nbsp;
	    </display:column>
	...
	$(function() {
		$( '.checkAll' ).live( 'change', function() {
			...
			if($( this ).is( ':checked' )){
				for (var i=8;i<=20;i++)
				{
					$('#vRpMnDistrictGprsCsBhDetail td:nth-child('+i+'),#vRpMnDistrictGprsCsBhDetail th:nth-child('+i+')').show();
				}
			} else {
				for (var i=8;i<=20;i++)
				{
					$('#vRpMnDistrictGprsCsBhDetail td:nth-child('+i+'),#vRpMnDistrictGprsCsBhDetail th:nth-child('+i+')').hide();
				}
			}
		});
