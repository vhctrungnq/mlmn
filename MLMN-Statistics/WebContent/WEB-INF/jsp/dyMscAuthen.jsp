...
<content tag="heading">MSC AUTHENCATION DAILY REPORT</content>
 
<ul class="ui-tabs-nav">
  <li class=""><a href="${pageContext.request.contextPath}/report/core-era/authen-cation/hr.htm?mscid=${msc.mscid}&startDate=${startDate}&endDate=${endDate}"><span>Báo cáo giờ</span></a></li>
  <li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/core-era/authen-cation/dy.htm?mscid=${msc.mscid}&startDate=${startDate}&endDate=${endDate}"><span>Báo cáo ngày</span></a></li>
</ul>
...
<div  id="doublescroll">
		<display:table name="${DyMscAUTH}" id="DyMscAUTH" requestURI="" pagesize="100" class="simple3" export="true">
			<display:column property="mscid" titleKey="SYSTEM" headerClass="hide" class="hide"/>		   
		    <display:column title="SYSTEM" media="html">
		   	 	<a href="${pageContext.request.contextPath}/report/core-era/authen-cation/hr.htm?mscid=${DyMscAUTH.mscid}&startDate=<fmt:formatDate pattern="dd/MM/yyyy" value="${DyMscAUTH.day}"/>&endDate=<fmt:formatDate pattern="dd/MM/yyyy" value="${DyMscAUTH.day}"/>">${DyMscAUTH.mscid}</a>
		    </display:column>
		    <display:column property ="day" format="{0,date,dd/MM/yyyy}" titleKey="Day" />
		    <display:column property="authReq" titleKey="Sent authentication request"/>
		    <display:column property="authCheckSucc" titleKey="Sucessfull authentication check of SRES or XRES"/>
		    <display:column property="piSuccAuth" titleKey="Pi_Succ_AUTH"/>
		    <display:column property="piSuccCipherGsm" titleKey="Pi_Succ_Ciph_GMS"/>
		</display:table>
	</div>
