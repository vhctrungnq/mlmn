			...
			<form:form method = "get" action = "thanh-toan-nhieu-ky.htm">
				<table> 
					...
					<tr>
						...
						<td > Từ tháng</td>
						<th> <input class ="thangnam" id = "thangquy" value = "${thangquy}" name = "thangquy"/> 
							
						</th>
						<td style="padding-left: 30px;">Năm</td>
						<th> <input class ="thangnam" id = "nam" value = "${nam}" name = "nam"/> 
						
						<td style="padding-left: 30px;">Đến tháng</td>
						<th> <input class ="thangnam" id = "thangquy_t" value = "${thangquy_t}" name = "thangquy_t"/> 
							
						</th>
						<td style="padding-left: 30px;">Năm</td>
						<th><input class ="thangnam" id = "nam_t" value = "${nam_t}" name = "nam_t"/> 
...
var urlprovince = "${pageContext.request.contextPath}/ajax/getDSTinh.htm?region="+$("#region").val();
   ...
   $("#tinh").jqxDropDownList({source: dataAdapterprovince, displayMember: "province", valueMember: "province",checkboxes: true, width: 180, autoDropDownHeight: true, theme: theme,enableHover: true });           
