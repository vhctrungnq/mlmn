		...
		<tr>
			<td width="20%" valign="top">
			    <table class="simple2">
			        ...
			        <tr>
			            <td>CSSR (%)</td>
			            <td><a href="#sdcch">${wkBscCore.cssr} %</a></td>
			        </tr>
			        <tr>
			            <td>PSR (%)</td>
			            <td>N/A</td>
			        ...
			        <tr>
			            <td>DCRS (%)</td>
			            <td><a href="#sdcch">${wkBscCore.dcrs} %</a></td>
			        </tr>
			        <tr>
			            <td>HSR (%)</td>
			        ...
			        <tr>
			            <td>DCRT (%)</td>
			            <td><a href="#tch">${wkBscCore.dcrt} %</a></td>
			        </tr>
			        <tr>
			            <td>TRAUCR (%)</td>
			            <td>N/A</td>
