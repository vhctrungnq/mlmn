...
<content tag="heading">MSC LOCATION UPDATE AREA OBJ BC HOURLY REPORT</content>
...
<div  id="doublescroll">
		<display:table name="${hrMscluareBC}" id="hrMscluareBC" requestURI="" pagesize="100" class="simple3" export="true">
		    <display:column property="mscid" titleKey="SYSTEM"/>
		    <display:column property="obj" titleKey="OBJ"/>
		    <display:column property="bc" titleKey="SybSys"/>
