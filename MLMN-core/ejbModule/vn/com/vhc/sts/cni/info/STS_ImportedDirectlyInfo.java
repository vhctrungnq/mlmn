...
public class STS_ImportedDirectlyInfo extends STS_TaskInfo implements STS_DBLogParam {
    ...
    public STS_ImportedDirectlyInfo() {
    }
    ...
    private String getLogSQL() {
        if (this.getImportTime().equalsIgnoreCase("")) {
            this.setImportTime(STS_Util.getCurrentTime());
        }
        ...
        String sqlCommand = "insert into I_FILE_IMPORT_LOGS \n" +
            ...
            this.getImportTime() + "', '" + STS_Setting.DB_TIME_FORMAT + "'), " +
