...
<content tag="heading">LIST CELL TO CELLS HADOVER FROM ${startMonth}/${startYear} TO ${endMonth}/${endYear}</content>
<ul class="ui-tabs-nav">
	...
	<li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio/cell-to-cells/mn/list.htm?bscid=${bscid}&fromCell=${fromCell}"><span>Báo cáo tháng</span></a></li>
</ul>
<div class="ui-tabs-panel">
	...
	<display:table name="${mnCellToCellsQos}" id="mnCellToCells" requestURI="" pagesize="100" class="simple2" export="true" sort="list">
