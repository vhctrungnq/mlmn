...
<ul class="ui-tabs-nav">
  <li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/other/mn.htm"><span>Báo cáo tháng</span></a></li>
...
<div class="ui-tabs-panel">
	<center><h2>BÁO CÁO THÁNG</h2></center>
	<br/>
	<form method="get" action="mn.htm">
		<table width="100%" class="form">
			<tr>
				<td align="left">
			        Chọn tháng báo cáo :  
			        <input value="${month}" name="month" id="month" size="2" maxlength="2">
	...
	<div style="overflow: auto;">
		<display:table name="${vRpDyRegionList}" id="vRpDyRegion" requestURI="" pagesize="100" class="simple2" export="true">
	...
	<hr color="92cdd8" align=left width="100%" size="6">
	<br/>
	<center><h2>BÁO CÁO THEO THÁNG</h2></center>
	<br/>
	<br/>
		<table width="100%" class="form">
			<tr>
				<td align="left">
			        Traffic - KPI theo tháng 
			        <input value="${startMonth}" name="startMonth" id="startMonth" size="2" maxlength="2">
			         / <input value="${startYear}" name="startYear" id="startYear" size="4" maxlength="4">
			          Đến <input value="${endMonth}" name="endMonth" id="endMonth" size="2" maxlength="2">
	...
	<br/>
	<div style="overflow: auto;">
		<display:table name="${vRpMnRegion2G3GList}" id="vRpMnRegion2G3G" requestURI="" pagesize="100" class="simple2" export="true">
	...
	<br/>
	<div id="traffMonthChart" style="width: 1000px; margin: 1em auto"></div>
	<br/>
	<div id="traffByMonthChart" style="width: 1000px; margin: 1em auto"></div>
	<br/>
	...
	<br/>
	<div style="overflow: auto;">
		<display:table name="${vRpMnBranchTraffic2G3GList}" id="vRpMnBranchTraffic2G3G" requestURI="" pagesize="100" class="simple2" export="true">
				<display:column property="month" titleKey="MONTH"/>
				<display:column property="year" titleKey="YEAR"/>
	    		<display:column property="region" titleKey="REGION"/>
			    ...
			    <display:column property ="ulData2g" decorator="vn.com.vhc.vmsc2.statistics.web.utils.NumberDecorator" titleKey="UL DATA 2G (GB)"/>	
			    <display:column property="dlData2g" decorator="vn.com.vhc.vmsc2.statistics.web.utils.NumberDecorator" titleKey="DL DATA 2G (GB)" />
			    <display:column property ="ulData3g" titleKey="UL DATA 3G (GB)"/>	
			    <display:column property="dlData3g" titleKey="DL DATA 3G (GB)" />
		</display:table>
	</div>
	<br/>
