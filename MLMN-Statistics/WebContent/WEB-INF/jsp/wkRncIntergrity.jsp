...
<content tag="heading">RNC INTERGRITY WEEKLY REPORT</content>
...
<ul class="ui-tabs-nav">
  ...
  <li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio3g/rnc-integrity/wk.htm?bscid=${bsc.bscid}&mscid=${msc.mscid}&region=${region}&startWeek=${startWeek}&startYear=${startYear}&endWeek=${endWeek}&endYear=${endYear}"><span>Báo cáo tuần</span></a></li>
