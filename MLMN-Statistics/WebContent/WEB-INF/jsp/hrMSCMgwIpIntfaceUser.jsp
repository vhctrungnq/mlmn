...
<content tag="heading">MSC IP INTERFACE USER STS DATA HOURLY REPORT</content>
...
<div  id="doublescroll">
		<display:table name="${HrMscipfaceuser}" id="HrMscipfaceuser" requestURI="" pagesize="100" class="simple3" export="true">
