s<%@ include file="/commons/taglibs.jsp" %>
...
<ul class="ui-tabs-nav">
	...
	<li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio/bsc-gprs-qos/mn/list.htm"><span>Báo cáo tháng</span></a></li>
</ul>
...
<display:table name="${vRpMnBscGprsQos}" id="vRpMnBscGprsQos" requestURI="" pagesize="100" class="simple2" export="true">
		<display:column property="month" titleKey="MONTH" sortable="true"/>
	    	...
	    	<a href="${pageContext.request.contextPath}/report/radio/bsc-gprs-qos/mn/detail.htm?bscid=${vRpMnBscGprsQos.bscid}&endMonth=${vRpMnBscGprsQos.month}&endYear=${vRpMnBscGprsQos.year}">${vRpMnBscGprsQos.bscid}</a>&nbsp;
	    </display:column>
