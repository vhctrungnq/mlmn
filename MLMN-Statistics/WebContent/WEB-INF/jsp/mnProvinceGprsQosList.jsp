...
<content tag="heading">GPRS-QOS PROVINCE MONTHLY REPORT</content>
<ul class="ui-tabs-nav">
	...
	<li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio/province-gprs-qos/mn/list.htm"><span>Báo cáo tháng</span></a></li>
</ul>
...
<display:table name="${vRpMnProvinceGprsQos}" id="vRpMnProvinceGprsQos" requestURI="" pagesize="100" class="simple2" export="true">
			    ...
			    <display:column titleKey="PROVINCE" media="html">
			    	<a href="${pageContext.request.contextPath}/report/radio/province-gprs-qos/mn/details.htm?province=${vRpMnProvinceGprsQos.province}&endMonth=${vRpMnProvinceGprsQos.month}&endYear=${vRpMnProvinceGprsQos.year}">${vRpMnProvinceGprsQos.province}</a>&nbsp;
			    </display:column>
