...
<content tag="heading">NO TRAFFIC CELLS HOURLY REPORT</content>

<ul class="ui-tabs-nav">
  <li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio/bad-cell/Notraffic/hr.htm?bscid=${bsc.bscid}&cellid=${cell.cellid}&startDate=${startDate}&startHour=${startHour}&endDate=${endDate}&endHour=${endHour}"><span>Báo cáo giờ</span></a></li>
  <li class=""><a href="${pageContext.request.contextPath}/report/radio/bad-cell/Notraffic/dy.htm?bscid=${bsc.bscid}"><span>Báo cáo ngày</span></a></li>
  <li class=""><a href="${pageContext.request.contextPath}/report/radio/bad-cell/Notraffic/wk.htm?bscid=${bsc.bscid}"><span>Báo cáo tuần</span></a></li>
  <li class=""><a href="${pageContext.request.contextPath}/report/radio/bad-cell/Notraffic/mn.htm?bscid=${bsc.bscid}"><span>Báo cáo tháng</span></a></li>
</ul>
  
<div class="ui-tabs-panel">
 <form:form commandName="filterno" method="post" action="hr.htm" name = "frmSample" onSubmit = "return ValidateForm()">
...
<div  style="overflow: auto;">
  <display:table name="${VrphrCellQos}" id="VrphrCellQos" requestURI="" pagesize="100" class="simple3" export="true">
      ...
      <display:column property ="tUtil"  titleKey="TCH UTILITY RATE(%)" />
  </display:table>
 </div>
