...
<content tag="heading">MSC MGW POOL PROCCESS STS DATA HOURLY REPORT</content>
 
  <ul class="ui-tabs-nav">
  <li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/core/pool-process/hr.htm?mscid=${msc.mscid}&startDate=${startDate}&startHour=${startHour}&endDate=${endDate}&endHour=${endHour}"><span>Báo cáo giờ</span></a></li>
  <li class=""><a href="${pageContext.request.contextPath}/report/core/pool-process/dy.htm?mscid=${msc.mscid}&startDate=${startDate}&endDate=${endDate}"><span>Báo cáo ngày</span></a></li>
</ul>
...
<div  id="doublescroll">
		<display:table name="${HrMscpool}" id="HrMscpool" requestURI="" pagesize="100" class="simple3" export="true">
		    <display:column property="mscid" titleKey="SYSTEM" headerClass="hide" class="hide"/>
		    <display:column title="SYSTEM" media="html">
		   	 	<a href="${pageContext.request.contextPath}/report/core/pool-process/detail.htm?mscid=${HrMscpool.mscid}&startDate=<fmt:formatDate pattern="dd/MM/yyyy" value="${HrMscpool.day}"/>&endDate=<fmt:formatDate pattern="dd/MM/yyyy" value="${HrMscpool.day}"/>">${HrMscpool.mscid}</a>
		    </display:column>
		    <display:column property ="day" format="{0,date,dd/MM/yyyy}" titleKey="Day" />
		    <display:column property="hour" titleKey="HOUR"/>
		    <display:column property="currentNo" titleKey="Current NoOf PPSessions"/>
		    <display:column property="totNoFailed" titleKey="Current NoOf Failed PPSessions"/>
		    <display:column property="totNo" titleKey="Total NoOf PPSessions"/>
		    <display:column property="poolProxySucc" titleKey="MSC POOL PROXY Sesion Success rate (%)"/>
		</display:table>
	</div>
