...
<content tag="heading">REGION IRSR 2G YEAR LIST</content>
<ul class="ui-tabs-nav">
	...
	<li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio/irsr/by-region/yr/list.htm"><span>IRSR by Center</span></a></li>
</ul>
<div class="ui-tabs-panel">
	...
	<div  style="overflow: auto;">
		<display:table name="${yrIrsrAlarmRegion2gList}" id="yrIrsrAlarmRegion2g" requestURI="" pagesize="100" class="simple3" export="true">		
