...
<content tag="heading">MSC MGW ACCESSIBILITY DAYLY REPORT</content>
 
<ul class="ui-tabs-nav">
  <li class=""><a href="${pageContext.request.contextPath}/report/core/msc-mgw/hr.htm?mscid=${msc.mscid}&startDate=${startDate}&endDate=${endDate}"><span>Báo cáo giờ</span></a></li>
  <li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/core/msc-mgw/dy.htm?mscid=${msc.mscid}&startDate=${startDate}&endDate=${endDate}"><span>Báo cáo ngày</span></a></li>
</ul>
...
<div  style="overflow: auto;">
		<display:table name="${dyMscMgw}" id="dyMscMgw" requestURI="" pagesize="100" class="simple3" export="true">
		   <display:column title="SYSTEM" media="html">
		   	 	<a href="${pageContext.request.contextPath}/report/core/msc-mgw/hr.htm?mscid=${dyMscMgw.mscid}&startDate=<fmt:formatDate pattern="dd/MM/yyyy" value="${dyMscMgw.day}"/>&endDate=<fmt:formatDate pattern="dd/MM/yyyy" value="${dyMscMgw.day}"/>">${dyMscMgw.mscid}</a>
		    </display:column>
