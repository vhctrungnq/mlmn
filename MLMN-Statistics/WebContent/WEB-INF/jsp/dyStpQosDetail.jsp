...
<title><fmt:message key="sidebar.stp.dy"/></title>
<content tag="heading"><fmt:message key="sidebar.stp.dy"/></content>
<ul class="ui-tabs-nav">
	<li class=""><a href="${pageContext.request.contextPath}/report/core/stp/hr.htm?stpid=${stp.stpid}&day=${day}"><span>Báo cáo giờ</span></a></li>
	<li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/core/stp/dy.htm?stpid=${stp.stpid}"><span>Báo cáo ngày</span></a></li>
					...
					<div>
					    <table class="simple2">
					        ...
					        <tr>
					            ...
					            <td>${dyStpUtilisationQos.f2}</td>
					        </tr>
					        <tr>
					            <td>Sigtrans utilization RPB-E (%)</td>
					            <td>${dyStpUtilisationQos.f3} %</td>
					        </tr>
					    </table>
					</div>
					...
					<div>
					    <table class="simple2">
					        <tr>
					            ...
					            <td>${dyStpRetransmitionQos.f1}</td>
					        </tr>
					        <tr>
					            <td>Number of retransmitted data chunks</td>
					            <td>${dyStpRetransmitionQos.f2}</td>
					        </tr>
					        <tr>
					            <td>Retransmission rate(%)</td>
					            <td>${dyStpRetransmitionQos.f3} %</td>
					        </tr>
					    </table>
					</div>
				</div>
