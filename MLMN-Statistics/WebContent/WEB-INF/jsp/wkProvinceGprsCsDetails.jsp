...
<content tag="heading">GPRS CS PROVINCE WEEKLY ${province} REPORT</content>
<ul class="ui-tabs-nav">
  ...
  <li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio/province-gprs-cs/wk/details.htm?province=${province}&endWeek=${endWeek}&endYear=${endYear}"><span>Báo cáo tuần</span></a></li>
  ...
  <li class=""><a href="${pageContext.request.contextPath}/report/radio/province-gprs-cs/wk/bhDetails.htm?province=${province}&endWeek=${endWeek}&endYear=${endYear}"><span>Báo cáo BH tuần</span></a></li>
...
<div class="ui-tabs-panel">
	...
	<br/>
   	<div  id="doublescroll">
<display:table name="${vRpWkProvinceGprsCsDetails}" id="vRpWkProvinceGprsCsDetail" requestURI="" pagesize="100" class="simple2" export="true">
	    ...
	    <display:column titleKey="PROVINCE" media="html">
	    	<a href="${pageContext.request.contextPath}/report/radio/province-gprs-cs/wk/details.htm?province=${vRpWkProvinceGprsCsDetail.province}&endWeek=${week}&endYear=${year}">${vRpWkProvinceGprsCsDetail.province}</a>&nbsp;
	    </display:column> 
	...
	$(function() {
		$( '.checkAll' ).live( 'change', function() {
			...
			if($( this ).is( ':checked' )){
				for (var i=6;i<=19;i++)
				{
					$('#vRpWkProvinceGprsCsDetail td:nth-child('+i+'),#vRpWkProvinceGprsCsDetail th:nth-child('+i+')').show();
				}
			} else {
				for (var i=6;i<=19;i++)
				{
					$('#vRpWkProvinceGprsCsDetail td:nth-child('+i+'),#vRpWkProvinceGprsCsDetail th:nth-child('+i+')').hide();
				}
			}
		});
