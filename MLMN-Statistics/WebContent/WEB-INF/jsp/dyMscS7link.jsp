...
<content tag="heading"> S7LINK ${title} REPORT</content>    
...
<div  id="doublescroll">
		<display:table name="${dyMscList}" id="dyMscList" requestURI="" pagesize="100" class="simple2" export="true">
		    ...
		    <display:column  property="linkid" titleKey="Linkid" sortable="true" headerClass="master-header-1"/>
		    ...
		    <display:column titleKey="Type" media="html" sortable="true" headerClass="master-header-1">
			   	 	<a href="${pageContext.request.contextPath}/report/core/${linkReport}/hr.htm?mscid=${dyMscList.mscid}&linkid=${dyMscList.linkid}&linksetname=${dyMscList.linksetName}&type=${dyMscList.type}&startDate=<fmt:formatDate pattern="dd/MM/yyyy" value="${dyMscList.day}"/>">${dyMscList.type}</a>
			 </display:column>
