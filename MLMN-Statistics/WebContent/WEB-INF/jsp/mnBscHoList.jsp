...
<content tag="heading">BSC HANDOVER MONTHLY REPORT</content>
<ul class="ui-tabs-nav">
	<li class=""><a href="${pageContext.request.contextPath}/report/radio/bsc-ho/dy/list.htm"><span>Báo cáo ngày</span></a></li>
	<li class=""><a href="${pageContext.request.contextPath}/report/radio/bsc-ho/wk/list.htm"><span>Báo cáo tuần</span></a></li>
	<li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio/bsc-ho/mn/list.htm"><span>Báo cáo tháng</span></a></li>
</ul>
	...
	<br/>
		...
		<display:table name="${vRpMnBscHo}" id="vRpMnBscHo" requestURI="" pagesize="100" class="simple2" export="true">
			    ...
			    <display:column titleKey="BSC" media="html">
			    	<a href="details.htm?bscid=${vRpMnBscHo.bscid}&endMonth=${month}&endYear=${year}">${vRpMnBscHo.bscid}</a>&nbsp;
			    </display:column>
