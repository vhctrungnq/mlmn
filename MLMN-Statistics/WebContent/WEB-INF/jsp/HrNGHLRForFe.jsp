...
<title>NGHLR HOUR REPORT</title>
<content tag="heading">NG HLR FOR FE HOURLY REPORT</content>
 
<ul class="ui-tabs-nav">
  <li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/RpHrHrlFor-Fe/hr.htm?nodeid=${node.hlrid}&startDate=${startDate}&startHour=${startHour}&endDate=${endDate}&endHour=${endHour}"><span>Báo cáo giờ</span></a></li>
  <li class=""><a href="${pageContext.request.contextPath}/report/RpHrHrlFor-Fe/dy.htm?nodeid=${node.hlrid}&startDate=${startDate}&endDate=${endDate}"><span>Báo cáo ngày</span></a></li>
</ul>
...
<div  style="overflow: auto;">
		<display:table name="${HrhlrFe}" id="HrhlrFe" requestURI="" pagesize="100" class="simple3" export="true">
