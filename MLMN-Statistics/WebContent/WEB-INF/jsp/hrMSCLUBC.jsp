...
<content tag="heading">MSC LOCATION UPDATE BC HOURLY REPORT</content>
...
<div  id="doublescroll">
		<display:table name="${hrMSCLUBC}" id="hrMSCLUBC" requestURI="" pagesize="100" class="simple3" export="true">
