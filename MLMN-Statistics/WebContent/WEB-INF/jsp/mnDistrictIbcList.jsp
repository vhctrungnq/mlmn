...
<content tag="heading">IBC DISTRICT REPORT</content>
<ul class="ui-tabs-nav">
	...
	<li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio/ibc/district/mn/list.htm"><span>Báo cáo tháng</span></a></li>
</ul>
...
<display:table name="${vRpMnDistrictIbc}" id="vRpMnDistrictIbc" requestURI="" pagesize="100" class="simple2" export="true" sort="list">
			    ...
			    <display:column titleKey="PROVINCE" media="html" sortable="true" sortProperty="province">
			    	<a href="${pageContext.request.contextPath}/report/radio/ibc/province/mn/detail.htm?province=${vRpMnDistrictIbc.province}&endMonth=${vRpMnDistrictIbc.month}&endYear=${vRpMnDistrictIbc.year}">${vRpMnDistrictIbc.province}</a>
			    </display:column>
			    ...
			    <display:column titleKey="DISTRICT" media="html" sortable="true" sortProperty="district">
			    	<a href="${pageContext.request.contextPath}/report/radio/ibc/district/mn/detail.htm?province=${vRpMnDistrictIbc.province}&district=${vRpMnDistrictIbc.district}&endMonth=${vRpMnDistrictIbc.month}&endYear=${vRpMnDistrictIbc.year}">${vRpMnDistrictIbc.district}</a>
			    </display:column>
