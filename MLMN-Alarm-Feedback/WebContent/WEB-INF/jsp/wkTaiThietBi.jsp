...
<content tag="heading">BIỂU ĐỒ TẢI THIẾT BỊ THEO TUẦN</content>
<ul class="ui-tabs-nav">
	<li class=""><a href="${pageContext.request.contextPath}/chart/rp/tai-thiet-bi/dy.htm"><span>Báo cáo ngày</span></a></li>
	<li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/chart/rp/tai-thiet-bi/wk.htm"><span>Báo cáo tuần</span></a></li>
