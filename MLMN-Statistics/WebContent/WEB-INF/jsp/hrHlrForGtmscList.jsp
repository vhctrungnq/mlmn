...
<content tag="heading">NG HLR FOR GTMSC HOURLY REPORT</content>
 
  <ul class="ui-tabs-nav">
  <li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/core/hlr-for-gtmsc/hr.htm?nodeid=${node.nodeid}&startDate=${startDate}&startHour=${startHour}&endDate=${endDate}&endHour=${endHour}"><span>Báo cáo giờ</span></a></li>
  <li class=""><a href="${pageContext.request.contextPath}/report/core/hlr-for-gtmsc/dy.htm?nodeid=${node.nodeid}&startDate=${startDate}&endDate=${endDate}"><span>Báo cáo ngày</span></a></li>
</ul>
...
<div  id="doublescroll">
		<display:table name="${vRpHrHlrForGtmsc}" id="vRpHrHlrForGtmsc" requestURI="" pagesize="100" class="simple3" export="true">
