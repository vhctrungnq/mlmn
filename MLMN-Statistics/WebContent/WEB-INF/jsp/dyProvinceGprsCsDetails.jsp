...
<content tag="heading">GPRS-CS PROVINCE DAILY ${province} REPORT</content>
<ul class="ui-tabs-nav">
  ...
  <li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio/province-gprs-cs/dy/details.htm?province=${province}&endDate=${endDate}"><span>Báo cáo ngày</span></a></li>
...
<div class="ui-tabs-panel">
	...
	<br/>
	<div  id="doublescroll">
<display:table name="${vRpDyProvinceGprsCsDetails}" id="vRpDyProvinceGprsCsDetail" requestURI="" pagesize="100" class="simple2" export="true">
    	...
    	<a href="${pageContext.request.contextPath}/report/radio/province-gprs-cs/hr/details.htm?province=${vRpDyProvinceGprsCsDetail.province}&endDate=<fmt:formatDate pattern="dd/MM/yyyy" value="${vRpDyProvinceGprsCsDetail.day}"/>">${vRpDyProvinceGprsCsDetail.province}</a>&nbsp;
    	</display:column> 
	...
	$(function() {
		...
		$( '.checkAll' ).live( 'change', function() {
			...
			if($( this ).is( ':checked' )){
				for (var i=5;i<=18;i++)
				{
					$('#vRpDyProvinceGprsCsDetail td:nth-child('+i+'),#vRpDyProvinceGprsCsDetail th:nth-child('+i+')').show();
				}
			} else {
				for (var i=5;i<=18;i++)
				{
					$('#vRpDyProvinceGprsCsDetail td:nth-child('+i+'),#vRpDyProvinceGprsCsDetail th:nth-child('+i+')').hide();
				}
			}
		});
