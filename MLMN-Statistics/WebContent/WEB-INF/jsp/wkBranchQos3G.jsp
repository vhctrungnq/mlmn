...
<content tag="heading">BRANCH QOS 3G REPORT ${branch}</content>
<ul class="ui-tabs-nav">
  <li class=""><a href="${pageContext.request.contextPath}/report/radio3g/branch/hr/detail.htm?branch=${branch}"><span>Báo cáo giờ</span></a></li>
  <li class=""><a href="${pageContext.request.contextPath}/report/radio3g/branch/dy/detail.htm?branch=${branch}"><span>Báo cáo ngày</span></a></li>
  <li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio3g/branch/wk/detail.htm?branch=${branch}&endWeek=${endWeek}&endYear=${endYear}"><span>Báo cáo tuần</span></a></li>
  ...
  <%-- <li class=""><a href="${pageContext.request.contextPath}/report/radio3g/branch/dy/bh.htm?branch=${branch}"><span>Báo cáo BH ngày </span></a></li>
  <li class=""><a href="${pageContext.request.contextPath}/report/radio3g/branch/wk/bh.htm?branch=${branch}&endWeek=${endWeek}&endYear=${endYear}"><span>Báo cáo BH tuần</span></a></li>
...
<display:table name="${vRpWkBranchList}" id="vRpWkBranch" requestURI="" pagesize="100" class="simple2" export="true" sort="list">
		...
		<display:column titleKey="Branch" media="html" headerClass="master-header-1" sortable="true" sortProperty="branch">
	    	<a href="${pageContext.request.contextPath}/report/radio3g/branch/wk/list.htm?branch=${vRpWkBranch.branch}&endWeek=${vRpWkBranch.week}&endYear=${vRpWkBranch.year}&startWeek=${vRpWkBranch.week}&startYear=${vRpWkBranch.year}">${vRpWkBranch.branch}</a>
	    </display:column>
	    ...
	    <display:column title="Cells" media="html" headerClass="master-header-1 margin" sortable="true" class="margin" sortProperty="cells">
