...
<content tag="heading">DISTRICT IBC REPORT ${district}/${province}</content>
<ul class="ui-tabs-nav">
  ...
  <li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio/ibc/district/wk/detail.htm?province=${province}&district=${district}&endWeek=${endWeek}&endYear=${endYear}"><span>Báo cáo tuần</span></a></li>
...
<display:table name="${vRpWkDistrictIbcList}" id="vRpWkDistrict" requestURI="" pagesize="100" class="simple2" export="true" sort="list">
