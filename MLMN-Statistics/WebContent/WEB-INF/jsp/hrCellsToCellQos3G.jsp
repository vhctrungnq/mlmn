...
<style type="text/css">    #doublescroll { overflow: auto; overflow-y: hidden; }    #doublescroll p { margin: 0; padding: 1em; white-space: nowrap; }</style><title>cells to cell 3g hourly report</title>
<content tag="heading">CELLS TO CELL 3G REPORT ${cellid}</content>
<ul class="ui-tabs-nav">
  ...
  <li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio3g/cell/ho-cell-to-cell/hrCellsToCell.htm?bscid=${bscid}&cellid=${cellid}&endDate=${endDate}"><span>Báo cáo giờ Cells to Cell</span></a></li>
  <li class=""><a href="${pageContext.request.contextPath}/report/radio3g/cell/ho-cell-to-cell/dyCellsToCell.htm?bscid=${bscid}&cellid=${cellid}&endDate=${endDate}"><span>Báo cáo ngày Cells to Cell</span></a></li>
	...
	<div class="ui-tabs-panel">
	  ...
	  <form method="get" action="hrCellsToCell.htm" name = "frmSample" onSubmit = "return ValidateForm()">
