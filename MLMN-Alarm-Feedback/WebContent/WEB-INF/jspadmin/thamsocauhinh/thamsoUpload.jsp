...
<form:form method="post" action="upload.htm?typeCode=${typeCode}" enctype="multipart/form-data" >
				...
				<td>
					<ul style="list-style-type: none;">
						...
						<li>Dữ liệu trong file có dạng: 
							<code>
							&lt;<fmt:message key="thamso.code"/>&gt;<font color="red">(*)</font>, 
							&lt;<fmt:message key="thamso.name"/>&gt;<font color="red">(*)</font>, 
							&lt;<fmt:message key="thamso.value"/>&gt;<font color="red">(*)</font>, 
							&lt;<fmt:message key="thamso.ordering"/>&gt;, 
							&lt;<fmt:message key="thamso.dataType"/>&gt;, 
							&lt;<fmt:message key="thamso.remark"/>&gt;
							</code>
						</li>
						<li>File mẫu:&nbsp;<a style="color: blue; " title="ParameterExample" href="${pageContext.request.contextPath}/upload/example/ParameterExample.xls">ParameterExample.xls</a>
						</li>
					</ul>
			</td>
		</tr>
    	...
    	<div id="failed">
    		...
    		<div style="max-height: 500px; overflow: auto;">
    			<display:table name="${failedList}" class="simple2" id="item1" requestURI="" export="false" pagesize="100">
							...
							<display:column property="code" titleKey="thamso.code"  class="NOT_NULL" />
							<display:column property="name" titleKey="thamso.name"  class="NOT_NULL"/>
							<display:column property="value"  class="NOT_NULL" titleKey="thamso.value" />
							<display:column property="ordering" titleKey="thamso.ordering" />
							<display:column property="dataType" titleKey="thamso.dataType" />
							<display:column property="remark" titleKey="thamso.remark" />
				</display:table>
			</div>
		</div>
	</c:if>
	<c:if test="${fn:length(successList) gt 0}">
		...
		<tr>
			<td >
               	<input class="button" type="button" value="<fmt:message key="global.button.back"/>" onClick='window.location="danh-sach.htm?typeCode=${typeCode}"'>
			</td>
		</tr>
	</table>
</form:form>
