...
<ul class="ui-tabs-nav">
	...
	<li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio3g/bad-cell-traff/by-province/list.htm?province=${province}&startDate=${startDate}&endDate=${endDate}"><span>Cell có lưu lượng &lt; 10 erl của Province</span></a></li>
...
<div class="ui-tabs-panel">
	...
	<a href="${pageContext.request.contextPath}/report/radio3g/bad-cell-traff/by-province/mn/list.htm?province=${province}"><span>theo tháng</span></a>
	<br/>
			...
			<tr>
			  ...
			  <form method="get" action="list.htm" name="frmSample" onSubmit="return ValidateForm()">
			  	Trung tâm 
					...
					Province <input name="province" id="province" value="${province}" size="10" maxlength="50" onchange="xl()">
