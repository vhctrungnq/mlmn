...
<content tag="heading">DISTRICT IRSR 2G QUARTER LIST</content>
<ul class="ui-tabs-nav">
	...
	<li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio/irsr/by-district/qr/list.htm"><span>IRSR by District</span></a></li>
...
<div class="ui-tabs-panel">
	...
	<div  style="overflow: auto;">
		<display:table name="${qrIrsrAlarmDistrict2gList}" id="qrIrsrAlarmDistrict2g" requestURI="" pagesize="100" class="simple3" export="true">		
