...
<title>Unavailable cells day report</title>
<content tag="heading">UNAVAILABLE CELLS DAILY REPORT</content>

<ul class="ui-tabs-nav">
  <li class=""><a href="/VMSC2-Statistics/report/radio3g/cell-available/hr.htm?bscid=${bsc.bscid}&cellid=${cell.cellid}"><span>Báo cáo giờ</span></a></li>
  <li class="ui-tabs-selected"><a href="/VMSC2-Statistics/report/radio3g/cell-available/dy.htm?bscid=${bsc.bscid}&cellid=${cell.cellid}&startDate=${startDate}&endDate=${endDate}"><span>Báo cáo ngày</span></a></li>
  <li class=""><a href="/VMSC2-Statistics/report/radio3g/cell-available/wk.htm?bscid=${bsc.bscid}&cellid=${cell.cellid}"><span>Báo cáo tuần</span></a></li>
  <li class=""><a href="/VMSC2-Statistics/report/radio3g/cell-available/mn.htm?bscid=${bsc.bscid}&cellid=${cell.cellid}"><span>Báo cáo tháng</span></a></li>
</ul>
