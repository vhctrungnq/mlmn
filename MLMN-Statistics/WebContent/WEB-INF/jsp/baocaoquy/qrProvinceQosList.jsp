...
<content tag="heading">PROVINCE QOS QUARTERLY REPORT</content>
<ul class="ui-tabs-nav">
	...
	<li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio/province/qr/list.htm"><span>Báo cáo quý</span></a></li>
...
<div  style="overflow: auto;" class="tableStandar" id = "doublescroll">
	<display:table name="${vRpQrProvinceQos}" id="item" requestURI="" pagesize="100" class="simple2" export="true" sort="list">
