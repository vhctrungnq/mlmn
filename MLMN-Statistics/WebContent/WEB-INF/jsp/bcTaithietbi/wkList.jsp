...
<ul class="ui-tabs-nav">
	...
	<li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/taithietbi/wk.htm?type=${type}"><span>Báo cáo tuần</span></a></li>
...
<br>
	<form method="post" action="wk.htm?type=${type}">
		<table style="width:100%;" class="form">
			<tr>
				<td align="left">
					...
					Từ tuần<input value="${sWeek}" name="sWeek" id="sWeek" maxlength="2" class="wid2">
					<img alt="calendar" title="Click to choose the start week number" id="chooseStartWeek" style="cursor: pointer;" src="${pageContext.request.contextPath}/images/calendar.png"/>&nbsp;&nbsp;
			        năm <input value="${sYear}" name="sYear" id="sYear" class="wid4">&nbsp;&nbsp;
			        Đến tuần<input value="${eWeek}" name="eWeek" id="eWeek" maxlength="2" class="wid2">
...
<div  style="overflow: auto;" >
	<display:table name="${dataList}" id="item" requestURI="" pagesize="100" class="simple2" export="true">
			...
			<display:column property="week" title="Tuần" sortName="week" sortable="true" headerClass="master-header-1 margin" class="margin"/>
