	...
	<div align="left">
		...
		<c:choose>
			<c:when test="${warningTp == 'WOTK_SHIFT'}">
				<li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/caTruc/list.htm?warningTp=WOTK_SHIFT&region=${region}"><span><fmt:message key="tab.congvieccodinh"/></span></a></li>
				 <li class=""><a href="${pageContext.request.contextPath}/caTruc/list.htm?warningTp=2G&region=${region}"><span><fmt:message key="tab.canhBao2G"/></span></a></li>
				<li class=""><a href="${pageContext.request.contextPath}/caTruc/list.htm?warningTp=3G&region=${region}"><span><fmt:message key="tab.canhBao3G"/></span></a></li> 
				<li class=""><a href="${pageContext.request.contextPath}/caTruc/list.htm?warningTp=PS_CORE&region=${region}"><span><fmt:message key="tab.canhBaoPSCore"/></span></a></li>
				<li class=""><a href="${pageContext.request.contextPath}/caTruc/list.htm?warningTp=CS_CORE&region=${region}"><span><fmt:message key="tab.canhBaoCSCore"/></span></a></li>
				<li class=""><a href="${pageContext.request.contextPath}/caTruc/list.htm?warningTp=IPBB&region=${region}"><span><fmt:message key="tab.canhBaoIPBB"/></span></a></li>
				<li class=""><a href="${pageContext.request.contextPath}/caTruc/list.htm?warningTp=SU_CO_LON&region=${region}"><span><fmt:message key="tab.canhBaoSuCoLon"/></span></a></li>
				<li class=""><a href="${pageContext.request.contextPath}/caTruc/list.htm?warningTp=LOI_TRUYEN_DAN&region=${region}"><span><fmt:message key="tab.canhBaoLoiTruyenDan"/></span></a></li>
				<li class=""><a href="${pageContext.request.contextPath}/caTruc/list.htm?warningTp=SU_CO_KHAC&region=${region}"><span><fmt:message key="tab.canhBaoSuCoKhac"/></span></a></li>
				<li class=""><a href="${pageContext.request.contextPath}/caTruc/list.htm?warningTp=ALARM_EXTEND&region=${region}"><span><fmt:message key="tab.congViecHieuChinhMR"/></span></a></li>
				<li class=""><a href="${pageContext.request.contextPath}/caTruc/list.htm?warningTp=TEMPERATURE_SITE&region=${region}"><span><fmt:message key="tab.gsnhietdoSite"/></span></a></li>
			</c:when>
			 <c:when test="${warningTp == '2G'}">
				<li class=""><a href="${pageContext.request.contextPath}/caTruc/list.htm?warningTp=WOTK_SHIFT&region=${region}"><span><fmt:message key="tab.congvieccodinh"/></span></a></li>
				<li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/caTruc/list.htm?warningTp=2G&region=${region}"><span><fmt:message key="tab.canhBao2G"/></span></a></li>
				<li class=""><a href="${pageContext.request.contextPath}/caTruc/list.htm?warningTp=3G&region=${region}"><span><fmt:message key="tab.canhBao3G"/></span></a></li>
				<li class=""><a href="${pageContext.request.contextPath}/caTruc/list.htm?warningTp=PS_CORE&region=${region}"><span><fmt:message key="tab.canhBaoPSCore"/></span></a></li>
				<li class=""><a href="${pageContext.request.contextPath}/caTruc/list.htm?warningTp=CS_CORE&region=${region}"><span><fmt:message key="tab.canhBaoCSCore"/></span></a></li>
				<li class=""><a href="${pageContext.request.contextPath}/caTruc/list.htm?warningTp=IPBB&region=${region}"><span><fmt:message key="tab.canhBaoIPBB"/></span></a></li>
		 	...
		 	<c:when test="${warningTp == '3G'}">
				<li class=""><a href="${pageContext.request.contextPath}/caTruc/list.htm?warningTp=WOTK_SHIFT&region=${region}"><span><fmt:message key="tab.congvieccodinh"/></span></a></li>
				<li class=""><a href="${pageContext.request.contextPath}/caTruc/list.htm?warningTp=2G&region=${region}"><span><fmt:message key="tab.canhBao2G"/></span></a></li>
				<li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/caTruc/list.htm?warningTp=3G&region=${region}"><span><fmt:message key="tab.canhBao3G"/></span></a></li>
				<li class=""><a href="${pageContext.request.contextPath}/caTruc/list.htm?warningTp=PS_CORE&region=${region}"><span><fmt:message key="tab.canhBaoPSCore"/></span></a></li>
				<li class=""><a href="${pageContext.request.contextPath}/caTruc/list.htm?warningTp=CS_CORE&region=${region}"><span><fmt:message key="tab.canhBaoCSCore"/></span></a></li>
				<li class=""><a href="${pageContext.request.contextPath}/caTruc/list.htm?warningTp=IPBB&region=${region}"><span><fmt:message key="tab.canhBaoIPBB"/></span></a></li>
				<li class=""><a href="${pageContext.request.contextPath}/caTruc/list.htm?warningTp=SU_CO_LON&region=${region}"><span><fmt:message key="tab.canhBaoSuCoLon"/></span></a></li>
			...
			<c:when test="${warningTp == 'CS_CORE'}">
				...
				<li class=""><a href="${pageContext.request.contextPath}/caTruc/list.htm?warningTp=3G&region=${region}"><span><fmt:message key="tab.canhBao3G"/></span></a></li> 
				<li class=""><a href="${pageContext.request.contextPath}/caTruc/list.htm?warningTp=PS_CORE&region=${region}"><span><fmt:message key="tab.canhBaoPSCore"/></span></a></li>
				<li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/caTruc/list.htm?warningTp=CS_CORE&region=${region}"><span><fmt:message key="tab.canhBaoCSCore"/></span></a></li>
				<li class=""><a href="${pageContext.request.contextPath}/caTruc/list.htm?warningTp=IPBB&region=${region}"><span><fmt:message key="tab.canhBaoIPBB"/></span></a></li>
				<li class=""><a href="${pageContext.request.contextPath}/caTruc/list.htm?warningTp=SU_CO_LON&region=${region}"><span><fmt:message key="tab.canhBaoSuCoLon"/></span></a></li>
				<li class=""><a href="${pageContext.request.contextPath}/caTruc/list.htm?warningTp=LOI_TRUYEN_DAN&region=${region}"><span><fmt:message key="tab.canhBaoLoiTruyenDan"/></span></a></li>
				<li class=""><a href="${pageContext.request.contextPath}/caTruc/list.htm?warningTp=SU_CO_KHAC&region=${region}"><span><fmt:message key="tab.canhBaoSuCoKhac"/></span></a></li>
			...
			<c:when test="${warningTp == 'PS_CORE'}">
				<li class=""><a href="${pageContext.request.contextPath}/caTruc/list.htm?warningTp=WOTK_SHIFT&region=${region}"><span><fmt:message key="tab.congvieccodinh"/></span></a></li>
				 <li class=""><a href="${pageContext.request.contextPath}/caTruc/list.htm?warningTp=2G&region=${region}"><span><fmt:message key="tab.canhBao2G"/></span></a></li>
				<li class=""><a href="${pageContext.request.contextPath}/caTruc/list.htm?warningTp=3G&region=${region}"><span><fmt:message key="tab.canhBao3G"/></span></a></li> 
				<li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/caTruc/list.htm?warningTp=PS_CORE&region=${region}"><span><fmt:message key="tab.canhBaoPSCore"/></span></a></li>
				<li class=""><a href="${pageContext.request.contextPath}/caTruc/list.htm?warningTp=CS_CORE&region=${region}"><span><fmt:message key="tab.canhBaoCSCore"/></span></a></li>
				<li class=""><a href="${pageContext.request.contextPath}/caTruc/list.htm?warningTp=IPBB&region=${region}"><span><fmt:message key="tab.canhBaoIPBB"/></span></a></li>
				<li class=""><a href="${pageContext.request.contextPath}/caTruc/list.htm?warningTp=SU_CO_LON&region=${region}"><span><fmt:message key="tab.canhBaoSuCoLon"/></span></a></li>
				<li class=""><a href="${pageContext.request.contextPath}/caTruc/list.htm?warningTp=LOI_TRUYEN_DAN&region=${region}"><span><fmt:message key="tab.canhBaoLoiTruyenDan"/></span></a></li>
			...
			<c:when test="${warningTp == 'IPBB'}">
				...
				<li class=""><a href="${pageContext.request.contextPath}/caTruc/list.htm?warningTp=PS_CORE&region=${region}"><span><fmt:message key="tab.canhBaoPSCore"/></span></a></li>
				<li class=""><a href="${pageContext.request.contextPath}/caTruc/list.htm?warningTp=CS_CORE&region=${region}"><span><fmt:message key="tab.canhBaoCSCore"/></span></a></li>
				<li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/caTruc/list.htm?warningTp=IPBB&region=${region}"><span><fmt:message key="tab.canhBaoIPBB"/></span></a></li>
				<li class=""><a href="${pageContext.request.contextPath}/caTruc/list.htm?warningTp=SU_CO_LON&region=${region}"><span><fmt:message key="tab.canhBaoSuCoLon"/></span></a></li>
				<li class=""><a href="${pageContext.request.contextPath}/caTruc/list.htm?warningTp=LOI_TRUYEN_DAN&region=${region}"><span><fmt:message key="tab.canhBaoLoiTruyenDan"/></span></a></li>
				<li class=""><a href="${pageContext.request.contextPath}/caTruc/list.htm?warningTp=SU_CO_KHAC&region=${region}"><span><fmt:message key="tab.canhBaoSuCoKhac"/></span></a></li>
				<li class=""><a href="${pageContext.request.contextPath}/caTruc/list.htm?warningTp=ALARM_EXTEND&region=${region}"><span><fmt:message key="tab.congViecHieuChinhMR"/></span></a></li>
			...
			<c:when test="${warningTp == 'SU_CO_LON'}">
				...
				<li class=""><a href="${pageContext.request.contextPath}/caTruc/list.htm?warningTp=CS_CORE&region=${region}"><span><fmt:message key="tab.canhBaoCSCore"/></span></a></li>
				<li class=""><a href="${pageContext.request.contextPath}/caTruc/list.htm?warningTp=IPBB&region=${region}"><span><fmt:message key="tab.canhBaoIPBB"/></span></a></li>
				<li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/caTruc/list.htm?warningTp=SU_CO_LON&region=${region}"><span><fmt:message key="tab.canhBaoSuCoLon"/></span></a></li>
				<li class=""><a href="${pageContext.request.contextPath}/caTruc/list.htm?warningTp=LOI_TRUYEN_DAN&region=${region}"><span><fmt:message key="tab.canhBaoLoiTruyenDan"/></span></a></li>
				<li class=""><a href="${pageContext.request.contextPath}/caTruc/list.htm?warningTp=SU_CO_KHAC&region=${region}"><span><fmt:message key="tab.canhBaoSuCoKhac"/></span></a></li>
				<li class=""><a href="${pageContext.request.contextPath}/caTruc/list.htm?warningTp=ALARM_EXTEND&region=${region}"><span><fmt:message key="tab.congViecHieuChinhMR"/></span></a></li>
				<li class=""><a href="${pageContext.request.contextPath}/caTruc/list.htm?warningTp=TEMPERATURE_SITE&region=${region}"><span><fmt:message key="tab.gsnhietdoSite"/></span></a></li>
			...
			<c:when test="${warningTp == 'ALARM_EXTEND'}">
				...
				<li class=""><a href="${pageContext.request.contextPath}/caTruc/list.htm?warningTp=LOI_TRUYEN_DAN&region=${region}"><span><fmt:message key="tab.canhBaoLoiTruyenDan"/></span></a></li>
				<li class=""><a href="${pageContext.request.contextPath}/caTruc/list.htm?warningTp=SU_CO_KHAC&region=${region}"><span><fmt:message key="tab.canhBaoSuCoKhac"/></span></a></li>
				<li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/caTruc/list.htm?warningTp=ALARM_EXTEND&region=${region}"><span><fmt:message key="tab.congViecHieuChinhMR"/></span></a></li>
				<li class=""><a href="${pageContext.request.contextPath}/caTruc/list.htm?warningTp=TEMPERATURE_SITE&region=${region}"><span><fmt:message key="tab.gsnhietdoSite"/></span></a></li>
			</c:when>
			<c:when test="${warningTp == 'TEMPERATURE_SITE'}">
				...
				<li class=""><a href="${pageContext.request.contextPath}/caTruc/list.htm?warningTp=SU_CO_KHAC&region=${region}"><span><fmt:message key="tab.canhBaoSuCoKhac"/></span></a></li>
				<li class=""><a href="${pageContext.request.contextPath}/caTruc/list.htm?warningTp=ALARM_EXTEND&region=${region}"><span><fmt:message key="tab.congViecHieuChinhMR"/></span></a></li>
				<li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/caTruc/list.htm?warningTp=TEMPERATURE_SITE&region=${region}"><span><fmt:message key="tab.gsnhietdoSite"/></span></a></li>
			</c:when>
			<c:when test="${warningTp == 'SU_CO_KHAC'}">
				...
				<li class=""><a href="${pageContext.request.contextPath}/caTruc/list.htm?warningTp=SU_CO_LON&region=${region}"><span><fmt:message key="tab.canhBaoSuCoLon"/></span></a></li>
				<li class=""><a href="${pageContext.request.contextPath}/caTruc/list.htm?warningTp=LOI_TRUYEN_DAN&region=${region}"><span><fmt:message key="tab.canhBaoLoiTruyenDan"/></span></a></li>
				<li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/caTruc/list.htm?warningTp=SU_CO_KHAC&region=${region}"><span><fmt:message key="tab.canhBaoSuCoKhac"/></span></a></li>
				<li class=""><a href="${pageContext.request.contextPath}/caTruc/list.htm?warningTp=ALARM_EXTEND&region=${region}"><span><fmt:message key="tab.congViecHieuChinhMR"/></span></a></li>
				<li class=""><a href="${pageContext.request.contextPath}/caTruc/list.htm?warningTp=TEMPERATURE_SITE&region=${region}"><span><fmt:message key="tab.gsnhietdoSite"/></span></a></li>
			</c:when>
			<c:when test="${warningTp == 'LOI_TRUYEN_DAN'}">
				...
				<li class=""><a href="${pageContext.request.contextPath}/caTruc/list.htm?warningTp=IPBB&region=${region}"><span><fmt:message key="tab.canhBaoIPBB"/></span></a></li>
				<li class=""><a href="${pageContext.request.contextPath}/caTruc/list.htm?warningTp=SU_CO_LON&region=${region}"><span><fmt:message key="tab.canhBaoSuCoLon"/></span></a></li>
				<li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/caTruc/list.htm?warningTp=LOI_TRUYEN_DAN&region=${region}"><span><fmt:message key="tab.canhBaoLoiTruyenDan"/></span></a></li>
				<li class=""><a href="${pageContext.request.contextPath}/caTruc/list.htm?warningTp=SU_CO_KHAC&region=${region}"><span><fmt:message key="tab.canhBaoSuCoKhac"/></span></a></li>
				<li class=""><a href="${pageContext.request.contextPath}/caTruc/list.htm?warningTp=ALARM_EXTEND&region=${region}"><span><fmt:message key="tab.congViecHieuChinhMR"/></span></a></li>
				<li class=""><a href="${pageContext.request.contextPath}/caTruc/list.htm?warningTp=TEMPERATURE_SITE&region=${region}"><span><fmt:message key="tab.gsnhietdoSite"/></span></a></li>
			</c:when>
		 	<c:when test="${warningTp == 'BAN_GIAO_CA' }">
		 		<li class=""><a href="${pageContext.request.contextPath}/caTruc/list.htm?warningTp=WOTK_SHIFT&region=${region}"><span><fmt:message key="tab.congvieccodinh"/></span></a></li>
				 <li class=""><a href="${pageContext.request.contextPath}/caTruc/list.htm?warningTp=2G&region=${region}"><span><fmt:message key="tab.canhBao2G"/></span></a></li>
				<li class=""><a href="${pageContext.request.contextPath}/caTruc/list.htm?warningTp=3G&region=${region}"><span><fmt:message key="tab.canhBao3G"/></span></a></li> 
				<li class=""><a href="${pageContext.request.contextPath}/caTruc/list.htm?warningTp=PS_CORE&region=${region}"><span><fmt:message key="tab.canhBaoPSCore"/></span></a></li>
		...
		<c:if test="${region != '' && (checkCaTruc==true || isRoleManager=='Y')}">
				<c:choose>
					<c:when test="${warningTp == 'BAN_GIAO_CA' }">
						<li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/caTruc/list.htm?warningTp=BAN_GIAO_CA&region=${region}"><span><fmt:message key="tab.bangiaoca"/></span></a></li>
					</c:when>
					<c:otherwise>
						<li class=""><a href="${pageContext.request.contextPath}/caTruc/list.htm?warningTp=BAN_GIAO_CA&region=${region}"><span><fmt:message key="tab.bangiaoca"/></span></a></li>
					</c:otherwise>
				</c:choose>
		</c:if>
		</div>
...
<table style="width:100%">
	...
	<tr>
		...
		<c:if test="${warningTp == 'WOTK_SHIFT' && checkTruongCa==true}">
				<input class="button"  type="button" id="btAdd" value="<fmt:message key="global.button.addNew"/>" onclick='window.location="${pageContext.request.contextPath}/working/form.htm?id=&type=cvcd&note=caTruc&region=${region}"' />
		</c:if>
		<c:if test="${checkCaTruc==true || isRoleManager=='Y'}">	
			<c:choose>
				<c:when test="${warningTp == '2G'}">
					<input class="button"  type="button" id="btUpdate" value="<fmt:message key="global.button.UpdateEnd"/>" onclick='window.location="updateEnd.htm?warningTp=2G&ca=${ca}&ngayTruc=${ngayTruc}&region=${region}"' />
					<input class="button"  type="button" id="btAdd" value="<fmt:message key="global.button.addNew"/>" onclick='window.location="form23G.htm?warningTp=2G&region=${region}"' />
				</c:when>
				<c:when test="${warningTp == '3G'}">
					<input class="button"  type="button" id="btUpdate" value="<fmt:message key="global.button.UpdateEnd"/>"  onclick='window.location="updateEnd.htm?warningTp=3G&ca=${ca}&ngayTruc=${ngayTruc}&region=${region}"' />
					<input class="button"  type="button" id="btAdd" value="<fmt:message key="global.button.addNew"/>" onclick='window.location="form23G.htm?warningTp=3G&region=${region}"' />
				</c:when>
				<c:when test="${warningTp == 'PS_CORE'}">
					<input class="button"  type="button" id="btUpdate" value="<fmt:message key="global.button.UpdateEnd"/>"  onclick='window.location="updateEnd.htm?warningTp=PS_CORE&ca=${ca}&ngayTruc=${ngayTruc}&region=${region}"' />
					<input class="button" type="button" id="btAdd" value="<fmt:message key="global.button.addNew"/>" onclick='window.location="${pageContext.request.contextPath}/warning/form.htm?warningTp=PS_CORE&note=caTruc&region=${region}"' />
				</c:when>
				<c:when test="${warningTp == 'CS_CORE'}">
					<input class="button"  type="button" id="btUpdate" value="<fmt:message key="global.button.UpdateEnd"/>" onclick='window.location="updateEnd.htm?warningTp=CS_CORE&ca=${ca}&ngayTruc=${ngayTruc}&region=${region}"' />
					<input class="button" type="button" id="btAdd" value="<fmt:message key="global.button.addNew"/>" onclick='window.location="${pageContext.request.contextPath}/warning/form.htm?warningTp=CS_CORE&note=caTruc&region=${region}"' />
				</c:when>
				<c:when test="${warningTp == 'IPBB'}">
					...
					<input class="button" type="button" id="btAdd" value="<fmt:message key="global.button.addNew"/>" onclick='window.location="${pageContext.request.contextPath}/warning/form.htm?warningTp=IPBB&note=caTruc&region=${region}"' />  
				</c:when>
				<c:when test="${warningTp == 'SU_CO_LON'}">
					<input class="button" type="button" id="btAdd" value="<fmt:message key="global.button.addNew"/>"  onclick='window.location="form23G.htm?warningTp=SU_CO_LON&region=${region}"' />
				</c:when>
				<c:when test="${warningTp == 'SU_CO_KHAC'}">
					<input class="button" type="button" id="btAdd" value="<fmt:message key="global.button.addNew"/>"  onclick='window.location="form23G.htm?warningTp=SU_CO_KHAC&region=${region}"' />
				</c:when>
				<c:when test="${warningTp == 'LOI_TRUYEN_DAN'}">
					<input class="button" type="button" id="btAdd" value="<fmt:message key="global.button.addNew"/>"  onclick='window.location="form23G.htm?warningTp=LOI_TRUYEN_DAN&region=${region}"' />
				</c:when>
				<c:when test="${warningTp == 'ALARM_EXTEND'}">
					<input class="button" type="button" id="btAdd" value="<fmt:message key="global.button.addNew"/>" onclick='window.location="${pageContext.request.contextPath}/alarmExtend/form.htm?note=caTruc&region=${region}"' />
		 		</c:when>
				<c:when test="${warningTp == 'TEMPERATURE_SITE'}">
					<input class="button" type="button" id="btAdd" value="<fmt:message key="global.button.addNew"/>" onclick='window.location="${pageContext.request.contextPath}/monitor/temperatureForm.htm?note=caTruc&region=${region}"' />
		 		</c:when>
			</c:choose>
		</c:if>
		</td>
...
<!-- <div id="grid"></div> -->
<%@ include file="/includeJQ/jwGrid.jsp" %>
<div id='menujqx'>
            <ul>
				...
				<c:if test="${(checkCaTruc==true || isRoleManager=='Y')&&warningTp == 'WOTK_SHIFT'}">	
				...
				<c:if test="${warningTp=='SU_CO_LON'||warningTp=='ALARM_EXTEND'||warningTp=='TEMPERATURE_SITE'||warningTp=='LOI_TRUYEN_DAN'||warningTp=='SU_CO_KHAC'}">		
...
<table style="width:100%">
	...
	<tr>
		...
		<td align="right" class="ftsize12">
		<c:if test="${warningTp == 'WOTK_SHIFT' && checkTruongCa==true}">
				<input class="button"  type="button" id="btAdd" value="<fmt:message key="global.button.addNew"/>" onclick='window.location="${pageContext.request.contextPath}/working/form.htm?id=&type=&note=caTruc&region=${region}"' />
		</c:if>
		</td>
...
<h2><fmt:message key="catruc.chuyenGiaoCaTruc"/></h2>
	...
	<div id="giaoCa" >
	<form:form commandName="catruc" method="post" id ="foo" name="foo" action="list.htm?warningTp=BAN_GIAO_CA&region=${region}"> 	
...
var theme =  getTheme();
	...
	function functionNextShift()
	{
		...
		if (nhanNgayTruc != '' &&nhanCaTruc != '') {
			$.getJSON("${pageContext.request.contextPath}/ajax/getNextShift.htm",{ngaytruc : nhanNgayTruc,catruc:nhanCaTruc,region:region}, function(j){
	...
	$("#menujqx2").on('itemclick', function (event) {
	   ...
	   var rowindex = $("#grid2").jqxGrid('getselectedrowindex');
	    ...
	    if ($.trim($(args).text()) == '<fmt:message key="global.button.updateWorkProgress"/>')  {
	    	window.location = '${pageContext.request.contextPath}/w_working_managements/formContentDetails.htm?id='+row.id+'&type=cvcd&region='+region;      
	    }
	    if ($.trim($(args).text()) == '<fmt:message key="global.button.deleteSelected"/>')  {
	    	var answer = confirm ('<fmt:message key="messsage.confirm.delete"/>');
	    	if (answer)
	    	{
	    		window.location = '${pageContext.request.contextPath}/working/delete.htm?idList='+row.id+'&type=&note=caTruc'+'&region='+region;   
	    	}
	    }
   ...
   var rowindex = $("#grid").jqxGrid('getselectedrowindex');
    ...
    if ($.trim($(args).text()) == '<fmt:message key="global.button.editSelected"/>') {
    	if (warningTp=='2G'||warningTp=='3G'||warningTp=='SU_CO_LON'||warningTp=='SU_CO_KHAC'||warningTp=='LOI_TRUYEN_DAN')
   		{
    		window.location = 'form23G.htm?id='+row.id+'&warningTp='+warningTp+'&region='+region;  
   		}
    	
    	else if (warningTp=='PS_CORE'||warningTp=='CS_CORE'||warningTp=='IPBB')
   		{
    		window.location = '${pageContext.request.contextPath}/warning/form.htm?id='+row.id+'&warningTp='+warningTp+'&note=caTruc'+'&region='+region;
   		}
   		...
   		{
    		window.location = '${pageContext.request.contextPath}/alarmExtend/form.htm?id='+row.id+'&note=caTruc'+'&region='+region;    
   		}
    	else if (warningTp=='TEMPERATURE_SITE')
   		{
    		window.location = '${pageContext.request.contextPath}/monitor/temperatureForm.htm?id='+row.id+'&note=caTruc'+'&region='+region;
   		}
    ...
    if ($.trim($(args).text()) == '<fmt:message key="global.button.deleteSelected"/>')  {
    	...
    	if (answer)
    	{
    		if (warningTp=='2G'||warningTp=='3G'||warningTp=='SU_CO_LON'||warningTp=='SU_CO_KHAC'||warningTp=='LOI_TRUYEN_DAN')
       		{
    			window.location = 'delete23G.htm?id='+row.id+'&warningTp='+warningTp+'&region='+region;    
    		}
    		else if (warningTp=='PS_CORE'||warningTp=='CS_CORE'||warningTp=='IPBB')
       		{
    			window.location = '${pageContext.request.contextPath}/warning/delete.htm?id='+row.id+'&warningTp='+warningTp+'&note=caTruc&region='+region;    
       		}  
    		else if (warningTp=='ALARM_EXTEND')
       		{
    			window.location = '${pageContext.request.contextPath}/alarmExtend/delete.htm?id='+row.id+'&note=caTruc&region='+region;    
       		}
    		else if (warningTp=='TEMPERATURE_SITE')
       		{
    			window.location = '${pageContext.request.contextPath}/monitor/temperaturedelete.htm?idList='+row.id+'&note=caTruc&region='+region;   
       		}
    		else if (warningTp=='WOTK_SHIFT')
       		{
           		window.location = '${pageContext.request.contextPath}/working/delete.htm?idList='+row.id+'&type=&note=caTruc&region='+region;   
    ...
    if ($.trim($(args).text()) == '<fmt:message key="global.button.exportExcel"/>')  {
    	/*  $("#grid").jqxGrid('exportdata', 'xls', exportFileName);     */
    	 window.open('${pageContext.request.contextPath}/caTruc/export.htm?warningtype='+"<c:out value='${warningTp}'/>"+'&shiftid='+"<c:out value='${caTK}'/>"+
    ...
    if ($.trim($(args).text()) == '<fmt:message key="global.button.sendMessage"/>')
    {
    	...
    	else if (warningTp=='SU_CO_KHAC')
   		{
    		var content="SU_CO_KHAC: "+row.alarm+".\n";
        	content+="Thiet bi:"+row.system+".\n";
        	
        	$("#title").val("SU_CO_KHAC");
    		$("#sendTo").val("");
        	$("#sendToCb").val("");
            $("#content").val(content);
		}
    	else if (warningTp=='LOI_TRUYEN_DAN')
   		{
    		var content="LOI_TRUYEN_DAN: "+row.alarm+".\n";
        	content+="Thiet bi:"+row.system+".\n";
        	
        	$("#title").val("LOI_TRUYEN_DAN");
    		$("#sendTo").val("");
        	$("#sendToCb").val("");
            $("#content").val(content);
		}
