...
<div  style="overflow: auto;">
		<display:table name="${vAlDyTransErrDipAll2G}" id="vAlDyTransErrDipAll2G" requestURI="" pagesize="100" class="simple3" export="true">
		    ...
		    <display:column property="cause" titleKey="CAUSE" sortable="true"/>
		</display:table>
	</div>
