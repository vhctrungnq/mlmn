...
<content tag="heading">LIST CELL CONGESTION TCH DAILY BY CENTER</content>
<ul class="ui-tabs-nav">
	...
	<li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report-blk/radio/bad-cell/by-region/list.htm?startDate=${startDate}&endDate=${endDate}"><span>Cell nghẽn TCH by Center</span></a></li>
</ul>
