...
<c:choose>
 	<c:when test="${function=='accessibility' }">
 		<content tag="heading">CELL ${cellName} ACCESSIBILITY BH REPORT</content>
 	</c:when>
 	<c:when test="${function=='mobility' }">
  	 	<content tag="heading">CELL ${cellName} MOBILITY BH REPORT</content>	
 	</c:when>
 	<c:when test="${function=='retainability' }">
  		<content tag="heading">CELL ${cellName} RETAINABILITY BH REPORT</content>	
 	</c:when>
 	<c:when test="${function=='traffic' }">
 	 	<content tag="heading">CELL ${cellName} TRAFFIC BH REPORT</content>	
 	</c:when>
 	<c:otherwise>
 		<content tag="heading">CELL ${cellName} QOS BH REPORT</content>	
 	</c:otherwise>
</c:choose>
<ul class="ui-tabs-nav">
  ...
  <li class=""><a href="${pageContext.request.contextPath}/report/radio3g/cell/dy/detail.htm?function=${function}&cellName=${cellName}&bscid=${bscid}&startDate=${startDate}&endDate=${endDate}"><span>Báo cáo ngày</span></a></li>
  ...
  <li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio3g/cell/dy/bhDetails.htm?function=${function}&cellName=${cellName}&bscid=${bscid}&startDate=${startDate}&endDate=${endDate}"><span>Báo cáo BH ngày</span></a></li>
	...
	<div class="tableStandar">
		...
		<%-- 	    <display:column property="vendor" titleKey="Vendor"  headerClass="master-header-1" sortable="true"  style="width:120px"/>  
		 --%>	    <display:column property="bscid" titleKey="RNC" sortable="true" headerClass="hide" class="hide"/>
			    ...
			    <display:column titleKey="Busy Hour" sortable="true" headerClass="master-header-1 margin" class="margin" sortProperty="hour">
			    	${vRpDyCell.hour} 
			    </display:column><c:choose>
			    	<c:when test="${function=='accessibility' }">
					    ...
					    <display:column titleKey="SPEECH_CSSR" class="SPEECH_CSSR" sortable="true" headerClass="master-header-4"  media="html" sortName="SPEECH_CSSR">
					    	<a href="${pageContext.request.contextPath}/report/radio3g/cell/cssr/dy.htm?bscid=${vRpDyCell.bscid}&cellName=${vRpDyCell.cellName}&endDate=<fmt:formatDate pattern="dd/MM/yyyy" value="${vRpDyCell.day}"/>">${vRpDyCell.speechCssr}</a>
					    </display:column>
					    ...
					    <display:column titleKey="SPEECH_DRPR" class="SPEECH_DRPR" sortable="true" headerClass="master-header-5"  media="html" sortName="SPEECH_DRPR">
					    	<a href="${pageContext.request.contextPath}/report/radio3g/cell/drop/dy.htm?bscid=${vRpDyCell.bscid}&cellName=${vRpDyCell.cellName}&endDate=<fmt:formatDate pattern="dd/MM/yyyy" value="${vRpDyCell.day}"/>">${vRpDyCell.speechDrpr}</a>
					    </display:column>
