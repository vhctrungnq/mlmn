...
<content tag="heading">UNAVAILABLE CELLS HOURLY REPORT</content>

<ul class="ui-tabs-nav">
  <li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio3g/cell-available/hr.htm?bscid=${bsc.bscid}&cellid=${cell.cellid}&startHour=${startHour}&startDate=${startDate}&endHour=${endHour}&endDate=${endDate}"><span>Báo cáo giờ</span></a></li>
  <li class=""><a href="${pageContext.request.contextPath}/report/radio3g/cell-available/dy.htm?bscid=${bsc.bscid}"><span>Báo cáo ngày</span></a></li>
