...
<content tag="heading">LIST BAD CELL 3G BY DISTRICT DAILY</content>
<ul class="ui-tabs-nav">
	...
	<li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio3g/bad-cell/by-district/list.htm?startDate=${startDate}&endDate=${endDate}"><span>Bad Cell by District</span></a></li>
...
<div class="ui-tabs-panel">
	<span>theo ngày</span>&nbsp;
	<a href="${pageContext.request.contextPath}/report/radio3g/bad-cell/by-district/wk/list.htm?district=${district}"><span>theo tuần</span></a>&nbsp;
	...
	<div  style="overflow: auto;">
		<display:table name="${dyBadCell3GList}" id="dyBadCell3GList" requestURI="" pagesize="100" class="simple3" export="true">
