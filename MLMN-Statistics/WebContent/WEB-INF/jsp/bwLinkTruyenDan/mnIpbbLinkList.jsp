...
<title>Báo cáo BW link truyền dẫn tháng</title>
<content tag="heading">Báo cáo BW link truyền dẫn tháng</content>
...
<ul class="ui-tabs-nav">
	...
	<li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/core/ipbb-link/mn-link.htm"><span>Báo cáo tháng</span></a></li>
...
<br>
<form method="get" action="mn-link.htm">
		...
		<tr>
			<td align="left">
               ...
               &nbsp;&nbsp;Link 
		        ...
		        &nbsp;&nbsp;Từ tháng <input value="${startMonth}" name="startMonth" id="startMonth" maxlength="2" class="wid3">
		        &nbsp;năm <input value="${startYear}" name="startYear" id="startYear" maxlength="4" class="wid5">
		        
                &nbsp;&nbsp;đến tháng <input value="${endMonth}" name="endMonth" id="endMonth" maxlength="2" class="wid3">
...
<div  style="overflow: auto;" class="wid100" >
	<display:table name="${monthList}" id="monthList" requestURI="" pagesize="100" class="simple2" export="true">
			<display:column property="year" titleKey="year" sortName="year" sortable="true" headerClass="master-header-1"/>
			<display:column property="month" titleKey="month" sortName="month" sortable="true" headerClass="master-header-1 margin" class="margin"/>
