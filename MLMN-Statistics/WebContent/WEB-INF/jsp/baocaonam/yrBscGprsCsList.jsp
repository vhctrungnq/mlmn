...
<title>BSC GPRS-CS YEARLY REPORT</title>
<content tag="heading">BSC GPRS-CS YEARLY REPORT</content>
<ul class="ui-tabs-nav">
	...
	<li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio/bsc-gprs-cs/yr/list.htm"><span>Báo cáo năm</span></a></li>
</ul>
...
<div  style="overflow: auto;" class="tableStandar" id = "doublescroll">
	<display:table style = "width: 150%"  name="${vRpYrBscGprsCs}" id="item" requestURI="" pagesize="100" class="simple2" export="true" sort="list">
