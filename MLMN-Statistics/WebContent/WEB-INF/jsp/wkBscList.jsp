...
<content tag="heading">BSC QOS WEEKLY REPORT</content>
<ul class="ui-tabs-nav">
	<li class=""><a href="${pageContext.request.contextPath}/report/radio/bsc/dy/list.htm"><span>Báo cáo ngày</span></a></li>
	<li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio/bsc/wk/list.htm"><span>Báo cáo tuần</span></a></li>
...
<display:table name="${vRpWkBsc}" id="vRpWkBsc" requestURI="" pagesize="100" class="simple2" export="true">
	    ...
	    <display:column titleKey="BSC" media="html" sortable="true" sortProperty="bscid">
	    	<a href="${pageContext.request.contextPath}/report/radio/bsc/wk/detail.htm?bscid=${vRpWkBsc.bscid}&endWeek=${vRpWkBsc.week}&endYear=${vRpWkBsc.year}&startWeek=${vRpWkBsc.week}&startYear=${vRpWkBsc.year}">${vRpWkBsc.bscid}</a>
	    </display:column>
	    ...
	    <display:column titleKey="SITES" media="html" sortable="true" sortProperty="sites">
	    	<a href="${pageContext.request.contextPath}/report/radio/site-qos/wk/list.htm?bscid=${vRpWkBsc.bscid}&week=${vRpWkBsc.week}&year=${vRpWkBsc.year}"><fmt:formatNumber pattern="#,###,###,##0.##" value="${vRpWkBsc.sites}"/></a>
	    </display:column>
	    ...
	    <display:column titleKey="CELLS" media="html" sortable="true" sortProperty="cells">
	    	<a href="${pageContext.request.contextPath}/report/radio/cell/wk/list.htm?bscid=${vRpMnBsc.bscid}&week=${vRpWkBsc.week}&year=${vRpWkBsc.year}"><fmt:formatNumber pattern="#,###,###,##0.##" value="${vRpWkBsc.cells}"/></a>
	    </display:column>
	    ...
	    <display:column property ="tHoblkr" titleKey="T_HOBLKR" sortable="true" headerClass="margin" class="T_HOBLKR"/>
