...
<ul class="ui-tabs-nav">
  ...
  <li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio/cell-gprs-qos/dy/detail.htm?cellid=${cellid}&bscid=${bscid}&endDate=${endDate}"><span>Báo cáo ngày</span></a></li>
...
<display:table name="${vRpDyCellGprsQosList}" id="vRpDyCellGprsQos" requestURI="" pagesize="100" class="simple2" export="true">
			   ...
			   <display:column property="province" titleKey="PROVINCE"/> 
			    ...
			    <display:column titleKey="CELL" media="html">
			    	<a href="${pageContext.request.contextPath}/report/radio/cell-gprs-qos/hr/detail.htm?bscid=${vRpDyCellGprsQos.bscid}&cellid=${vRpDyCellGprsQos.cellid}&endDate=<fmt:formatDate pattern="dd/MM/yyyy" value="${vRpDyCellGprsQos.day}"/>">${vRpDyCellGprsQos.cellid}</a>
			    </display:column>
