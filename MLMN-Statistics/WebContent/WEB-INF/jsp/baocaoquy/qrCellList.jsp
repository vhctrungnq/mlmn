...
<title>CELL QOS QUARTER REPORT</title>
<content tag="heading">CELL QOS QUARTER REPORT</content>
<ul class="ui-tabs-nav"> 
	...
	<li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio/cell/qr/list.htm"><span>Báo cáo quý</span></a></li>
...
<div class="ui-tabs-panel">
	...
	<display:table name="${vRpQrCellQosList}" id="item" class="simple2" export="true" requestURI="" pagesize="50" sort="external" defaultsort="1">
		<display:column property="quarter" title="Quarter" sortable="true" sortName="quarter" headerClass="master-header-1"/>
	    ...
	    <%-- <display:column titleKey="PROVINCE" media="html" sortable="true" sortName="province" style = "width: 120px" headerClass="master-header-1">
	    	<a href="${pageContext.request.contextPath}/report/radio/province/mn/detail.htm?province=${item.province}&endMonth=${item.month}&endYear=${item.year}">${item.province}</a>
	    </display:column>	 --%>		    
