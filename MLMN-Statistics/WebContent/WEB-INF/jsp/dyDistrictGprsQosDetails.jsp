...
<ul class="ui-tabs-nav">
  ...
  <li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio/district-gprs-qos/dy/details.htm?province=${province}&district=${district}&endDate=${endDate}"><span>Báo cáo ngày</span></a></li>
...
<display:table name="${vRpDyDistrictGprsQosDetails}" id="vRpDyDistrictGprsQosDetail" requestURI="" pagesize="100" class="simple2" export="true">
    	...
    	<a href="${pageContext.request.contextPath}/report/radio/province-gprs-qos/hr/details.htm?province=${vRpDyDistrictGprsQosDetail.province}&endDate=<fmt:formatDate pattern="dd/MM/yyyy" value="${vRpDyDistrictGprsQosDetail.day}"/>">${vRpDyDistrictGprsQosDetail.province}</a>&nbsp;
    	</display:column>
    	...
    	<a href="${pageContext.request.contextPath}/report/radio/district-gprs-qos/hr/details.htm?province=${vRpDyDistrictGprsQosDetail.province}&district=${vRpDyDistrictGprsQosDetail.district}&endDate=<fmt:formatDate pattern="dd/MM/yyyy" value="${vRpDyDistrictGprsQosDetail.day}"/>">${vRpDyDistrictGprsQosDetail.district}</a>&nbsp;
    	</display:column> 
	...
	$(function() {
		...
		$( '.checkAll' ).live( 'change', function() {
			...
			if($( this ).is( ':checked' )){
				for (var i=7;i<=15;i++)
				{
					$('#vRpDyDistrictGprsQosDetail td:nth-child('+i+'),#vRpDyDistrictGprsQosDetail th:nth-child('+i+')').show();
				}
			} else {
				for (var i=7;i<=15;i++)
				{
					$('#vRpDyDistrictGprsQosDetail td:nth-child('+i+'),#vRpDyDistrictGprsQosDetail th:nth-child('+i+')').hide();
				}
			}
		});
