...
<content tag="heading">LOW TRAFFIC CELL HOURLY REPORT</content>

<ul class="ui-tabs-nav">
  <li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio/bad-cell/lowtraffic/hr.htm?bscid=${bsc.bscid}&cellid=${cell.cellid}&startDate=${startDate}&startHour=${startHour}&endDate=${endDate}&endHour=${endHour}"><span>Báo cáo giờ</span></a></li>
  <li class=""><a href="${pageContext.request.contextPath}/report/radio/bad-cell/lowtraffic/dy.htm?bscid=${bsc.bscid}"><span>Báo cáo ngày</span></a></li>
...
<div class="ui-tabs-panel">
 <form:form commandName="filterlow" method="post" action="hr.htm" name = "frmSample" onSubmit = "return ValidateForm()">
