...
<ul class="ui-tabs-nav">
  ...
  <li class=""><a href="${pageContext.request.contextPath}/report/radio/bsc-gprs-cs/wk/detail.htm?bscid=${bscid}&endWeek=${endWeek}&endYear=${endYear}"><span>Báo cáo tuần</span></a></li>
  ...
  <li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio/bsc-gprs-cs/wk/bh.htm?bscid=${bscid}&endWeek=${endWeek}&endYear=${endYear}"><span>Báo cáo BH tuần</span></a></li>
...
<br/>
	<div  id="doublescroll">
<display:table name="${vRpWkBscGprsCsBh}" id="vRpWkBscGprsCsBh" requestURI="" pagesize="100" class="simple2" export="true">
	    ...
	    <display:column titleKey="BSC" media="html">
	    	<a href="${pageContext.request.contextPath}/report/radio/bsc-gprs-cs/wk/detail.htm?bscid=${vRpWkBscGprsCsBh.bscid}&endWeek=${week}&endYear=${year}">${vRpWkBscGprsCsBh.bscid}</a>&nbsp;
	    </display:column>
	...
	$(function() {
		$( '.checkAll' ).live( 'change', function() {
			...
			if($( this ).is( ':checked' )){
				for (var i=5;i<=17;i++)
				{
					$('#vRpWkBscGprsCsBh td:nth-child('+i+'),#vRpWkBscGprsCsBh th:nth-child('+i+')').show();
				}
			} else {
				for (var i=5;i<=17;i++)
				{
					$('#vRpWkBscGprsCsBh td:nth-child('+i+'),#vRpWkBscGprsCsBh th:nth-child('+i+')').hide();
				}
			}
		});
