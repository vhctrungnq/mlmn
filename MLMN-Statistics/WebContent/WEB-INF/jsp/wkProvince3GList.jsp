...
<content tag="heading">PROVINCE QOS 3G WEEKLY REPORT</content>
<ul class="ui-tabs-nav">
	<li class=""><a href="${pageContext.request.contextPath}/report/radio3g/province/dy/list.htm"><span>Báo cáo ngày</span></a></li>
	<li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio3g/province/wk/list.htm"><span>Báo cáo tuần</span></a></li>
...
<div  id="doublescroll">
	<display:table name="${vRpWkProvince}" id="vRpWkProvince" requestURI="" pagesize="100" class="simple2" export="true" sort="list">
	    ...
	    <display:column titleKey="Province" media="html" headerClass="master-header-1" sortable="true" sortProperty="province">
	    	<a href="${pageContext.request.contextPath}/report/radio3g/province/wk/detail.htm?province=${vRpWkProvince.province}&endWeek=${vRpWkProvince.week}&endYear=${vRpWkProvince.year}">${vRpWkProvince.province}</a>
	    </display:column>
