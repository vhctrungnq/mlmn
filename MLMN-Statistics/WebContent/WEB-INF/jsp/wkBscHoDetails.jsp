...
<title>bsc handover weekly report</title>
<content tag="heading">BSC HANDOVER WEEKLY REPORT ${bscid}</content>
<ul class="ui-tabs-nav">
  <li class=""><a href="/VMSC2-Statistics/report/radio/bsc-ho/hr/details.htm?bscid=${bscid}&day=${endDate}"><span>Báo cáo giờ</span></a></li>
  <li class=""><a href="/VMSC2-Statistics/report/radio/bsc-ho/dy/details.htm?bscid=${bscid}"><span>Báo cáo ngày</span></a></li>
  <li class="ui-tabs-selected"><a href="/VMSC2-Statistics/report/radio/bsc-ho/wk/details.htm?bscid=${bscid}&endWeek=${endWeek}&endYear=${endYear}"><span>Báo cáo tuần</span></a></li>
  <li class=""><a href="/VMSC2-Statistics/report/radio/bsc-ho/mn/details.htm?bscid=${bscid}"><span>Báo cáo tháng</span></a></li>
  <li class=""><a href="/VMSC2-Statistics/report/radio/bsc-ho/dy/bhDetails.htm?bscid=${bscid}"><span>Báo cáo BH ngày</span></a></li>
  <li class=""><a href="/VMSC2-Statistics/report/radio/bsc-ho/wk/bhDetails.htm?bscid=${bscid}&endWeek=${endWeek}&endYear=${endYear}"><span>Báo cáo BH tuần</span></a></li>
  <li class=""><a href="/VMSC2-Statistics/report/radio/bsc-ho/mn/bhDetails.htm?bscid=${bscid}"><span>Báo cáo BH tháng</span></a></li>
</ul>
...
<display:table name="${vRpWkBscHoDetails}" id="vRpWkBscHoDetail" requestURI="" pagesize="100" class="simple2" export="true">
	...
	$(function() {
		$( '.checkAll' ).live( 'change', function() {
			...
			if($( this ).is( ':checked' )){
				for (var i=5;i<=10;i++)
				{
					$('#vRpWkBscHoDetail td:nth-child('+i+'),#vRpWkBscHoDetail th:nth-child('+i+')').show();
				}
			} else {
				for (var i=5;i<=10;i++)
				{
					$('#vRpWkBscHoDetail td:nth-child('+i+'),#vRpWkBscHoDetail th:nth-child('+i+')').hide();
				}
			}
		});
