...
<content tag="heading">MSC TRUNKROUTE PERFORMANCE BC HOURLY REPORT</content>
...
<div  id="doublescroll">
		<display:table name="${hrMSCTrunkBC}" id="hrMSCTrunkBC" requestURI="" pagesize="100" class="simple3" export="true">
			<display:column property="mscid" titleKey="SYSTEM" sortable="true"/>
		    <display:column property="routeid" titleKey="ROUTE" sortable="true"/>
		     <display:column property="bc" titleKey="BC" sortable="true"/>
