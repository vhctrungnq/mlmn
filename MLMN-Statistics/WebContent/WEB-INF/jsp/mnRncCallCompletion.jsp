...
<content tag="heading">RNC CALL COMPLETION MONTHLY REPORT</content>
...
<ul class="ui-tabs-nav">
  ...
  <li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio3g/rnc-call-completion/mn.htm?bscid=${bsc.bscid}&mscid=${msc.mscid}&region=${region}&startMonth=${startMonth}&startYear=${startYear}&endMonth=${endMonth}&endYear=${endYear}"><span>Báo cáo tháng</span></a></li>
</ul>
