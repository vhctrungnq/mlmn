...
<content tag="heading">DISTRICT QOS MONTHLY REPORT</content>
<ul class="ui-tabs-nav">
	...
	<li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio/district/mn/list.htm"><span>Báo cáo tháng</span></a></li>
...
<display:table name="${vRpMnDistrict}" id="vRpMnDistrict" requestURI="" pagesize="100" class="simple2" export="true" sort="list">
			    ...
			    <display:column titleKey="PROVINCE" media="html" sortable="true" sortProperty="province">
			    	<a href="${pageContext.request.contextPath}/report/radio/province/mn/detail.htm?province=${vRpMnDistrict.province}&endMonth=${vRpMnDistrict.month}&endYear=${vRpMnDistrict.year}">${vRpMnDistrict.province}</a>
			    </display:column>
			    ...
			    <display:column titleKey="DISTRICT" media="html" sortable="true" sortProperty="district">
			    	<a href="${pageContext.request.contextPath}/report/radio/district/mn/detail.htm?province=${vRpMnDistrict.province}&district=${vRpMnDistrict.district}&endMonth=${vRpMnDistrict.month}&endYear=${vRpMnDistrict.year}">${vRpMnDistrict.district}</a>
			    </display:column>
			    ...
			    <display:column titleKey="SITES" media="html" sortable="true" sortProperty="sites">
			    	<a href="${pageContext.request.contextPath}/report/radio/site-qos/mn/list.htm?province=${vRpMnDistrict.province}&month=${vRpMnDistrict.month}&year=${vRpMnDistrict.year}"><fmt:formatNumber pattern="#,###,###,##0.##" value="${vRpMnDistrict.sites}"/></a>
			    </display:column>
			    ...
			    <display:column titleKey="CELLS" media="html" sortable="true" sortProperty="cells">
			    	<a href="${pageContext.request.contextPath}/report/radio/cell/mn/list.htm?province=${vRpMnDistrict.province}&month=${vRpMnDistrict.month}&year=${vRpMnDistrict.year}"><fmt:formatNumber pattern="#,###,###,##0.##" value="${vRpMnDistrict.cells}"/></a>
			    </display:column>
