...
<form:form commandName="filter" method="get" action="antenna.htm">
	<table>
		<tr>
	    	...
	    	<td>
	    		<input type ="text" value="${startTime}" name="startTime" id="startTime" size="16" maxlength="16" width="60px">
	   			 <img alt="calendar" title="Click to choose the start date" id="chooseStartDate" style="cursor: pointer;" src="${pageContext.request.contextPath}/images/calendar.png"/>
	    	</td>
	    	<td style="width:70px; padding-left:5px;" align="left"><fmt:message key="AlDyNonFinishDetail.endT"/> </td>
	    	<td>
	    		<input type ="text" value="${endTime}" name="endTime" id="endTime" size="16" maxlength="16" width="60px">
		...
		<tr>
			<td ><fmt:message key="vAlRbLossAntenna.alarmLevel"/></td>
			<td>
  ...
  <div id="doublescroll" >
	<display:table name="${alarmList}"  class="simple2" id="item" requestURI="" pagesize="50" sort="external" defaultsort="1" export="true">
		...
		<display:column property="day" format="{0,date,dd/MM/yyyy}" titleKey="AlDyNonFinishDetail.day" sortable="true" sortName="DAY" style="min-width:60px;max-width:60px;"/>
	  	<display:column property="bscid" titleKey="vAlRbLossAntenna.rncid" sortable="true" sortName="BSCID"  style="min-width:60px;max-width:60px;"/>
	  	<display:column property="site" titleKey="AlDyNonFinishDetail.site" sortable="true" sortName="SITE"  style="min-width:60px;max-width:60px;"/>
		...
		<display:column property="teamProcess" titleKey="vAlRbLossAntenna.dvtTeamProcess" sortable="true" sortName="TEAM_PROCESS" style="min-width:100px;max-width:100px;"/>
		<display:column property="causebyContent" titleKey="vAlRbLossAntenna.causeby" sortable="true" sortName="CAUSEBY_CONTENT" style="min-width:150px;"/>
		<display:column property="resultContent"  titleKey="AlDyNonFinishDetail.resultContent" sortable="true" sortName="RESULT_CONTENT" style="min-width:150px;"/>
		<c:if test="${checkCaTruc==true}">
			...
			<a href="antenna_form.htm?id=${item.id}"><fmt:message key="button.edit"/></a>&nbsp;
	 			<a href="antenna_delete.htm?id=${item.id}"
