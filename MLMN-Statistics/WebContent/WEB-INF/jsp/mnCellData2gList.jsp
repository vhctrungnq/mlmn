...
<content tag="heading">CELL DATA 2G MONTHLY REPORT</content>
<ul class="ui-tabs-nav">
	...
	<li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio/cell-data/mn/list.htm"><span>Báo cáo tháng</span></a></li>
...
<div class="ui-tabs-panel">
	...
	<div  id="doublescroll">
	<display:table  style="width:150%" name="${vRpMnCellData2g}" id="vRpMnCell" requestURI="" pagesize="100" class="simple2" export="true" sort="list">
