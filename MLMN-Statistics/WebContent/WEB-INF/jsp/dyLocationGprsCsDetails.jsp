...
<ul class="ui-tabs-nav">
  ...
  <li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio/location-gprs-cs/dy/details.htm?location=${location}&endDate=${endDate}"><span>Báo cáo ngày</span></a></li>
...
<div class="ui-tabs-panel">
	...
	<br/>
	<div  id="doublescroll">
<display:table name="${vRpDyLocationGprsCsDetails}" id="vRpDyLocationGprsCsDetail" requestURI="" pagesize="100" class="simple2" export="true">
	...
	$(function() {
		...
		$( '.checkAll' ).live( 'change', function() {
			...
			if($( this ).is( ':checked' )){
				for (var i=4;i<=17;i++)
				{
					$('#vRpDyLocationGprsCsDetail td:nth-child('+i+'),#vRpDyLocationGprsCsDetail th:nth-child('+i+')').show();
				}
			} else {
				for (var i=4;i<=17;i++)
				{
					$('#vRpDyLocationGprsCsDetail td:nth-child('+i+'),#vRpDyLocationGprsCsDetail th:nth-child('+i+')').hide();
				}
			}
		});
