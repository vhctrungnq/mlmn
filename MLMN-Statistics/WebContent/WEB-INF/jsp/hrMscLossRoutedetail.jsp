...
<div  id="doublescroll">
		<display:table name="${hrMscLRdetail}" id="hrMscLRdetail" requestURI="" pagesize="100" class="simple3" export="true">
		 	<display:column property="mscid" titleKey="SYSTEM"/>
		 	<display:column property="routeid" titleKey="ROUTEID" headerClass="hide" class="hide"/>
		 	<display:column title="ROUTEID" media="html">
		   	 	<a target="_blank" href="${pageContext.request.contextPath}/report/core-era/loss-route/msc/list.htm?routeid=${hrMscLRdetail.routeid}&startDate=<fmt:formatDate pattern="dd/MM/yyyy" value="${hrMscLRdetail.day}"/>&endDate=<fmt:formatDate pattern="dd/MM/yyyy" value="${hrMscLRdetail.day}"/>">${hrMscLRdetail.routeid}</a>
		    </display:column>
