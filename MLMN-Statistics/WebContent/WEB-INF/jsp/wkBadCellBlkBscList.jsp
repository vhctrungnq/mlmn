...
<content tag="heading">LIST CELL CONGESTION TCH WEEKLY BY BSC</content>
<ul class="ui-tabs-nav">
	...
	<li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio/bad-cell-blk/by-bsc/list.htm?startDate=${startDate}&endDate=${endDate}"><span>Cell nghẽn TCH by Bsc</span></a></li>
...
<div class="ui-tabs-panel">
	<a href="${pageContext.request.contextPath}/report/radio/bad-cell-blk/by-bsc/list.htm?startDate=${startDate}&endDate=${endDate}"><span>Theo Ngày</span></a>
<span>Theo Tuần</span>
<a href="${pageContext.request.contextPath}/report/radio/bad-cell-blk/by-bsc/mnList.htm?endMonth=${endMonth}&endYear=${endYear}"><span>Theo Tháng</span></a>
