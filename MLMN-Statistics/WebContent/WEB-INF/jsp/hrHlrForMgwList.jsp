...
<content tag="heading">NG HLR FOR MGW HOURLY REPORT</content>
 
  <ul class="ui-tabs-nav">
  <li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/core/hlr-for-mgw/hr.htm?nodeid=${node.nodeid}&startDate=${startDate}&startHour=${startHour}&endDate=${endDate}&endHour=${endHour}"><span>Báo cáo giờ</span></a></li>
  <li class=""><a href="${pageContext.request.contextPath}/report/core/hlr-for-mgw/dy.htm?nodeid=${node.nodeid}&startDate=${startDate}&endDate=${endDate}"><span>Báo cáo ngày</span></a></li>
</ul>
...
<div  id="doublescroll">
		<display:table name="${vRpHrHlrForMgw}" id="vRpHrHlrForMgw" requestURI="" pagesize="100" class="simple3" export="true">
		   		<display:column property="nodeid" titleKey="NODE"/>		   
		    	<display:column property ="day" format="{0,date,dd/MM/yyyy}" titleKey="Day" />
		    	<display:column property="hour" titleKey="HOUR"/>
		    	<display:column property="occupiedRateOfCpu" titleKey="Average CPU Ussage"/>
			    <display:column property="usageFlow" titleKey="TC Ussage"/>
			    <display:column property="ipFlow" titleKey="GE Ip Flow Ussage"/>
		</display:table>
	</div>
