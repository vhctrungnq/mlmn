...
<title>REPORT BRANCH ${branch}</title>
<content tag="heading">REPORT BRANCH ${branch}</content>
<ul class="ui-tabs-nav">
  <li class=""><a href="${pageContext.request.contextPath}/report/radio/branch/hr/detail.htm?branch=${branch}&endDate=${endDate}"><span>Báo cáo giờ</span></a></li>
  <li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio/branch/dy/detail.htm?branch=${branch}&endDate=${endDate}"><span>Báo cáo ngày</span></a></li>
...
<display:table name="${vRpDyBranchList}" id="vRpDyBranch" requestURI="" pagesize="100" class="simple2" export="true" sort="list">
