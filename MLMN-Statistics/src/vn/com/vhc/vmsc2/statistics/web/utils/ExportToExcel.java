...
public class ExportToExcel implements BinaryExportView
{
           ...
           /* headerStyle.setFillBackgroundColor(HSSFColor.BLUE_GREY.index);*/
            ...
            if (caption!=null && !caption.equals(""))
            {
	           ...
	           // bold2.setBoldweight(HSSFFont.BOLDWEIGHT_BOLD);
	            ...
	            sheet.addMergedRegion(new CellRangeAddress(xlsRow1.getRowNum(),cell1.getColumnIndex(), xlsRow1.getRowNum(), (model.getNumberOfColumns() - 1)));
	            ...
	            if (ctionList.length>1)
	            {
		           	 ...
		           	 for (int i=1;i<ctionList.length;i++){
		                   ...
		                   //  sheet.addMergedRegion(new CellRangeAddress(xlsRow2.getRowNum(),cell2.getColumnIndex(), xlsRow2.getRowNum(), (model.getNumberOfColumns() - 1)));
    ...
    static class ExcelGenerationException extends BaseNestableJspTagException
    {
        ...
        {
            super(ExportToExcel.class, Messages.getString("ExcelView.errorexporting"), cause); //$NON-NLS-1$
        }
