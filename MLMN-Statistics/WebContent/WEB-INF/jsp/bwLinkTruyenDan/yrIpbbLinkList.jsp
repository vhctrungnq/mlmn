...
<title>Báo cáo BW link truyền dẫn năm</title>
<content tag="heading">Báo cáo BW link truyền dẫn năm</content>
...
<ul class="ui-tabs-nav">
	...
	<li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/core/ipbb-link/yr-link.htm"><span>Báo cáo năm</span></a></li>
</ul>

<br>
<form method="get" action="yr-link.htm">
		...
		<tr>
			<td align="left">
               ...
               &nbsp;&nbsp;Link 
		        ...
		        &nbsp;&nbsp;Từ năm <input value="${startYear}" name="startYear" id="startYear" maxlength="4"  class="wid5">
                &nbsp;&nbsp;đến năm <input value="${endYear}" name="endYear" id="endYear" maxlength="4"  class="wid5">
...
<div  style="overflow: auto;" class="wid100" >
	<display:table name="${yearList}" id="yearList" requestURI="" pagesize="100" class="simple2" export="true">
