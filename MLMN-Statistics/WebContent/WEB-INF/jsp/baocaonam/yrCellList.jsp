...
<title>CELL QOS YEAR REPORT</title>
<content tag="heading">CELL QOS YEAR REPORT</content>
<ul class="ui-tabs-nav">
	...
	<li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio/cell/yr/list.htm"><span>Báo cáo năm</span></a></li>
</ul>
<div class="ui-tabs-panel">
	...
	<display:table name="${vRpYrCellQosList}" id="item" class="simple2" export="true" requestURI="" pagesize="50" sort="external" defaultsort="1">
