...
<div  id="doublescroll">
		<display:table name="${HrMscpooluser}" id="HrMscpooluser" requestURI="" pagesize="100" class="simple3" export="true">
		    <display:column property="mscid" titleKey="SYSTEM"/>
		    <display:column property="userlabel" titleKey="User lable"/>
