...
<content tag="heading">BSC IBC HANDOVER MONTHLY REPORT ${bscid}</content>
<ul class="ui-tabs-nav">
  ...
  <li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio/ibc/bsc-ho/mn/details.htm?bscid=${bscid}&endMonth=${endMonth}&endYear=${endYear}"><span>Báo cáo tháng</span></a></li>
  ...
  <li class=""><a href="${pageContext.request.contextPath}/report/radio/ibc/bsc-ho/mn/bhDetails.htm?bscid=${bscid}&endMonth=${endMonth}&endYear=${endYear}"><span>Báo cáo BH tháng</span></a></li>
</ul>
...
<display:table name="${vRpMnBscHoIbcDetails}" id="vRpMnBscHoIbcDetail" requestURI="" pagesize="100" class="simple2" export="true">
	...
	$(function() {
		$( '.checkAll' ).live( 'change', function() {
			...
			if($( this ).is( ':checked' )){
				for (var i=5;i<=10;i++)
				{
					$('#vRpMnBscHoIbcDetail td:nth-child('+i+'),#vRpMnBscHoIbcDetail th:nth-child('+i+')').show();
				}
			} else {
				for (var i=5;i<=10;i++)
				{
					$('#vRpMnBscHoIbcDetail td:nth-child('+i+'),#vRpMnBscHoIbcDetail th:nth-child('+i+')').hide();
				}
			}
		});
