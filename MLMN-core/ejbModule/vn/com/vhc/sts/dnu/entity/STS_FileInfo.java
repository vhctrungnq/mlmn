...
public class STS_FileInfo extends STS_TaskInfo implements STS_DBLogParam {
    ...
    public String getSubDirectory() {
        ...
        if (!subDir.isEmpty() &&
            !subDir.substring(0, 1).equals(STS_Global.SEPARATOR)) {
            subDir = STS_Global.SEPARATOR + subDir;
        }
        return subDir;
    }
	...
	protected String getInsertSQL() {
        String execCommand = "";
        if (this.isRemoteType()) {
            String time = STS_Util.getTime(this.downloadTime, STS_Setting.TIME_FORMAT);
            execCommand =
