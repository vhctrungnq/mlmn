...
<content tag="heading">MSC RAB ASSIGMENT OBJ HOURLY REPORT</content>
...
<div  id="doublescroll">
		<display:table name="${hrMscRabasigObj}" id="hrMscRabasigObj" requestURI="" pagesize="100" class="simple3" export="true">
		 	<display:column property="mscid" titleKey="SYSTEM" headerClass="hide" class="hide"/>
		 	<display:column title="SYSTEM" media="html">
		   	 	<a target="_blank" href="${pageContext.request.contextPath}/report/core-era/rab-assig/msc/list.htm?mscid=${hrMscRabasigObj.mscid}&startDate=<fmt:formatDate pattern="dd/MM/yyyy" value="${hrMscRabasigObj.day}"/>&endDate=<fmt:formatDate pattern="dd/MM/yyyy" value="${hrMscRabasigObj.day}"/>">${hrMscRabasigObj.mscid}</a>
		    </display:column>
