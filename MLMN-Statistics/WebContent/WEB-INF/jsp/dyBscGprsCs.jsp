...
<title>Báo cáo GPRS-CS Bsc ${bscid}</title>
...
<ul class="ui-tabs-nav">
  ...
  <li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio/bsc-gprs-cs/dy/detail.htm?bscid=${bscid}&endDate=${endDate}"><span>Báo cáo ngày</span></a></li>
...
<br/>
			<div  id="doublescroll">
<display:table name="${vRpDyBscGprsCsList}" id="vRpDyBscGprsCs" requestURI="" pagesize="100" class="simple2" export="true">
    ...
    <display:column titleKey="BSC" media="html">
    	<a href="${pageContext.request.contextPath}/report/radio/bsc-gprs-cs/hr/detail.htm?bscid=${vRpDyBscGprsCs.bscid}&endDate=<fmt:formatDate pattern="dd/MM/yyyy" value="${vRpDyBscGprsCs.day}"/>">${vRpDyBscGprsCs.bscid}</a>&nbsp;
    </display:column> 
