...
<content tag="heading">MSC IP RESOURCE RESERVATION STS DATA DAILY REPORT</content>
 
<ul class="ui-tabs-nav">
  <li class=""><a href="${pageContext.request.contextPath}/report/core/resour-reservation/hr.htm?mscid=${msc.mscid}&startDate=${startDate}&endDate=${endDate}"><span>Báo cáo giờ</span></a></li>
  <li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/core/resour-reservation/dy.htm?mscid=${msc.mscid}&startDate=${startDate}&endDate=${endDate}"><span>Báo cáo ngày</span></a></li>
</ul>
...
<div  id="doublescroll">
		<display:table name="${DyMscIpResour}" id="DyMscIpResour" requestURI="" pagesize="100" class="simple3" export="true">
			<display:column property="mscid" titleKey="SYSTEM" headerClass="hide" class="hide"/>		   
		    <display:column title="SYSTEM" media="html">
		   	 	<a href="${pageContext.request.contextPath}/report/core/resour-reservation/hr.htm?mscid=${DyMscIpResour.mscid}&startDate=<fmt:formatDate pattern="dd/MM/yyyy" value="${DyMscIpResour.day}"/>&endDate=<fmt:formatDate pattern="dd/MM/yyyy" value="${DyMscIpResour.day}"/>">${DyMscIpResour.mscid}</a>
		    </display:column>
