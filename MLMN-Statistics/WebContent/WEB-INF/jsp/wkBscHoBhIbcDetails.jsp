...
<ul class="ui-tabs-nav">
  ...
  <li class=""><a href="${pageContext.request.contextPath}/report/radio/ibc/bsc-ho/wk/details.htm?bscid=${bscid}&endWeek=${endWeek}&endYear=${endYear}"><span>Báo cáo tuần</span></a></li>
  ...
  <li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio/ibc/bsc-ho/wk/bDdetails.htm?bscid=${bscid}&endWeek=${endWeek}&endYear=${endYear}"><span>Báo cáo BH tuần</span></a></li>
...
<display:table name="${vRpWkBscHoBhIbcDetails}" id="vRpWkBscHoBhIbcDetail" requestURI="" pagesize="100" class="simple2" export="true">
	...
	$(function() {
		$( '.checkAll' ).live( 'change', function() {
			...
			if($( this ).is( ':checked' )){
				for (var i=5;i<=10;i++)
				{
					$('#vRpWkBscHoBhIbcDetail td:nth-child('+i+'),#vRpWkBscHoBhIbcDetail th:nth-child('+i+')').show();
				}
			} else {
				for (var i=5;i<=10;i++)
				{
					$('#vRpWkBscHoBhIbcDetail td:nth-child('+i+'),#vRpWkBscHoBhIbcDetail th:nth-child('+i+')').hide();
				}
			}
		});
