...
<content tag="heading">RNC UTILITY BANDWIDTH ${title} REPORT</content>
...
<div  id="doublescroll">
		<display:table name="${dyBscList}" id="dyBscList" requestURI="" pagesize="100" class="simple2" export="true">
			...
			<display:column class="rightColumnMana"   decorator="vn.com.vhc.vmsc2.statistics.web.utils.NumberDecorator" property ="dlThroughput"  titleKey="DL Throughput"  sortable="true" />
			<display:column class="rightColumnMana"   decorator="vn.com.vhc.vmsc2.statistics.web.utils.NumberDecorator" property ="ulThroughput"  titleKey="UL Throughput"  sortable="true" />
			<display:column class="rightColumnMana"   decorator="vn.com.vhc.vmsc2.statistics.web.utils.NumberDecorator" property ="psDlThroughput"  titleKey="PS DL Throughput"  sortable="true" />
			<display:column class="rightColumnMana"   decorator="vn.com.vhc.vmsc2.statistics.web.utils.NumberDecorator" property ="psUlThroughput"  titleKey="PS UL Throughput"  sortable="true" />
			<display:column class="rightColumnMana"   decorator="vn.com.vhc.vmsc2.statistics.web.utils.NumberDecorator" property ="iubDlThroughput"  titleKey="IUB DL Throughput"  sortable="true" />
			<display:column class="rightColumnMana"   decorator="vn.com.vhc.vmsc2.statistics.web.utils.NumberDecorator" property ="iubUlThroughput"  titleKey="IUB UL Throughput"  sortable="true" />
			<c:if test="${level == 'dy'}"> 
