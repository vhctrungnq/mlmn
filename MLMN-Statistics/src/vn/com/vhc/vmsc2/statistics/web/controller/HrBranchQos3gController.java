...
import vn.com.vhc.vmsc2.statistics.dao.VRpHrBranch3GDAO;
...
@Controller
@RequestMapping("/report/radio3g/branch/hr/*")
public class HrBranchQos3gController extends BaseController {
	@Autowired
	private VRpHrBranch3GDAO vRpHrBranchDao;
	@Autowired
	...
	public String showReport(@RequestParam(required = false) String region,@RequestParam(required = true) String branch, @RequestParam(required = false) String startHour,
		...
		List<VRpHrBranch3G> vRpHrBranchList = new ArrayList<VRpHrBranch3G>();
		...
		for (VRpHrBranch3G vRpHrBranch : vRpHrBranchList) {
			categories.add(Integer.toString(vRpHrBranch.getHour())+":00 "+ddf.format(vRpHrBranch.getDay()));
			speechCssrList.add(vRpHrBranch.getSpeechCssr());
			cs64CssrList.add(vRpHrBranch.getCs64Cssr());
			psr99CssrList.add(vRpHrBranch.getPsr99Cssr());
			hsupaCssrList.add(vRpHrBranch.getHsupaCssr());
			hsdpaCssrList.add(vRpHrBranch.getHsdpaCssr());
			speechDrprList.add(vRpHrBranch.getSpeechDrpr());
			cs64DrprList.add(vRpHrBranch.getCs64Drpr());
			psr99DrprList.add(vRpHrBranch.getPsr99Drpr());
			hsupaDrprList.add(vRpHrBranch.getHsupaDrpr());
			hsdpaDrprList.add(vRpHrBranch.getHsdpaDrpr());
		}
		...
		model.addAttribute("checkColumns", Helper.checkColumns(checkColumns, "vRpHrBranch", 6));

		return "hrBranchQos3G";
	}
}
