...
<style type="text/css">    #doublescroll { overflow: auto; overflow-y: hidden; }    #doublescroll p { margin: 0; padding: 1em; white-space: nowrap; }</style><title>cell to cells qos 3g</title>
<content tag="heading">Báo cáo CELL TO CELLS QOS 3G</content>
<ul class="ui-tabs-nav">
  ...
  <li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio3g/cell/ho-cell-to-cell/dyCellToCells.htm?bscid=${bscid}&cellid=${cellid}&endDate=${endDate}"><span>Báo cáo ngày Cell to Cells</span></a></li>
  ...
  <li class=""><a href="${pageContext.request.contextPath}/report/radio3g/cell/ho-cell-to-cell/dyCellsToCell.htm?bscid=${bscid}&cellid=${cellid}&endDate=${endDate}"><span>Báo cáo ngày Cells to Cells</span></a></li>
</ul>
<div class="ui-tabs-panel">
		...
		<table width="100%" class="form">
			<tr>
			    <td align="left">
			  	  <form method="get" action="dyCellToCells.htm">
			       FROM RNC 
