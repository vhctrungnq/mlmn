...
<ul class="ui-tabs-nav">
	...
	<li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio/province-gprs-cs/yr/list.htm"><span>Báo cáo năm</span></a></li>
</ul>
<div class="ui-tabs-panel">
	...
	<div  style="overflow: auto;" class="tableStandar" id = "doublescroll">
		<display:table name="${vRpProvinceGprsCs}" id="item" requestURI="" pagesize="100" class="simple2" export="true">
