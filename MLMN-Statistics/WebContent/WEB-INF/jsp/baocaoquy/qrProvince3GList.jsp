...
<content tag="heading">PROVINCE QOS 3G QUARTERLY REPORT</content>
<ul class="ui-tabs-nav">
	...
	<li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio3g/province/qr/list.htm"><span>Báo cáo quý</span></a></li>
...
<display:table name="${vRpQrProvince3G}" id="item" requestURI="" pagesize="100" class="simple2" export="true" sort="list">
