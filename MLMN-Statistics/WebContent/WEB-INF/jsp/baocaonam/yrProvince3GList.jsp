...
<content tag="heading">PROVINCE QOS 3G YEARLY REPORT</content>
<ul class="ui-tabs-nav">
	...
	<li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio3g/province/yr/list.htm"><span>Báo cáo năm</span></a></li>
</ul>
		...
		<tr>
			<td align="left">
				<form method="get" action="list.htm">
					...
					&nbsp;Từ năm <input value="${startYear}" name="startYear"
						id="startYear" size="4" maxlength="4"> &nbsp;Tơi năm <input value="${endYear}"
...
<display:table name="${vRpYrProvince3G}" id="item" requestURI="" pagesize="100" class="simple2" export="true" sort="list">
