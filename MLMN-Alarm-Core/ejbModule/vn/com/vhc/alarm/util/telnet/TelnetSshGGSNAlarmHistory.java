...
import vn.com.vhc.alarm.utils.log.AL_TelnetLog;
	...
	public class TelnetSshGGSNAlarmHistory {
		...
		try { 
			if(p_Vendor.contains("NOKIA")){
				...
				if(p_NeType.equalsIgnoreCase("GGSN")){
					//ssh lay du lieu History GGSN
					alTelnetLog = cls.SshAlarmHistoryGGSN(p_Ne, p_SDate, p_STime, p_IpAddress, p_TelnetUser, p_TelnetPass);
