...
<title>province gprs qos hourly report</title>
<content tag="heading">GPRS-QOS PROVINCE ${province} REPORT</content>
<ul class="ui-tabs-nav">
  <li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio/province-gprs-qos/hr/details.htm?province=${province}&endDate=${endDate}"><span>Báo cáo giờ</span></a></li>
	...
	<table class="form">
        <tr>
			<td align="left">
				...
				<% 
					String[] provinceGprsQosArray = {"DL_TBF_REQ","DL_TBF_SUCR","UL_TBF_REQ","UL_TBF_SUCR","GDL_TRAF","GUL_TRAF","EDL_TRAF","EUL_TRAF"};
					String[]  provinceGprsQosNameArray = {"dlTbfReq","dlTbfSucr","ulTbfReq","ulTbfSucr","gdlTraf","gulTraf","edlTraf","eulTraf"};
					int i;
...
<display:table name="${vRpHrProvinceGprsQosDetails}" id="vRpHrProvinceGprsQosDetail" requestURI="" pagesize="100" class="simple2" export="true">
		<display:column property="day" format="{0,date,dd/MM/yyyy}" titleKey="DAY"/>
	    <display:column titleKey="HOUR">
	    	${vRpHrProvinceGprsQosDetail.hour}:00
	    </display:column>
	...
	$(function() {
		...
		$( '.checkAll' ).live( 'change', function() {
			...
			if($( this ).is( ':checked' )){
				for (var i=5;i<=12;i++)
				{
					$('#vRpHrProvinceGprsQosDetail td:nth-child('+i+'),#vRpHrProvinceGprsQosDetail th:nth-child('+i+')').show();
				}
			} else {
				for (var i=5;i<=12;i++)
				{
					$('#vRpHrProvinceGprsQosDetail td:nth-child('+i+'),#vRpHrProvinceGprsQosDetail th:nth-child('+i+')').hide();
				}
			}
		});
