...
<content tag="heading">GPRS-QOS PROVINCE DAILY REPORT</content>
<ul class="ui-tabs-nav">
	<li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio/province-gprs-qos/dy/list.htm"><span>Báo cáo ngày</span></a></li>
	<li class=""><a href="${pageContext.request.contextPath}/report/radio/province-gprs-qos/wk/list.htm"><span>Báo cáo tuần</span></a></li>
...
<display:table name="${vRpDyProvinceGprsQos}" id="vRpDyProvinceGprsQos" requestURI="" pagesize="100" class="simple2" export="true">
    	...
    	<a href="${pageContext.request.contextPath}/report/radio/province-gprs-qos/hr/details.htm?province=${vRpDyProvinceGprsQos.province}&endDate=<fmt:formatDate pattern="dd/MM/yyyy" value="${vRpDyProvinceGprsQos.day}"/>">${vRpDyProvinceGprsQos.province}</a>&nbsp;
    	</display:column>
