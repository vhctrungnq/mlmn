...
<content tag="heading">MSC CHANNEL ASSIGNMENT HOURLY REPORT</content>

<ul class="ui-tabs-nav">
  <li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/core-era/channel-assig/msc/hr.htm?mscid=${msc.mscid}&startDate=${startDate}&startHour=${startHour}&endDate=${endDate}&endHour=${endHour}"><span>Báo cáo giờ</span></a></li>
  <li class=""><a href="${pageContext.request.contextPath}/report/core-era/channel-assig/msc/dy.htm?mscid=${msc.mscid}&startDate=${startDate}&endDate=${endDate}"><span>Báo cáo ngày</span></a></li>
</ul>
...
<div  id="doublescroll">
		<display:table name="${hrMSCCA}" id="hrMSCCA" requestURI="" pagesize="100" class="simple3" export="true">
		    <display:column property="mscid" titleKey="SYSTEM" headerClass="hide" class="hide"/>
		    <display:column title="SYSTEM" media="html">
		   	 	<a href="${pageContext.request.contextPath}/report/core-era/channel-assig/msc/detail.htm?mscid=${hrMSCCA.mscid}&startDate=<fmt:formatDate pattern="dd/MM/yyyy" value="${hrMSCCA.day}"/>&endDate=<fmt:formatDate pattern="dd/MM/yyyy" value="${hrMSCCA.day}"/>">${hrMSCCA.mscid}</a>
		    </display:column>
		    <display:column property ="day" format="{0,date,dd/MM/yyyy}" titleKey="Day" />
		    <display:column property ="hour" format="{0,number}:00" titleKey="Hour" />
		    <display:column property="numChassigGsmCallTo" titleKey="Channel assignment for call to mobile subcriber"/>
		    <display:column property="numChassigGsmCallToSucc" titleKey="Sucessful channel assignment for call to mobile subcriber"/>
		    <display:column property="succrChassigGsmCallTo" titleKey="Channel assignment for call from mobile subcriber"/>
		    <display:column property="numChassigGsmCallFrom" titleKey="Sucessful channel assignment for call from mobile subcriber"/>
		    <display:column property="succrChassigGsm" titleKey="Succ CHASSIG GMS (%)"/>
		    <display:column property="succrChassigGsmCallFrom" titleKey="Succ CHASSIG GMS call to (%)"/>
		</display:table>
	</div>
