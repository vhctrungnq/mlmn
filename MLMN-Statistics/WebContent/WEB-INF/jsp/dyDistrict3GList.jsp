...
<content tag="heading">DISTRICT QOS 3G DAILY REPORT</content>
<ul class="ui-tabs-nav">
	<li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio3g/district/dy/list.htm"><span>Báo cáo ngày</span></a></li>
...
<div class="ui-tabs-panel">
	...
	<br/>
		...
		<div  id="doublescroll">
			<display:table style = "width: 200%" name="${vRpDyDistrict}" id="vRpDyDistrict" requestURI="" pagesize="100" class="simple2" export="true" sort="list">
...
<%-- 			    <display:column property="region" titleKey="Center" sortable="true" headerClass="master-header-1"/>
 --%>			    <display:column property="province" titleKey="Province" sortable="true" headerClass="hide" class="hide"/>
			    <display:column titleKey="Province" media="html" sortable="true" headerClass="master-header-1" sortProperty="province" style = "width: 120px">
			    	<a href="${pageContext.request.contextPath}/report/radio3g/province/hr/detail.htm?province=${vRpDyDistrict.province}&endDate=<fmt:formatDate pattern="dd/MM/yyyy" value="${vRpDyDistrict.day}"/>">${vRpDyDistrict.province}</a>
			    </display:column>
