...
<ul class="ui-tabs-nav">
	...
	<li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio/cell/qr/list.htm"><span>Báo cáo quý</span></a></li>
 	...
 	<li class=""><a href="${pageContext.request.contextPath}/report/radio/cell-gprs-cs/mn/bh.htm?cellid=${cellid}&bscid=${bscid}&endMonth=${endMonth}&endYear=${endYear}"><span>Báo cáo BH tháng</span></a></li>
</ul>
	...
	<table class="form">
			...
			<div  id="doublescroll">
<display:table  style = "width: 150%" name="${vRpMnCellGprsCsList}" id="vRpMnCellGprsCs" requestURI="" pagesize="100" class="simple2" export="true">
