...
<content tag="heading">LIST CELL IBC HANDOVER MONTH ${month}/${year}</content>
<ul class="ui-tabs-nav">
	...
	<li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio/ibc/cell-ho/mn/list.htm"><span>Báo cáo tháng</span></a></li>
</ul>
...
<display:table name="${vRpMnCellHoIbc}" id="vRpMnCellHoIbc" requestURI="" pagesize="100" class="simple2" export="true">
			    ...
			    <display:column titleKey="BSC" media="html">
			    	<a href="${pageContext.request.contextPath}/report/radio/ibc/bsc-ho/mn/details.htm?bscid=${vRpMnCellHoIbc.bscid}&endMonth=${month}&endYear=${year}">${vRpMnCellHoIbc.bscid}</a>
			    </display:column> 
			    <display:column property="cellid" titleKey="CELLID" headerClass="hide" class="hide"/>
			    <display:column titleKey="CELL" media="html">
			    	<a href="${pageContext.request.contextPath}/report/radio/cell-ho/mn/details.htm?bscid=${vRpMnCellHoIbc.bscid}&cellid=${vRpMnCellHoIbc.cellid}&endMonth=${month}&endYear=${year}">${vRpMnCellHoIbc.cellid}</a>
			    </display:column>
