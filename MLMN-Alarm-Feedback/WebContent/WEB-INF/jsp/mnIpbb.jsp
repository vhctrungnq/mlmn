...
<content tag="heading">BIỂU ĐỒ TẢI IPBB THEO THÁNG</content>
<ul class="ui-tabs-nav">
	<li class=""><a href="${pageContext.request.contextPath}/chart/rp/ipbb/dy.htm"><span>Báo cáo ngày</span></a></li>
	<li class=""><a href="${pageContext.request.contextPath}/chart/rp/ipbb/wk.htm"><span>Báo cáo tuần</span></a></li>
	<li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/chart/rp/ipbb/mn.htm"><span>Báo cáo tháng</span></a></li>
</ul>
