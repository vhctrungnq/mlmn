			...
			<form:form method = "get" action = "tong-hop-thanh-toan.htm">
				<table> 
				 	<tr>
						...
						<td style="padding-left: 30px;">Chu kỳ thời gian </td>
						<td> 
				 	...
				 	<tr>
						...
						<td> 
							<select  name = "type">
								<option value = "">Tổng hợp thanh toán</option>
								<option value = "TW">Tổng hợp thanh toán tạm ứng</option>
							</select>
							<%-- <input id = "type" value = "${type}" name = "type"/> --%>
						</td>
...
var urlprovince = "${pageContext.request.contextPath}/ajax/getDSTinh.htm?region="+$("#region").val();
   ...
   $("#tinh").jqxDropDownList({source: dataAdapterprovince, displayMember: "province",width: '174px' , valueMember: "province",checkboxes: true, width: 180,  theme: theme,enableHover: true });           
...
var urlRegion = "${pageContext.request.contextPath}/ajax/getRegionList.htm";
   ...
   $("#region").jqxDropDownList({source: dataAdapterregion, displayMember: "name",width: '174px' ,valueMember: "name",checkboxes: true, width: 120, autoDropDownHeight: true, theme: theme,enableHover: true });           
...
$("#chuKyTT").jqxComboBox({ source: dataAdaptertgttTq, displayMember: "name", valueMember: "name", width: '100%', height: 20, theme: theme,autoOpen: true  });
