...
<ul class="ui-tabs-nav">
  <li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio3g/branch/traffic/wk.htm?branch=${branch}"><span>Báo cáo tuần</span></a></li>
  <li class=""><a href="${pageContext.request.contextPath}/report/radio3g/branch/traffic/mn.htm?branch=${branch}"><span>Báo cáo tháng</span></a></li>
</ul>
	...
	<br/>
	<div  id="doublescroll">
<display:table name="${wkBranchList}" id="wkBranch" requestURI="" pagesize="100" class="simple2" export="true">
		<display:column property="region" titleKey="TT"/>
		<display:column property="week" titleKey="WEEK"/>
	    <display:column property="year" titleKey="YEAR"/> 
	    <display:column property="branch" titleKey="BRANCH"/> 
	    <display:column property ="specchTraff" titleKey="Traf" />
