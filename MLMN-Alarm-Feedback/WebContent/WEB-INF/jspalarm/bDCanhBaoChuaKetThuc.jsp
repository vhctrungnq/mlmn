...
<c:choose>
	<c:when test="${function == 'hien-tai'}">
		<li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/alarm/bieu-do-canh-bao-chua-ket-thuc/hien-tai.htm"><span><fmt:message key="title.tabControls.hienTai"/></span></a></li>
		<li class=""><a href="${pageContext.request.contextPath}/alarm/bieu-do-canh-bao-chua-ket-thuc/theo-gio.htm"><span><fmt:message key="title.tabControls.theoGio"/></span></a></li>
		<li class=""><a href="${pageContext.request.contextPath}/alarm/bieu-do-canh-bao-chua-ket-thuc/theo-ngay.htm"><span><fmt:message key="title.tabControls.theoNgay"/></span></a></li>
	</c:when>
 	<c:when test="${function == 'theo-gio'}">
		<li class=""><a href="${pageContext.request.contextPath}/alarm/bieu-do-canh-bao-chua-ket-thuc/hien-tai.htm"><span><fmt:message key="title.tabControls.hienTai"/></span></a></li>
		<li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/alarm/bieu-do-canh-bao-chua-ket-thuc/theo-gio.htm"><span><fmt:message key="title.tabControls.theoGio"/></span></a></li>
		<li class=""><a href="${pageContext.request.contextPath}/alarm/bieu-do-canh-bao-chua-ket-thuc/theo-ngay.htm"><span><fmt:message key="title.tabControls.theoNgay"/></span></a></li>
	</c:when>
 	<c:when test="${function == 'theo-ngay'}">
 		<li class=""><a href="${pageContext.request.contextPath}/alarm/bieu-do-canh-bao-chua-ket-thuc/hien-tai.htm"><span><fmt:message key="title.tabControls.hienTai"/></span></a></li>
		<li class=""><a href="${pageContext.request.contextPath}/alarm/bieu-do-canh-bao-chua-ket-thuc/theo-gio.htm"><span><fmt:message key="title.tabControls.theoGio"/></span></a></li>
		<li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/alarm/bieu-do-canh-bao-chua-ket-thuc/theo-ngay.htm"><span><fmt:message key="title.tabControls.theoNgay"/></span></a></li>
 	</c:when>
...
<table border="0" width="100%" cellspacing="0" cellpadding="0" class="form">
		...
		<tr>
			...
			<c:when test="${function == 'hien-tai'}">
				<td>
					<fmt:message key="canhBaoChuaKetThuc.thoiGianHeThong"/>&nbsp;
		...
		<c:when test="${function != 'hien-tai'}">
			<tr>
				<td colspan="2"><h3><fmt:message key="title.soLuongCanhBaoChuaKetThuc"/></h3></td>
			</tr>
			<tr>
				<td colspan="2">
