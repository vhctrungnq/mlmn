...
<content tag="heading">MSC MAPSIGNAL PERFOMANCE DAILY REPORT</content>
 
<ul class="ui-tabs-nav">
  <li class=""><a href="${pageContext.request.contextPath}/report/core-era/mapsig-perfo/msc/hr.htm?mscid=${msc.mscid}&startDate=${startDate}&endDate=${endDate}"><span>Báo cáo giờ</span></a></li>
  <li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/core-era/mapsig-perfo/msc/dy.htm?mscid=${msc.mscid}&startDate=${startDate}&endDate=${endDate}"><span>Báo cáo ngày</span></a></li>
</ul>
...
<div  id="doublescroll">
		<display:table name="${dyMSCMapsig}" id="dyMSCMapsig" requestURI="" pagesize="100" class="simple3" export="true">
		   <display:column property="mscid" titleKey="SYSTEM" headerClass="hide" class="hide"/>
		    <display:column title="SYSTEM" media="html">
		   	 	<a href="${pageContext.request.contextPath}/report/core-era/mapsig-perfo/msc/hr.htm?mscid=${dyMSCMapsig.mscid}&startDate=<fmt:formatDate pattern="dd/MM/yyyy" value="${dyMSCMapsig.day}"/>&endDate=<fmt:formatDate pattern="dd/MM/yyyy" value="${dyMSCMapsig.day}"/>">${dyMSCMapsig.mscid}</a>
		    </display:column>
		    <display:column property ="day" format="{0,date,dd/MM/yyyy}" titleKey="DAY" />
		    <display:column property="firstMapSucc" titleKey="First successful map operations"/>
		    <display:column property="secondMapSucc" titleKey="Second successful map operations"/>
		    <display:column property="thirdMapSucc" titleKey="Third successful map operations"/>
		    <display:column property="firstMapTot" titleKey="Total first request of MAP"/>
		    <display:column property="secondMapTot" titleKey="Total second request of MAP"/>
		    <display:column property="thirdMapTot" titleKey="Total third request of MAP"/>
		    <display:column property="transacSucc" titleKey="Successful transation capabilities"/>
		    <display:column property="mapSignSucc" titleKey="Successful MAP Signalling (%)"/>
		</display:table>
	</div>
