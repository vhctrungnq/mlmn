...
<content tag="heading">PROVINCE QOS 3G MONTHLY REPORT</content>
<ul class="ui-tabs-nav">
	<li class=""><a href="${pageContext.request.contextPath}/report/radio3g/province/dy/list.htm"><span>Báo cáo ngày</span></a></li>
	<li class=""><a href="${pageContext.request.contextPath}/report/radio3g/province/wk/list.htm"><span>Báo cáo tuần</span></a></li>
	<li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio3g/province/mn/list.htm"><span>Báo cáo tháng</span></a></li>
...
<display:table name="${vRpMnProvince}" id="vRpMnProvince" requestURI="" pagesize="100" class="simple2" export="true" sort="list">
	    ...
	    <display:column titleKey="Province" media="html" sortable="true" headerClass="master-header-1" sortProperty="province">
	    	<a href="${pageContext.request.contextPath}/report/radio3g/province/mn/detail.htm?province=${vRpMnProvince.province}&endMonth=${vRpMnProvince.month}&endYear=${vRpMnProvince.year}">${vRpMnProvince.province}</a>
	    </display:column>
	    ...
	    <display:column titleKey="Cells" media="html" sortable="true" headerClass="master-header-1 margin" class="margin" sortProperty="cells">
	    	<a href="${pageContext.request.contextPath}/report/radio3g/cell/mn/list.htm?province=${vRpMnProvince.province}&month=${vRpMnProvince.month}&year=${vRpMnProvince.year}"><fmt:formatNumber pattern="#,###,###,##0.##" value="${vRpMnProvince.cells}"/></a>
	    </display:column>
