...
<title>Báo cáo tùy chọn province gprs cs</title>
<content tag="heading">Báo cáo tùy chọn province gprs cs</content>
...
<%-- 		<div class="pageSize">
			...
			<display:table name="${optionProvinceGprsCsList}" class="simple2" id="item" requestURI="" pagesize="100" export="true">
