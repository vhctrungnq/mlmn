...
<content tag="heading">DISTRICT QOS YEARLY REPORT</content>
<ul class="ui-tabs-nav">
	...
	<li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio/district/yr/list.htm"><span>Báo cáo năm</span></a></li>
</ul>
		...
		<tr>
			<td align="left">
				<form method="get" action="list.htm">
	            	...
	            	&nbsp;Đến năm <input value="${endYear}" name="endYear" id="endYear" size="4" maxlength="4">
...
<div  style="overflow: auto;" class="tableStandar">
	<display:table name="${vRpYrDistrictQosList}" id="item" requestURI="" pagesize="100" class="simple2" export="true" sort="list">
