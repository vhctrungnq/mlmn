...
<content tag="heading">RNC QOS 3G WEEKLY REPORT ${bscid}</content>
<ul class="ui-tabs-nav">
  ...
  <li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio3g/rnc/wk/detail.htm?bscid=${bscid }&endWeek=${endWeek}&endYear=${endYear}"><span>Báo cáo tuần</span></a></li>
  ...
  <li class=""><a href="${pageContext.request.contextPath}/report/radio3g/rnc/wk/bh.htm?bscid=${bscid}&endWeek=${endWeek}&endYear=${endYear}"><span>Báo cáo BH tuần</span></a></li>
...
<display:table name="${vRpWkBscList}" id="vRpWkBsc" requestURI="" pagesize="100" class="simple2" export="true" sort="list">
		...
		<display:column property="region" titleKey="Center" headerClass="master-header-1" sortable="true"/>
	    ...
	    <display:column titleKey="RNC" media="html" headerClass="master-header-1" sortable="true" sortProperty="bscid">
	    	<a href="${pageContext.request.contextPath}/report/radio3g/cell/wk/list.htm?bscid=${vRpWkBsc.bscid}&week=${vRpWkBsc.week}&year=${vRpWkBsc.year}">${vRpWkBsc.bscid}</a>
	    </display:column> 
	    ...
	    <display:column property="cells" decorator="vn.com.vhc.vmsc2.statistics.web.utils.NumberDecorator" titleKey="Cells" headerClass="master-header-1 margin" sortable="true" class="margin"/>
