...
<content tag="heading">LIST BSC IBC HANDOVER BY DAY ${day}</content>
<ul class="ui-tabs-nav">
	<li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio/ibc/bsc-ho/dy/list.htm"><span>Báo cáo ngày</span></a></li>
	<li class=""><a href="${pageContext.request.contextPath}/report/radio/ibc/bsc-ho/wk/list.htm"><span>Báo cáo tuần</span></a></li>
...
<display:table name="${vRpDyBscHoIbc}" id="vRpDyBscHoIbc" requestURI="" pagesize="100" class="simple2" export="true">
			    ...
			    <display:column titleKey="BSC" media="html">
			    	<a href="${pageContext.request.contextPath}/report/radio/ibc/bsc-ho/hr/details.htm?bscid=${vRpDyBscHoIbc.bscid}&endDate=${day}">${vRpDyBscHoIbc.bscid}</a>
			    </display:column>
			    ...
			    <display:column titleKey="HO_SUCR (%)" media="html">
			    	<a href="${pageContext.request.contextPath}/report/radio/bsc/ho/dy.htm?bscid=${vRpDyBscHoIbc.bscid}&endDate=${day}">${vRpDyBscHoIbc.hoSucr}</a>
			    </display:column>
