...
<content tag="heading">LIST BAD CELL BY BSC WEEKLY</content>
<ul class="ui-tabs-nav">
	...
	<li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio/bad-cell/by-bsc/list.htm?startDate=${startDate}&endDate=${endDate}"><span>Bad Cell by Bsc</span></a></li>
...
<div class="ui-tabs-panel">
	<a href="${pageContext.request.contextPath}/report/radio/bad-cell/by-bsc/list.htm?startDate=${startDate}&endDate=${endDate}"><span>Theo Ngày</span></a>
<span>Theo Tuần</span>
