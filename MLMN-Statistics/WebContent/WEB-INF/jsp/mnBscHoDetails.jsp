...
<ul class="ui-tabs-nav">
  ...
  <li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio/bsc-ho/mn/details.htm?bscid=${bscid}&endMonth=${endMonth}&endYear=${endYear}"><span>Báo cáo tháng</span></a></li>
  ...
  <li class=""><a href="${pageContext.request.contextPath}/report/radio/bsc-ho/mn/bhDetails.htm?bscid=${bscid}&endMonth=${endMonth}&endYear=${endYear}"><span>Báo cáo BH tháng</span></a></li>
</ul>
...
<display:table name="${vRpMnBscHoDetails}" id="vRpMnBscHoDetail" requestURI="" pagesize="100" class="simple2" export="true">
	...
	$(function() {
		$( '.checkAll' ).live( 'change', function() {
			...
			if($( this ).is( ':checked' )){
				for (var i=5;i<=10;i++)
				{
					$('#vRpMnBscHoDetail td:nth-child('+i+'),#vRpMnBscHoDetail th:nth-child('+i+')').show();
				}
			} else {
				for (var i=5;i<=10;i++)
				{
					$('#vRpMnBscHoDetail td:nth-child('+i+'),#vRpMnBscHoDetail th:nth-child('+i+')').hide();
				}
			}
		});
