...
<fmt:message key="warning.operator"/>: ${bsc}&nbsp;-&nbsp;  <fmt:message key="rAlarmLog.system"/>: ${site} &nbsp; - &nbsp;<fmt:message key="vAlRbLossPower.Start"/>: ${start}
 <div align="left"> <input type="button" class="button" value="<fmt:message key="button.cancel"/>" onClick='window.location="list.htm?alarmType=${alarmType}"'>
</div>
