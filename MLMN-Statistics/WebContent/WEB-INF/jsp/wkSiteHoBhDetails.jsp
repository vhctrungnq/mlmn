...
<title>site handover weekly report</title>
...
<ul class="ui-tabs-nav">
  ...
  <li class=""><a href="${pageContext.request.contextPath}/report/radio/site-ho/wk/details.htm?bscid=${bscid}&siteid=${siteid}&endWeek=${endWeek}&endYear=${endYear}"><span>Báo cáo tuần</span></a></li>
  ...
  <li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio/site-ho/wk/bDdetails.htm?bscid=${bscid}&siteid=${siteid}&endWeek=${endWeek}&endYear=${endYear}"><span>Báo cáo BH tuần</span></a></li>
		...
		<table width="100%" class="form">
			<tr>
				<td align="left">
					...
					<img alt="calendar" title="Click to choose the start week number" id="chooseStartWeek" style="cursor: pointer;" src="/images/calendar.png"/>
					...
					<img alt="calendar" title="Click to choose the end week number" id="chooseEndWeek" style="cursor: pointer;" src="/images/calendar.png"/>
...
<display:table name="${vRpWkSiteHoBhDetails}" id="vRpWkSiteHoBhDetail" requestURI="" pagesize="100" class="simple2" export="true">
	...
	$(function() {
		$( '.checkAll' ).live( 'change', function() {
			...
			if($( this ).is( ':checked' )){
				for (var i=6;i<=11;i++)
				{
					$('#vRpWkSiteHoBhDetail td:nth-child('+i+'),#vRpWkSiteHoBhDetail th:nth-child('+i+')').show();
				}
			} else {
				for (var i=6;i<=11;i++)
				{
					$('#vRpWkSiteHoBhDetail td:nth-child('+i+'),#vRpWkSiteHoBhDetail th:nth-child('+i+')').hide();
				}
			}
		});
