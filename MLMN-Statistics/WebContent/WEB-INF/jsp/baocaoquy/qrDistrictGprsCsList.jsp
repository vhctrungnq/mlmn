...
<ul class="ui-tabs-nav">
	...
	<li class="ui-tabs-selected""><a href="${pageContext.request.contextPath}/report/radio/district-gprs-cs/qr/list.htm"><span>Báo cáo quý</span></a></li>
...
<div class="ui-tabs-panel">
	...
	<div  style="overflow: auto;" class="tableStandar" id = "doublescroll">
		<display:table name="${vRpQrDistrictGprsCs}" id="item" requestURI="" pagesize="100" class="simple2" export="true">
