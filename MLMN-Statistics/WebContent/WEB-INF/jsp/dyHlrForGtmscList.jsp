...
<content tag="heading">NG HLR FOR GTMSC DAILY REPORT</content>
 
<ul class="ui-tabs-nav">
  <li class=""><a href="${pageContext.request.contextPath}/report/core/hlr-for-gtmsc/hr.htm?nodeid=${node.hlrid}&startDate=${startDate}&endDate=${endDate}"><span>Báo cáo giờ</span></a></li>
  <li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/core/hlr-for-gtmsc/dy.htm?nodeid=${node.hlrid}&startDate=${startDate}&endDate=${endDate}"><span>Báo cáo ngày</span></a></li>
</ul>
...
<div  id="doublescroll">
		<display:table name="${vRpDyHlrForGtmsc}" id="vRpDyHlrForGtmsc" requestURI="" pagesize="100" class="simple3" export="true">
			<display:column property="nodeid" titleKey="NODE" headerClass="hide" class="hide"/>		   
		    <display:column title="NODE" media="html">
		   	 	<a href="${pageContext.request.contextPath}/report/core/hlr-for-gtmsc/hr.htm?nodeid=${vRpDyHlrForGtmsc.nodeid}&startDate=<fmt:formatDate pattern="dd/MM/yyyy" value="${vRpDyHlrForGtmsc.day}"/>&endDate=<fmt:formatDate pattern="dd/MM/yyyy" value="${vRpDyHlrForGtmsc.day}"/>">${vRpDyHlrForGtmsc.nodeid}</a>
		    </display:column>
		    <display:column property ="day" format="{0,date,dd/MM/yyyy}" titleKey="Day" />
		    <display:column property="seizureTraffic" titleKey="Msc Total Traffic"/>
		    <display:column property="averageSeizureRate" titleKey="Average CPU Ussage"/>
