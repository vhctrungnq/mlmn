...
<div  id="doublescroll">
		<display:table name="${HrMscsccpuser}" id="HrMscsccpuser" requestURI="" pagesize="100" class="simple3" export="true">
		    <display:column property="mscid" titleKey="SYSTEM"/>
		    <display:column property="userlabel" titleKey="USERLABEL"/>
