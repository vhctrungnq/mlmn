...
<ul class="ui-tabs-nav">
	...
	<li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/taithietbi/mn.htm?type=${type}"><span>Báo cáo tháng</span></a></li>
...
<br>
	<form method="post" action="mn.htm?type=${type}">
		<table style="width:100%;" class="form">
			<tr>
				<td align="left">
					...
					Từ tháng<input value="${sMonth}" name="sMonth" id="sMonth" maxlength="2" class="wid2">
					<img alt="calendar" title="Click to choose the start month number" id="chooseStartMonth" style="cursor: pointer;" src="${pageContext.request.contextPath}/images/calendar.png"/>&nbsp;&nbsp;
			        năm <input value="${sYear}" name="sYear" id="sYear" class="wid4">&nbsp;&nbsp;
			        Đến tháng<input value="${eMonth}" name="eMonth" id="eMonth" maxlength="2" class="wid2">
			        <img alt="calendar" title="Click to choose the end month number" id="chooseEndMonth" style="cursor: pointer;" src="${pageContext.request.contextPath}/images/calendar.png"/>&nbsp;&nbsp;
...
<div  style="overflow: auto;">
	<display:table name="${dataList}" id="item" requestURI="" pagesize="100" class="simple2" export="true">
			...
			<display:column property="month" title="Tháng" sortName="month" sortable="true" headerClass="master-header-1 margin" class="margin"/>
...
Calendar.setup({
    inputField		:	"sMonth",	// id of the input field
    ifFormat		:	"%m",   	// format of the input field
    button			:   "chooseStartMonth",  	// trigger for the calendar (button ID)
    singleClick		:   false					// double-click mode
});
Calendar.setup({
    inputField		:	"eMonth",	// id of the input field
    ifFormat		:	"%m",   	// format of the input field
    button			:   "chooseEndMonth",  	// trigger for the calendar (button ID)
    singleClick		:   false					// double-click mode
});
