...
<title>CELL DATA 2G QUARTER REPORT</title>
<content tag="heading">CELL DATA 2G QUARTER REPORT</content>
	<ul class="ui-tabs-nav">
		...
		<li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio/cell-data/qr/list.htm"><span>Báo cáo quý</span></a></li>
...
<div class="ui-tabs-panel">
	...
	<div  style="overflow: auto;" class="tableStandar">
		<display:table name="${vRpQrCellData2gList}" style = "width: 150%" id="item" requestURI="" pagesize="100" export="false" sort="external" defaultsort="1" >
