...
import vn.com.vhc.vmsc2.statistics.dao.VRpHrProvinceDAO;
...
@Controller
@RequestMapping("/report/radio/province/hr/*")
public class HrProvinceQosController extends BaseController {
	@Autowired
	private VRpHrProvinceDAO vRpHrProvinceDao;
	@Autowired
	...
	public String showReport(@RequestParam(required = false) String region,@RequestParam(required = true) String province, @RequestParam(required = false) String startHour,
		...
		List<VRpHrProvince> vRpHrProvinceList = new ArrayList<VRpHrProvince>();
		...
		for (VRpHrProvince vRpHrProvince : vRpHrProvinceList) {
			categories.add(Integer.toString(vRpHrProvince.getHour()) + ":00 " + ddf.format(vRpHrProvince.getDay()));
			cssrList.add(vRpHrProvince.getCssr());
			tTrafList.add(vRpHrProvince.gettTraf());
			tTrafhList.add(vRpHrProvince.gettTrafh());
			tDrprList.add(vRpHrProvince.gettDrpr());
			tBlkrList.add(vRpHrProvince.gettBlkr());
			sDrprList.add(vRpHrProvince.getsDrpr());
			sBlkrList.add(vRpHrProvince.getsBlkr());
			haftratePercentList.add(vRpHrProvince.getHaftratePercent());
			ogHoSucrList.add(vRpHrProvince.getOgHoSucr());
			inHoSucrList.add(vRpHrProvince.getInHoSucr());
		}
