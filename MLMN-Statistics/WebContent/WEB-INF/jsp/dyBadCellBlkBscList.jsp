...
<content tag="heading">LIST CELL CONGESTION TCH DAILY BY BSC</content>
<ul class="ui-tabs-nav">
	...
	<li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio/bad-cell-blk/by-bsc/list.htm?bscid=${bscid}&startDate=${startDate}&endDate=${endDate}"><span>Cell nghẽn TCH by Bsc</span></a></li>
