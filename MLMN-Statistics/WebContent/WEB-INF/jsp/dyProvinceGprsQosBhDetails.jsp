...
<ul class="ui-tabs-nav">
  ...
  <li class=""><a href="${pageContext.request.contextPath}/report/radio/province-gprs-qos/dy/details.htm?province=${province}&endDate=${endDate}"><span>Báo cáo ngày</span></a></li>
  ...
  <li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio/province-gprs-qos/dy/bhDetails.htm?province=${province}&endDate=${endDate}"><span>Báo cáo BH ngày</span></a></li>
		...
		<table width="100%" class="form">
			<tr>
				<td align="left">
					...
					PROVINCE 
			        <select name="province" id="province" onchange="xl()">
			        	<option value="">Tất cả</option>
        ...
        <tr>
			<td align="left">
				...
				<% 
					...
					String[]  provinceGprsQosBhNameArray = {"bhDlTbfReq","bhDlTbfSucr","bhDlTbfReq","bhUlTbfSucr","bhGdlTraf","bhGulTraf","bhEdlTraf","bhEulTraf"};
					int i;
...
<display:table name="${vRpDyProvinceGprsQosBhDetails}" id="vRpDyProvinceGprsQosBhDetail" requestURI="" pagesize="100" class="simple2" export="true">
		<display:column property="day" format="{0,date,dd/MM/yyyy}" titleKey="Ngày"/>
		<display:column titleKey="Busy Hour">
		${vRpDyProvinceGprsQosBhDetail.bh}:00
		</display:column>
    	...
    	<a href="${pageContext.request.contextPath}/report/radio/province-gprs-qos/hr/details.htm?province=${vRpDyProvinceGprsQosBhDetail.province}&endDate=<fmt:formatDate pattern="dd/MM/yyyy" value="${vRpDyProvinceGprsQosBhDetail.day}"/>">${vRpDyProvinceGprsQosBhDetail.province}</a>&nbsp;
    	</display:column>
	...
	$(function() {
		...
		$( '.checkAll' ).live( 'change', function() {
			...
			if($( this ).is( ':checked' )){
				for (var i=6;i<=13;i++)
				{
					$('#vRpDyProvinceGprsQosBhDetail td:nth-child('+i+'),#vRpDyProvinceGprsQosBhDetail th:nth-child('+i+')').show();
				}
			} else {
				for (var i=6;i<=13;i++)
				{
					$('#vRpDyProvinceGprsQosBhDetail td:nth-child('+i+'),#vRpDyProvinceGprsQosBhDetail th:nth-child('+i+')').hide();
				}
			}
		});
