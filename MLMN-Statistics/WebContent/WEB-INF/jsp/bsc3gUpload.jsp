...
<title>Upload dữ liệu Rnc</title>
<content tag="heading">Upload dữ liệu Rnc</content>
...
<form:form method="post" action="upload.htm" enctype="multipart/form-data" >
		...
		<tr>
				...
				<td colspan="2">
					<ul>
						...
						<li>File mẫu:&nbsp;<a style="color: blue; " title="RncExample" href="${pageContext.request.contextPath}/upload/RncExample.xls">RncExample.xls</a>
						</li>
						<li>Chú ý:</li>
    ...
    <c:if test="${fn:length(failedList) gt 0}">
    	<div id="failed">
    		<div><b>Dữ liệu Rnc không hợp lệ  ( ${failNum}/${totalNum} )</b></div>
    		...
    		<div style="max-height: 500px; overflow: auto;">
    			<display:table name="${failedList}" class="simple2" id="item1" requestURI="" export="false" pagesize="100">
							...
							<display:column property="bscid" title="RNC"  class="NOT_NULL"/>
	...
	<c:if test="${fn:length(successList) gt 0}">
    	<div id="success">
    		<div><b>Dữ liệu Rnc hợp lệ  ( ${successNum}/${totalNum} )</b></div>
