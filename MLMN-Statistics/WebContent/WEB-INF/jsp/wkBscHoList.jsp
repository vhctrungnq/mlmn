...
<content tag="heading">BSC HANDOVER WEEKLY REPORT</content>
<ul class="ui-tabs-nav">
	<li class=""><a href="${pageContext.request.contextPath}/report/radio/bsc-ho/dy/list.htm"><span>Báo cáo ngày</span></a></li>
	<li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio/bsc-ho/wk/list.htm"><span>Báo cáo tuần</span></a></li>
	...
	<br/>
		...
		<display:table name="${vRpWkBscHo}" id="vRpWkBscHo" requestURI="" pagesize="100" class="simple2" export="true">
			    ...
			    <display:column titleKey="BSC" media="html">
			    	<a href="details.htm?bscid=${vRpWkBscHo.bscid}&endWeek=${week}&endYear=${year}">${vRpWkBscHo.bscid}</a>&nbsp;
			    </display:column>
