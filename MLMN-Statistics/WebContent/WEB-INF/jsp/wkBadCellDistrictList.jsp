...
<content tag="heading">LIST BAD CELL BY DISTRICT WEEKLY</content>
<ul class="ui-tabs-nav">
	...
	<li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio/bad-cell/by-district/list.htm?startDate=${startDate}&endDate=${endDate}"><span>Bad Cell by District</span></a></li>
...
<span>Theo Tuần</span>
<a href="${pageContext.request.contextPath}/report/radio/bad-cell/by-district/mnList.htm?endMonth=${endMonth}&endYear=${endYear}"><span>Theo Tháng</span></a>
