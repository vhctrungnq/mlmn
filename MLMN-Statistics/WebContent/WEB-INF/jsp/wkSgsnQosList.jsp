...
<ul class="ui-tabs-nav">
	...
	<li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/core/sgsn/wk/list.htm"><span>Báo cáo tuần</span></a></li>
	<li class=""><a href="${pageContext.request.contextPath}/report/core/sgsn/mn/list.htm"><span>Báo cáo tháng</span></a></li>
</ul>
<div class="ui-tabs-panel">
	...
	<display:table name="${vRpWkSgsnQosList}" id="vRpWkSgsnQos" requestURI="" pagesize="100" class="simple2" export="true" sort="list">
	    ...
	    <display:column property="sgsnName" titleKey="SGSN Name" class="hide" headerClass="hide"/>
	    <display:column titleKey="SGSN Name" media="html" sortable="true" headerClass="master-header-1" sortProperty="sgsnName">
	    	<a href="${pageContext.request.contextPath}/report/core/sgsn/wk/detail.htm?sgsnid=${vRpWkSgsnQos.sgsnName}&endWeek=${vRpWkSgsnQos.week}&endYear=${vRpWkSgsnQos.year}&startWeek=${vRpWkSgsnQos.week}&startYear=${vRpWkSgsnQos.year}">${vRpWkSgsnQos.sgsnName}</a>
	    </display:column>
