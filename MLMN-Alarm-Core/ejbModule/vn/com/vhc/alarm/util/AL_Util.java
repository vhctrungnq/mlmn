...
public class AL_Util {
    ...
    public static int getCurrentYear() {
        String year = AL_Util.getTime(new Date(), "yyyy");
    ...
    public static String getCurrentDate() {
        return AL_Util.getTime(new Date(), AL_Setting.DATE_FORMAT);
    }
    ...
    public static String getDate(Date date) {
        return AL_Util.getTime(date, AL_Setting.DATE_FORMAT);
    }
    ...
    public static String getDate(Date date, String format) {
        return AL_Util.getTime(date, format);
    }
    ...
    public static String getCurrentTime() {
        return AL_Util.getTime(new Date());
    }
    ...
    public static String getTime(Date date) {
        return AL_Util.getTime(date, AL_Setting.TIME_FORMAT);
    }

    public static String getTime(long minisecond, String format) {
        return AL_Util.getTime(new Date(minisecond), format);
    }
    ...
    public static long getTimeMinisecond(String time, String format) {
        long minisecond = 0;
        Date date = AL_Util.getDate(time, format);
        if (date != null) {
