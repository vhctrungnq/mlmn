...
<c:choose>
	<c:when test="${function == 'hr'}">
		<title><fmt:message key="sidebar.bsc2g.gslUtility.hr"/></title>
		<content tag="heading"><fmt:message key="sidebar.bsc2g.gslUtility.hr"/></content>

		<li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio/bsc/ericsson/gsl-util/hr.htm"><span><fmt:message key="title.tabControls.mucGio"/></span></a></li>
		<li class=""><a href="${pageContext.request.contextPath}/report/radio/bsc/ericsson/gsl-util/dy.htm"><span><fmt:message key="title.tabControls.mucNgay"/></span></a></li>
	</c:when>
	<c:when test="${function == 'dy'}">
		<title><fmt:message key="sidebar.bsc2g.gslUtility.dy"/></title>
		<content tag="heading"><fmt:message key="sidebar.bsc2g.gslUtility.dy"/></content>

		<li class=""><a href="${pageContext.request.contextPath}/report/radio/bsc/ericsson/gsl-util/hr.htm"><span><fmt:message key="title.tabControls.mucGio"/></span></a></li>
		<li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio/bsc/ericsson/gsl-util/dy.htm"><span><fmt:message key="title.tabControls.mucNgay"/></span></a></li>
	</c:when>
				...
				<td style="padding-top: 10px;">
					<div style="width:100%;overflow:auto; ">
						<display:table name="${hrBscGprsList}" class="simple2" id="item" requestURI="" pagesize="100" sort="external" defaultsort="1" export="true" >
							...
							<display:column property="gslutil" class="rightColumnMana" titleKey="dyGslUtility.gslutil" sortable="true" sortName="GSLUTIL"/>
							<display:column property="gslscan" class="rightColumnMana" titleKey="dyGslUtility.gslscan" sortable="true" sortName="GSLSCAN"/>
							<display:column property="gslutilRate" class="rightColumnMana GSLUTIL_RATE" titleKey="dyGslUtility.gslutilRate" sortable="true" sortName="GSLUTIL_RATE"/>
					...
					<div style="width:100%;overflow:auto; ">
						<display:table name="${dyBscGprsList}" class="simple2" id="item" requestURI="" pagesize="100" sort="external" defaultsort="1" export="true" >
							...
							<display:column class="link" titleKey="dyBscCpload.bscid" media="html" sortable="true" sortName="BSCID">
						   	 	<a href="${pageContext.request.contextPath}/report/radio/bsc/ericsson/gsl-util/hr.htm?bsc=${item.bscid}&startDate=<fmt:formatDate pattern="dd/MM/yyyy" value="${item.day}"/>&endDate=<fmt:formatDate pattern="dd/MM/yyyy" value="${item.day}"/>">${item.bscid}</a>
						    </display:column>
							<display:column property="bscid" titleKey="dyBscCpload.bscid" headerClass="hide" class="hide" />
								
							<display:column property="maxHourGsl" class="rightColumnMana" titleKey="dyPcuCongestion.maxHour" sortable="true" sortName="MAX_HOUR"/>
							<display:column property="gslutil" class="rightColumnMana" titleKey="dyGslUtility.gslutil" sortable="true" sortName="GSLUTIL"/>
							<display:column property="gslscan" class="rightColumnMana" titleKey="dyGslUtility.gslscan" sortable="true" sortName="GSLSCAN"/>
							<display:column property="gslutilRate" class="rightColumnMana GSLUTIL_RATE" titleKey="dyGslUtility.gslutilRate" sortable="true" sortName="GSLUTIL_RATE"/>
