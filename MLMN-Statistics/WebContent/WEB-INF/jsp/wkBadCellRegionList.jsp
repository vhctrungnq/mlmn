...
<content tag="heading">LIST BAD CELL BY CENTER WEEKLY</content>
<ul class="ui-tabs-nav">
	...
	<li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio/bad-cell/by-region/list.htm?startDate=${startDate}&endDate=${endDate}"><span>Bad Cell by Center</span></a></li>
</ul>
<div class="ui-tabs-panel">
	<a href="${pageContext.request.contextPath}/report/radio/bad-cell/by-region/list.htm?startDate=${startDate}&endDate=${endDate}"><span>Theo Ngày</span></a>
<span>Theo Tuần</span>
<a href="${pageContext.request.contextPath}/report/radio/bad-cell/by-region/mnList.htm?endMonth=${endMonth}&endYear=${endYear}"><span>Theo Tháng</span></a>
