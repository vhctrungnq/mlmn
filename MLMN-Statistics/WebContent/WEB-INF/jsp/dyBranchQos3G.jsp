...
<content tag="heading">BRANCH QOS 3G ${branch} REPORT</content>
<ul class="ui-tabs-nav">
  <li class=""><a href="${pageContext.request.contextPath}/report/radio3g/branch/hr/detail.htm?branch=${branch}&endDate=${endDate}"><span>Báo cáo giờ</span></a></li>
  <li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio3g/branch/dy/detail.htm?branch=${branch}&endDate=${endDate}"><span>Báo cáo ngày</span></a></li>
...
<br/>
	<div  id="doublescroll">
<display:table name="${vRpDyBranchList}" id="vRpDyBranch" requestURI="" pagesize="100" class="simple2" export="true">
