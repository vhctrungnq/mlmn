...
<title>TỔNG HỢP CHI PHÍ THEO TRẠM</title>
<content tag="heading">TỔNG HỢP CHI PHÍ THEO TRẠM</content>
<form:form commandName="filter" method="GET" action="list.htm">
	<table >
			...
			<tr> 
				...
				<td>
					<input type="text" id="smonth"  name="smonth" value="${smonth}" style="width: 100px;" />
				</td>
				<td style="padding-left: 5px;"><fmt:message key="PhanBoChiPhi.emonth"/></td>
				<td>
					<input type="text" id="emonth"  name="emonth" value="${emonth}" style="width: 100px;" />
				</td>
				<td style="padding-left: 5px;"><fmt:message key="PhanBoChiPhi.tram"/></td>
				<td>
					<input type="text" id="tram"  name="tram" style="width: 150px;" />
				</td>
				<td style="padding-left: 5px;"><fmt:message key="PhanBoChiPhi.nhom"/></td>
				<td>
					<input type="text" id="nhom"  name="nhom" style="width: 150px;" />
				</td>
...
$(document).ready(function(){
     ...
     // tram
        $("#tram").jqxInput({placeHolder: "Enter tram", height: 20, width: 150, minLength: 0, maxLength: 200, theme: theme});
        
     // nhom
        
     
        ${teamList}
        $("#nhom").jqxInput({ height: 20, width: 150, theme: theme,
            source: function (query, response) {
                var item = query.split(/,\s*/).pop();
                // update the search query.
                $("#nhom").jqxInput({ query: item });
                response(teamList);
            },
            renderer: renderer
        });
