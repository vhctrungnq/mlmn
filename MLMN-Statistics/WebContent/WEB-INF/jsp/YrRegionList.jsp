...
<title>Center Year Report</title>
<content tag="heading">CENTER QOS YEAR REPORT</content>
<ul class="ui-tabs-nav">
  ...
  <li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio/center/yr.htm?region=${temp.region}"><span>Báo cáo Năm</span></a></li>
</ul>
<div class="ui-tabs-panel">
		<table width="100%" class="form">
			<tr>
			  <td align="left">
			 <form method="get" action="yr.htm" name = "frmSample" onSubmit="return ValidateFormYear()">
	            	...
	            	Từ năm <input value="${startYear}" name="startYear" id="startYear" size="4" maxlength="4" onchange ="javascript:checkNumber(document.frmSample.startYear);">
	            	&nbsp;&nbsp;Đến năm <input value="${endYear}" name="endYear" id="endYear" size="4" maxlength="4" onchange ="javascript:checkNumber(document.frmSample.endYear);">
	...
	<div  style="overflow: auto;">
		<display:table name="${YrregionList}" id="YrregionList" requestURI="" pagesize="100" class="simple3" export="true">		
