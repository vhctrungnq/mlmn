...
<title>BÁO CÁO LỖI PHẦN CỨNG 3G</title>
<content tag="heading">BÁO CÁO LỖI PHẦN CỨNG 3G</content> 	
...
<div  style="overflow: auto;">
		<display:table name="${vAlHrHardWare3G}" id="vAlHrHardWare3G" requestURI="" pagesize="100" class="simple3" export="true">
