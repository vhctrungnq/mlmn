...
<content tag="heading">BSC IBC WEEKLY REPORT</content>
<ul class="ui-tabs-nav">
	<li class=""><a href="${pageContext.request.contextPath}/report/radio/ibc/bsc/dy/list.htm"><span>Báo cáo ngày</span></a></li>
	<li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio/ibc/bsc/wk/list.htm"><span>Báo cáo tuần</span></a></li>
		...
		<table width="100%" class="form">
			<tr>
			  ...
			  <form method="get" action="list.htm" name="frmSample" onSubmit="return ValidateFormWeek()">
			        ...
			        &nbsp;BSC<select name="bscid" id="bscid" style="width: 163px">
...
<display:table name="${vRpWkBscIbc}" id="vRpWkBscIbc" requestURI="" pagesize="100" class="simple2" export="true">
	    ...
	    <display:column titleKey="BSC" media="html" sortable="true" sortProperty="bscid">
	    	<a href="${pageContext.request.contextPath}/report/radio/ibc/bsc/wk/detail.htm?bscid=${vRpWkBscIbc.bscid}&endWeek=${vRpWkBscIbc.week}&endYear=${vRpWkBscIbc.year}&startWeek=${vRpWkBscIbc.week}&startYear=${vRpWkBscIbc.year}">${vRpWkBscIbc.bscid}</a>
	    </display:column>
	    ...
	    <display:column titleKey="SITES" media="html" sortable="true" sortProperty="sites">
	    	<a href="${pageContext.request.contextPath}/report/radio/site-qos/wk/list.htm?bscid=${vRpWkBscIbc.bscid}&week=${vRpWkBscIbc.week}&year=${vRpWkBscIbc.year}"><fmt:formatNumber pattern="#,###,###,##0.##" value="${vRpWkBscIbc.sites}"/></a>
	    </display:column>
	    ...
	    <display:column titleKey="CELLS" media="html" sortable="true" sortProperty="cells">
	    	<a href="${pageContext.request.contextPath}/report/radio/ibc/cell/wk/list.htm?bscid=${vRpMnBsc.bscid}&week=${vRpWkBscIbc.week}&year=${vRpWkBscIbc.year}"><fmt:formatNumber pattern="#,###,###,##0.##" value="${vRpWkBscIbc.cells}"/></a>
	    </display:column>
