...
<content tag="heading">MSC PAGING FOR AREA OBJ BC HOURLY REPORT</content>
...
<div  id="doublescroll">
		<display:table name="${hrMscPagAreBC}" id="hrMscPagAreBC" requestURI="" pagesize="100" class="simple3" export="true"  defaultsort="1">
		    <display:column property="mscid" titleKey="SYSTEM"/>
		    <display:column property="obj" titleKey="OBJ"/>
		    <display:column property="bc" titleKey="BC"/>
