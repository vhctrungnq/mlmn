...
<content tag="heading">PROVINCE QOS 3G REPORT ${province}</content>
<ul class="ui-tabs-nav">
  ...
  <li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio3g/province/mn/detail.htm?province=${province}&endMonth=${endMonth}&endYear=${endYear}"><span>Báo cáo tháng</span></a></li>
  ...
  <li class=""><a href="${pageContext.request.contextPath}/report/radio3g/province/mn/bh.htm?province=${province}&endMonth=${endMonth}&endYear=${endYear}"><span>Báo cáo BH tháng</span></a></li> --%>
</ul>
