...
<c:choose> 
 	<c:when test="${function == 'kiem-ke'}">
 		<table style = "border:0; width:100%; cellspacing:0; cellpadding:0;" class="form">
			<tr> 
				<td align="left" colspan="2">
				<form:form commandName="filter" method="post" action="kiem-ke.htm">
			...
			<tr>
				...
				<td class="wid10 mwid100" align="right">
					...
					<a href="kiem-ke.htm"><fmt:message key="title.tabControls.kiemKe"/></a>&nbsp;-
				...
				<td colspan="2">
					<div style="width:100%;overflow:auto; ">
						<display:table name="${assetsInventoryingList}" class="simple2" id="item" requestURI="" pagesize="100" sort="external" defaultsort="1" export="true" >
							...
							<display:column class="centerColumnMana" property="lechCu" titleKey="assetsInventorying.lech" />
	...
	<c:when test="${function == 'dieu-chinh'}">
		<%@ include file="/WEB-INF/jspassets/assetsInventoryingAdjusted.jsp"%>
	</c:when>
