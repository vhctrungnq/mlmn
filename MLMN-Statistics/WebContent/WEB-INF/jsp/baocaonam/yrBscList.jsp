...
<content tag="heading">BSC QoS YEARLY REPORT</content>
<ul class="ui-tabs-nav">
	...
	<li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio/bsc/yr/list.htm"><span>Báo cáo năm</span></a></li>
</ul>
...
<display:table name="${vRpYrBscQosList}" id="item" requestURI="" pagesize="100" class="simple2" export="true">
