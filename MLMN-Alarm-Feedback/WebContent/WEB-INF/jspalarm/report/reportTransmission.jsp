...
<div>
	<div align="left">
		...
		<c:choose>
			<c:when test="${type == 'NE'}">
				<li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/jitter/${function}.htm?type=NE"><span><fmt:message key="title.tabControls.NE"/></span></a></li>
				<li class=""><a href="${pageContext.request.contextPath}/report/jitter/${function}.htm?type=TEAM"><span><fmt:message key="title.tabControls.TEAM"/></span></a></li>
				<li class=""><a href="${pageContext.request.contextPath}/report/jitter/${function}.htm?type=PROVINCE"><span><fmt:message key="title.tabControls.PROVINCE"/></span></a></li>
			</c:when>
		 	<c:when test="${type == 'TEAM'||type == 'DISTRICT'}">
				<li class=""><a href="${pageContext.request.contextPath}/report/jitter/${function}.htm?type=NE"><span><fmt:message key="title.tabControls.NE"/></span></a></li>
				<li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/jitter/${function}.htm?type=TEAM"><span><fmt:message key="title.tabControls.TEAM"/></span></a></li>
				<li class=""><a href="${pageContext.request.contextPath}/report/jitter/${function}.htm?type=PROVINCE"><span><fmt:message key="title.tabControls.PROVINCE"/></span></a></li>
			</c:when>
			<c:when test="${type == 'PROVINCE'}">
				<li class=""><a href="${pageContext.request.contextPath}/report/jitter/${function}.htm?type=NE"><span><fmt:message key="title.tabControls.NE"/></span></a></li>
				<li class=""><a href="${pageContext.request.contextPath}/report/jitter/${function}.htm?type=TEAM"><span><fmt:message key="title.tabControls.TEAM"/></span></a></li>
				<li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/jitter/${function}.htm?type=PROVINCE"><span><fmt:message key="title.tabControls.PROVINCE"/></span></a></li>
			</c:when>
		 	<c:otherwise>
		 		<li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/jitter/${function}.htm?type=NE"><span><fmt:message key="title.tabControls.NE"/></span></a></li>
				<li class=""><a href="${pageContext.request.contextPath}/report/jitter/${function}.htm?type=TEAM"><span><fmt:message key="title.tabControls.TEAM"/></span></a></li>
       ...
       $("#jqxgrid").on('cellselect', function (event) 
    	  		{
		    		...
		    		//alert(type+'--'+funtion);
    	  		    var columnheader = $("#jqxgrid").jqxGrid('getcolumn', event.args.datafield).text; 
    	  		  	if (columnheader!='Day' && columnheader!='Network' && columnheader!='Vendor' && columnheader!='Province' && 
    	  		  			columnheader!='NE' && columnheader!='Sub team'&& columnheader!='District')
    	  		    {
   	  		    	...
   	  		    	else
 	  		    	{
    	  		    	...
    	  		    	if (type=='')
    	  		    	 ...
    	  		    	 window.open('${pageContext.request.contextPath}/report/detail/'+funtion+'.htm?sdate='+date+' 00:00'+
										'&edate='+date+' 23:59'+
											'&bscid='+ne+
											'&cellid='+site+'&vendor='+vendor+
											'&district='+district+
		    	  		    			'&alarmName=&province='+province+
			    	  		    		'&team='+team+
			    	  		    		'&alarmType='+alarmType+'&alarmMappingName=&reload=&reloadStr=&statusFinish='+
			    	  		    		'&severity=&netWork='+network+
			    	  		    		'&duarationTo=&bscPort=&btsPort=&objType='+objType+'&quality='+quality,'_blank');
    	  		    }
