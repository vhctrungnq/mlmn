...
<ul class="ui-tabs-nav">
  ...
  <li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio/location-gprs-cs/wk/details.htm?location=${location}&endWeek=${endWeek}&endYear=${endYear}"><span>Báo cáo tuần</span></a></li>
  ...
  <li class=""><a href="${pageContext.request.contextPath}/report/radio/location-gprs-cs/wk/bhDetails.htm?location=${location}&endWeek=${endWeek}&endYear=${endYear}"><span>Báo cáo BH tuần</span></a></li>
...
<div class="ui-tabs-panel">
	...
	<br/>
   	<div  id="doublescroll">
<display:table name="${vRpWkLocationGprsCsDetails}" id="vRpWkLocationGprsCsDetail" requestURI="" pagesize="100" class="simple2" export="true">
	...
	$(function() {
		...
		$( '.checkAll' ).live( 'change', function() {
			...
			if($( this ).is( ':checked' )){
				for (var i=5;i<=18;i++)
				{
					$('#vRpWkLocationGprsCsDetail td:nth-child('+i+'),#vRpWkLocationGprsCsDetail th:nth-child('+i+')').show();
				}
			} else {
				for (var i=5;i<=18;i++)
				{
					$('#vRpWkLocationGprsCsDetail td:nth-child('+i+'),#vRpWkLocationGprsCsDetail th:nth-child('+i+')').hide();
				}
			}
		});
