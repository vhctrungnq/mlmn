...
<ul class="ui-tabs-nav">
	...
	<li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/taithietbi/yr.htm?type=${type}"><span>Báo cáo năm</span></a></li>
</ul>

<br>
	<form method="post" action="yr.htm?type=${type}">
		<table style="width:100%;" class="form">
			<tr>
				<td align="left"> 
					...
					Từ năm <input value="${sYear}" name="sYear" id="sYear" class="wid4">&nbsp;&nbsp;
			        Đến năm <input value="${eYear}" name="eYear" id="eYear" class="wid4">&nbsp;&nbsp;
