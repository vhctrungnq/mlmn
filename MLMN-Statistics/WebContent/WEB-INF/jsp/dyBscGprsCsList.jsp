...
<content tag="heading">GPRS-CS BSC DAILY REPORT</content>
<ul class="ui-tabs-nav">
	<li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio/bsc-gprs-cs/dy/list.htm"><span>Báo cáo ngày</span></a></li>
...
<div class="ui-tabs-panel">
	...
	<br/>
			...
			<div  id="doublescroll">
	<display:table name="${vRpDyBscGprsCs}" id="vRpDyBscGprsCs" requestURI="" pagesize="100" class="simple2" export="true">
