...
<title>Báo cáo Cell CAPACITY</title>
<content tag="heading">CELL CAPACITY REPORT</content>
<ul class="ui-tabs-nav">
	<li class=""><a href="${pageContext.request.contextPath}/report/radio/cell-capacity/dy/list.htm"><span>Báo cáo ngày</span></a></li>
	<li class=""><a href="${pageContext.request.contextPath}/report/radio/cell-capacity/wk/list.htm"><span>Báo cáo tuần</span></a></li>
	<li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio/cell-capacity/mn/list.htm"><span>Báo cáo tháng</span></a></li>
</ul>
<div class="ui-tabs-panel">
	...
	<br/>
			...
			<div  id="doublescroll">
<display:table name="${vRpMnCellCapacity}" id="vRpMnCellCapacity" requestURI="" pagesize="100" class="simple2" export="true" sort="list">
