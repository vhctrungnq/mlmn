...
<content tag="heading">MSC PAGING FOR AREA HOURLY REPORT</content>

<ul class="ui-tabs-nav">
  <li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/core-era/msc-paging/hr.htm?mscid=${msc.mscid}&startDate=${startDate}&startHour=${startHour}&endDate=${endDate}&endHour=${endHour}"><span>Báo cáo giờ</span></a></li>
  <li class=""><a href="${pageContext.request.contextPath}/report/core-era/msc-paging/dy.htm?mscid=${msc.mscid}&startDate=${startDate}&endDate=${endDate}"><span>Báo cáo ngày</span></a></li>
</ul>
...
<div  id="doublescroll">
		<display:table name="${hrMscPagarea}" id="hrMscPagarea" requestURI="" pagesize="100" class="simple3" export="true" defaultsort="1" >
		    <display:column property="mscid" titleKey="SYSTEM" headerClass="hide" class="hide"/>
		    <display:column title="SYSTEM" media="html">
		   	 	<a target="_blank" href="${pageContext.request.contextPath}/report/core-era/msc-paging/detail.htm?mscid=${hrMscPagarea.mscid}&startDate=<fmt:formatDate pattern="dd/MM/yyyy" value="${hrMscPagarea.day}"/>&endDate=<fmt:formatDate pattern="dd/MM/yyyy" value="${hrMscPagarea.day}"/>">${hrMscPagarea.mscid}</a>
		    </display:column>
		    <display:column property ="hour" format="{0,number}:00" titleKey="Hour" />
		    <display:column property ="day" format="{0,date,dd/MM/yyyy}" titleKey="DAY" />
		    <display:column property="nlapag1lotot" titleKey="NLAPAG1LOTOT"/>
		    <display:column property="nlapag2lotot" titleKey="NLAPAG2LOTOT"/>
		    <display:column property="nlapag1resucc" titleKey="NLAPAG1RESUCC"/>
		    <display:column property="nlapag2resucc" titleKey="NLAPAG2RESUCC"/>
		    <display:column property="nlapagerr" titleKey="NLAPAGERR"/>
		    <display:column property="pagingSucc" titleKey="Paging Succ (%)" sortable="true"/>
		</display:table>
	</div>
