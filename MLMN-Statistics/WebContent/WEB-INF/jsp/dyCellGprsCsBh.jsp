...
<ul class="ui-tabs-nav">
  ...
  <li class=""><a href="${pageContext.request.contextPath}/report/radio/cell-gprs-cs/dy/detail.htm?cellid=${cellid}&bscid=${bscid}&endDate=${endDate}"><span>Báo cáo ngày</span></a></li>
  ...
  <li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio/cell-gprs-cs/dy/bh.htm?cellid=${cellid}&bscid=${bscid}&endDate=${endDate}"><span>Báo cáo BH ngày</span></a></li>
...
<div class="ui-tabs-panel">
	...
	<div  id="doublescroll">
<display:table style = "width: 150%"  name="${vRpDyCellGprsCsBh}" id="vRpDyCellGprsCsBh" requestURI="" pagesize="100" class="simple2" export="true">		
		<display:column  sortable="true"  headerClass="master-header-1"  property ="day" format="{0,date,dd/MM/yyyy}" titleKey="DAY"/>
		<display:column  sortable="true"  headerClass="master-header-1"  titleKey="BH">
		   	${vRpDyCellGprsCsBh.bh}:00
		</display:column> 
