...
<content tag="heading">BSC CPLOAD QOS DAILY REPORT</content>
<ul class="ui-tabs-nav">
  <li class=""><a href="${pageContext.request.contextPath}/report/core/bsc/cpload/hr.htm?bscid=${bscid}&endDate=${endDate}"><span>Báo cáo giờ</span></a></li>
  <li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/core/bsc/cpload/dy.htm?bscid=${bscid}&endDate=${endDate}"><span>Báo cáo ngày</span></a></li>
...
<div class="ui-tabs-panel">
		...
		<div style="overflow: auto;">
			<display:table name="${dyBscCploadQos}" id="dyBscCploadQos" requestURI="" pagesize="100" class="simple2" export="true" sort="list">
