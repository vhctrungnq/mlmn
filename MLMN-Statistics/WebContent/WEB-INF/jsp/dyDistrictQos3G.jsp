...
<content tag="heading">DISTRICT QOS 3G DAILY REPORT ${district}/${province}</content>
<ul class="ui-tabs-nav">
  <li class=""><a href="${pageContext.request.contextPath}/report/radio3g/district/hr/detail.htm?province=${province}&district=${district}&endDate=${endDate}"><span>Báo cáo giờ</span></a></li>
  <li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio3g/district/dy/detail.htm?province=${province}&district=${district}&endDate=${endDate}"><span>Báo cáo ngày</span></a></li>
  ...
  <li class=""><a href="${pageContext.request.contextPath}/report/radio3g/district/mn/detail.htm?province=${province}&district=${district}"><span>Báo cáo tháng</span></a></li>
  <%-- <li class=""><a href="${pageContext.request.contextPath}/report/radio3g/district/dy/bh.htm?province=${province}&district=${district}&endDate=${endDate}"><span>Báo cáo BH ngày</span></a></li>
  ...
  <li class=""><a href="${pageContext.request.contextPath}/report/radio3g/district/mn/bh.htm?province=${province}&district=${district}"><span>Báo cáo BH tháng</span></a></li> --%>
</ul>
...
<br/>
		<div  id="doublescroll">
			<display:table style = "width: 200%" name="${vRpDyDistrictList}" id="vRpDyDistrict" requestURI="" pagesize="100" class="simple2" export="true">
...
<%-- 			    <display:column property="region" titleKey="Center" sortable="true" headerClass="master-header-1"/>
 --%>			    <display:column property="province" titleKey="Province" sortable="true" headerClass="hide" class="hide"/>
				<display:column titleKey="Province" media="html" sortable="true" headerClass="master-header-1" sortProperty="province" style = "width: 120px">
			    	<a href="${pageContext.request.contextPath}/report/radio3g/province/dy/detail.htm?province=${vRpDyDistrict.province}&endDate=<fmt:formatDate pattern="dd/MM/yyyy" value="${vRpDyDistrict.day}"/>">${vRpDyDistrict.province}</a>
			    </display:column>
			    <display:column property="district" titleKey="District" sortable="true" headerClass="hide" class="hide"/>
			    <display:column titleKey="District" media="html" sortable="true" headerClass="master-header-1" sortProperty="district" style = "width: 120px">
			    	<a href="${pageContext.request.contextPath}/report/radio3g/district/hr/detail.htm?province=${vRpDyDistrict.province}&district=${vRpDyDistrict.district}&endDate=<fmt:formatDate pattern="dd/MM/yyyy" value="${vRpDyDistrict.day}"/>">${vRpDyDistrict.district}</a>
			    </display:column>
			    ...
			    <display:column titleKey="Cells" media="html" sortable="true" headerClass="master-header-1 margin" class="margin" sortProperty="cells">
			    	<a href="${pageContext.request.contextPath}/report/radio3g/cell/dy/list.htm?province=${vRpDyDistrict.province}&day=<fmt:formatDate pattern="dd/MM/yyyy" value="${vRpDyDistrict.day}"/>"><fmt:formatNumber pattern="#,###,###,##0.##" value="${vRpDyDistrict.cells}"/></a>
			    </display:column>
