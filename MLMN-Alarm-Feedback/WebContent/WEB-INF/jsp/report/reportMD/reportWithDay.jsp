...
<div>
<form:form commandName="filter" method="get" action="reportDay.htm">
	<table>
		<tr>
  ...
  <%-- <div style="overflow-y: auto; overflow-x: hidden; max-height: 1000px;padding-top:20px;" >
	<display:table name="${repotList}" class="simple2" id="item" requestURI="" export="true" defaultsort="1" decorator="org.displaytag.decorator.TotalTableDecorator">
		<display:column property="reportDay"  format="{0,date,dd/MM/yyyy}" titleKey="reportWithTeam.reportDay" />
		...
		<display:column property="mllAccuUuctSum"  format="{0,number,0}" titleKey="reportWithTeam.mllByAccuUuctSum" style="color:red;"   total="true"/>
		<display:column property="mllAccuUuctY"  format="{0,number,0}" titleKey="reportWithTeam.mllByAccuUuctY" total="true"/>
		<display:column property="mllAccuUuctN" format="{0,number,0}" titleKey="reportWithTeam.mllByAccuUuctN" total="true" />
		...
		<display:column property="nodeUuctSum"  format="{0,number,0}" titleKey="reportWithTeam.nodetdSum" style="color:red;"   total="true"/>
		<display:column property="nodeUuctY" format="{0,number,0}" titleKey="reportWithTeam.nodetdUuctY" total="true"/>
		<display:column property="nodeUuctN"  format="{0,number,0}" titleKey="reportWithTeam.nodetdUuctN" total="true"/>
		<display:column property="nodeMll" format="{0,number,0}" titleKey="reportWithTeam.nodetdMll" total="true"  />
	...
	<display:table name="${repotList}"  id="item" requestURI="" export="true"  decorator="org.displaytag.decorator.TotalTableDecorator">
		<display:column property="reportDay"  format="{0,date,dd/MM/yyyy}" titleKey="reportWithTeam.reportDay" />
		<display:column property="mdUuctSum" format="{0,number,0}" titleKey="reportWithTeam.mdUuctSum" style="color:red;"   total="true"/>
	  	<display:column property="mllByMpdUuctSum" format="{0,number,0}" titleKey="reportWithTeam.mllByMpdUuctSum" style="color:red;"  total="true"/>
		<display:column property="mllByMpdUuctY"  format="{0,number,0}" titleKey="reportWithTeam.mll2G" total="true"/>
		<display:column property="mllByMpdUuctN"  format="{0,number,0}" titleKey="reportWithTeam.mll3G" total="true"/>
		<display:column property="mllAccuUuctSum"  format="{0,number,0}" titleKey="reportWithTeam.mllByAccuUuctSum" style="color:red;"   total="true"/>
		<display:column property="mllAccuUuctY"  format="{0,number,0}" titleKey="reportWithTeam.mll2G" total="true"/>
		<display:column property="mllAccuUuctN" format="{0,number,0}" titleKey="reportWithTeam.mll3G" total="true" />
		<display:column property="nodeUuctSum"  format="{0,number,0}" titleKey="reportWithTeam.nodetdSum" style="color:red;"   total="true"/>
...
<script type="text/javascript">
	$(document).ready(function(){
	    ...
	    trs=trs +'<th><fmt:message key="reportWithTeam.mll2G"/></th>';
	    trs=trs +'<th><fmt:message key="reportWithTeam.mll3G"/></th>';
	    trs=trs +'<th ><fmt:message key="reportWithTeam.mllSum"/></th></tr>';
