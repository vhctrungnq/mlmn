...
<content tag="heading"><fmt:message key="sidebar.branch.3g.qos"/> ${branch}</content>
<ul class="ui-tabs-nav">
  ...
  <li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio3g/branch/mn/detail.htm?branch=${branch}&endMonth=${endMonth}&endYear=${endYear}"><span>Báo cáo tháng</span></a></li>
  ...
  <li class=""><a href="${pageContext.request.contextPath}/report/radio3g/branch/mn/bh.htm?branch=${branch}&endMonth=${endMonth}&endYear=${endYear}"><span>Báo cáo BH tháng</span></a></li> --%>
</ul>
...
<display:table name="${vRpMnBranchList}" id="vRpMnBranch" requestURI="" pagesize="100" class="simple2" export="true" sort="list">
		...
		<display:column property="branch" titleKey="Branch" sortable="true" headerClass="master-header-1"/>
