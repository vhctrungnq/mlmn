...
<content tag="heading">BSC GPRS-QOS WEEKLY REPORT ${bscid}</content>
<ul class="ui-tabs-nav">
  ...
  <li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio/bsc-gprs-qos/wk/detail.htm?bscid=${bscid}&endWeek=${endWeek}&endYear=${endYear}"><span>Báo cáo tuần</span></a></li>
  ...
  <li class=""><a href="${pageContext.request.contextPath}/report/radio/bsc-gprs-qos/wk/bh.htm?bscid=${bscid}&endWeek=${endWeek}&endYear=${endYear}"><span>Báo cáo BH tuần</span></a></li>
  <li class=""><a href="${pageContext.request.contextPath}/report/radio/bsc-gprs-qos/mn/bh.htm?bscid=${bscid}"><span>Báo cáo BH tháng</span></a></li>
	...
	<display:table name="${vRpWkBscGprsQosList}" id="vRpWkBscGprsQos" requestURI="" pagesize="100" class="simple2" export="true">
