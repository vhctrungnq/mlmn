...
<title>GPRS-CS PROVINCE REPORT</title>
<content tag="heading">GPRS-CS PROVINCE MONTHLY BH ${province} REPORT</content>
<ul class="ui-tabs-nav">
  ...
  <li class=""><a href="${pageContext.request.contextPath}/report/radio/province-gprs-cs/mn/details.htm?province=${province}&endMonth=${endMonth}&endYear=${endYear}"><span>Báo cáo tháng</span></a></li>
  ...
  <li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio/province-gprs-cs/mn/bhDetails.htm?province=${province}&endMonth=${endMonth}&endYear=${endYear}"><span>Báo cáo BH tháng</span></a></li>
</ul>
<div class="ui-tabs-panel">
	...
	<br/>
	<div  id="doublescroll">
<display:table name="${vRpMnProvinceGprsCsBhDetails}" id="vRpMnProvinceGprsCsBhDetail" requestURI="" pagesize="100" class="simple2" export="true">
	    ...
	    <display:column titleKey="PROVINCE" media="html">
	    	<a href="${pageContext.request.contextPath}/report/radio/province-gprs-cs/mn/bhDetails.htm?province=${vRpMnProvinceGprsCsBhDetail.province}&endMonth=${vRpMnProvinceGprsCsBhDetail.month}&endYear=${vRpMnProvinceGprsCsBhDetail.year}">${vRpMnProvinceGprsCsBhDetail.province}</a>&nbsp;
	    </display:column>
	...
	$(function() {
		$( '.checkAll' ).live( 'change', function() {
			...
			if($( this ).is( ':checked' )){
				for (var i=6;i<=18;i++)
				{
					$('#vRpMnProvinceGprsCsBhDetail td:nth-child('+i+'),#vRpMnProvinceGprsCsBhDetail th:nth-child('+i+')').show();
				}
			} else {
				for (var i=6;i<=18;i++)
				{
					$('#vRpMnProvinceGprsCsBhDetail td:nth-child('+i+'),#vRpMnProvinceGprsCsBhDetail th:nth-child('+i+')').hide();
				}
			}
		});
