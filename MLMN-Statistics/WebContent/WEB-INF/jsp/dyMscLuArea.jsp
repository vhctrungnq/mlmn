...
<content tag="heading">MSC LOCATION UPDATE ARER DAILY REPORT</content>

<ul class="ui-tabs-nav">
  <li class=""><a href="${pageContext.request.contextPath}/report/core-era/lu-area/msc/hr.htm?mscid=${msc.mscid}&startDate=${startDate}&endDate=${endDate}"><span>Báo cáo giờ</span></a></li>
  <li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/core-era/lu-area/msc/dy.htm?mscid=${msc.mscid}&startDate=${startDate}&endDate=${endDate}"><span>Báo cáo ngày</span></a></li>
</ul>
...
<div  id="doublescroll">
		<display:table name="${dyMSCluarea}" id="dyMSCluarea" requestURI="" pagesize="100" class="simple3" export="true">
		    <display:column property="mscid" titleKey="SYSTEM" headerClass="hide" class="hide"/>
		    <display:column title="SYSTEM" media="html">
		   	 	<a href="${pageContext.request.contextPath}/report/core-era/lu-area/msc/hr.htm?mscid=${dyMSCluarea.mscid}&startDate=<fmt:formatDate pattern="dd/MM/yyyy" value="${dyMSCluarea.day}"/>&endDate=<fmt:formatDate pattern="dd/MM/yyyy" value="${dyMSCluarea.day}"/>">${dyMSCluarea.mscid}</a>
		    </display:column>
