...
<ul class="ui-tabs-nav">
  ...
  <li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio/ibc/province/mn/detail.htm?province=${province}&endMonth=${endMonth}&endYear=${endYear}"><span>Báo cáo tháng</span></a></li>
</ul>
...
<display:table name="${vRpMnProvinceIbcList}" id="vRpMnProvinceIbc" requestURI="" pagesize="100" class="simple2" export="true" sort="list">
