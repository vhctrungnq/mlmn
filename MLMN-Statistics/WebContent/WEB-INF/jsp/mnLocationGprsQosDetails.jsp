...
<ul class="ui-tabs-nav">
  ...
  <li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio/location-gprs-qos/mn/details.htm?location=${location}&endMonth=${endMonth}&endYear=${endYear}"><span>Báo cáo tháng</span></a></li>
  ...
  <li class=""><a href="${pageContext.request.contextPath}/report/radio/location-gprs-qos/mn/bhDetails.htm?location=${location}&endMonth=${endMonth}&endYear=${endYear}"><span>Báo cáo BH tháng</span></a></li>
</ul>
...
<display:table name="${vRpMnLocationGprsQosDetails}" id="vRpMnLocationGprsQosDetail" requestURI="" pagesize="100" class="simple2" export="true">
