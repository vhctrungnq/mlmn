...
<content tag="heading">MSC INTERATIVE MESSAGING STS DATA DAILY REPORT</content>
 
<ul class="ui-tabs-nav">
  <li class=""><a href="${pageContext.request.contextPath}/report/core/inter-messag/hr.htm?mscid=${msc.mscid}&startDate=${startDate}&endDate=${endDate}"><span>Báo cáo giờ</span></a></li>
  <li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/core/inter-messag/dy.htm?mscid=${msc.mscid}&startDate=${startDate}&endDate=${endDate}"><span>Báo cáo ngày</span></a></li>
</ul>
...
<div  id="doublescroll">
		<display:table name="${DyMscIntermess}" id="DyMscIntermess" requestURI="" pagesize="100" class="simple3" export="true">
			<display:column property="mscid" titleKey="SYSTEM" headerClass="hide" class="hide"/>		   
		    <display:column title="SYSTEM" media="html">
		   	 	<a href="${pageContext.request.contextPath}/report/core/inter-messag/hr.htm?mscid=${DyMscIntermess.mscid}&startDate=<fmt:formatDate pattern="dd/MM/yyyy" value="${DyMscIntermess.day}"/>&endDate=<fmt:formatDate pattern="dd/MM/yyyy" value="${DyMscIntermess.day}"/>">${DyMscIntermess.mscid}</a>
		    </display:column>
		    <display:column property ="day" format="{0,date,dd/MM/yyyy}" titleKey="DAY" />
		   <display:column property="callAttemp" titleKey="Call Attempst"/>
		    <display:column property="failCallAtemp" titleKey="Failed Call Attempst"/>
		    <display:column property="basicMessigSucc" titleKey="Basic message success rate"/>
		</display:table>
	</div>
