...
<title>BÁO CÁO CELL MẤT LƯU LƯỢNG</title>
<content tag="heading">BÁO CÁO CELL MẤT LƯU LƯỢNG</content> 	
...
<div  style="overflow: auto;">
		<display:table name="${vAlDyNoTraffCells}" id="vAlDyNoTraffCells" requestURI="" pagesize="100" class="simple3" export="true">
		    ...
		    <display:column property="tchAvailable" titleKey="TCH_AVAILABLE" sortable="true"/>
