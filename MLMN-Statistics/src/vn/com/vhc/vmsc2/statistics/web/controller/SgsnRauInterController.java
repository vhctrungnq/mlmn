 ...
 */
@Controller
@RequestMapping("/report/core/sgsn-rau-intra-pp-inter/*")
public class SgsnRauInterController extends BaseController {
	@Autowired
	...
	public String showReport(@RequestParam(required = false) String sgsnid, @RequestParam(required = false) String startHour,
		...
		sgsnid = ModelAddtributes.checkSgsn(model, sgsnList, sgsnid, "sgsn-rau-intra-pp-inter");
