...
<content tag="heading">Báo cáo Province IBC</content>
<ul class="ui-tabs-nav">
	<li class=""><a href="${pageContext.request.contextPath}/report/radio/ibc/province/dy/list.htm"><span>Báo cáo ngày</span></a></li>
	<li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio/ibc/province/wk/list.htm"><span>Báo cáo tuần</span></a></li>
...
<div class="ui-tabs-panel">
	...
	<br/>
		...
		<div  style="overflow: auto;">
			<display:table name="${vRpWkProvinceIbc}" id="vRpWkProvinceIbc" requestURI="" pagesize="100" class="simple2" export="true" sort="list">
			    ...
			    <display:column titleKey="PROVINCE" media="html" sortable="true" sortProperty="province">
			    	<a href="${pageContext.request.contextPath}/report/radio/ibc/province/wk/detail.htm?province=${vRpWkProvinceIbc.province}&endWeek=${vRpWkProvinceIbc.week}&endYear=${vRpWkProvinceIbc.year}&startWeek=${vRpWkProvinceIbc.week}&startYear=${vRpWkProvinceIbc.year}">${vRpWkProvinceIbc.province}</a>
			    </display:column>
