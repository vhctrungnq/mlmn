...
class AL_FilePatternInfo {
    static final String QUERY =
        "select cfp.source_server, cfp.pattern_id, cfp.file_pattern, cfp.raw_table, cs.base_dir || cfp.sub_dir as local_dir, cfp.node_pattern_group, cfp.time_pattern_group, cfp.time_pattern from c_file_patterns cfp join c_servers cs on (cfp.local_server = cs.server_id) where  status = 'Y' and cfp.source_server = ";
     ...
     */
    public AL_RawFileInfo getRawFileInfo(String filePath) {
        //Need to implements
        return null;
    }
