...
public class AL_FileSweeper {
    private static Logger logger =
        Logger.getLogger(AL_FileSweeper.class.getName());
    private long backupDay;
    private File rootDir;

    public AL_FileSweeper(String rootDir, long backupDay) throws IOException {
    ...
    public static void main(String[] args) throws IOException {
        new AL_FileSweeper("H:\\Temp\\test.txt", 30).doSweep();
    }
