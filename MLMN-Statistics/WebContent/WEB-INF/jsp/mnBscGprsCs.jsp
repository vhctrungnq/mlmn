...
<content tag="heading">BSC GPRS-CS MONTHLY REPORT ${bscid}</content>
<ul class="ui-tabs-nav">
  ...
  <li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio/bsc-gprs-cs/mn/detail.htm?bscid=${bscid}&endMonth=${endMonth}&endYear=${endYear}"><span>Báo cáo tháng</span></a></li>
  ...
  <li class=""><a href="${pageContext.request.contextPath}/report/radio/bsc-gprs-cs/mn/bh.htm?bscid=${bscid}&endMonth=${endMonth}&endYear=${endYear}"><span>Báo cáo BH tháng</span></a></li>
</ul>
...
<br/>
			...
			<div  id="doublescroll">
<display:table name="${vRpMnBscGprsCsList}" id="vRpMnBscGprsCs" requestURI="" pagesize="100" class="simple2" export="true">
	    ...
	    <display:column titleKey="BSC" media="html">
	    	<a href="${pageContext.request.contextPath}/report/radio/cell-gprs-cs/mn/detail.htm?bscid=${vRpMnBscGprsCs.bscid}&cellid=&endMonth=${vRpMnBscGprsCs.month}&endYear=${vRpMnBscGprsCs.year}">${vRpMnBscGprsCs.bscid}</a>&nbsp;
	    </display:column>
