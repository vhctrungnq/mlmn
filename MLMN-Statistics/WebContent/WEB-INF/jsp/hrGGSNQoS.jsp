...
<title>GGSN Hourly Report</title>
<content tag="heading">GGSN QOS HOURLY REPORT</content>

<ul class="ui-tabs-nav">
  <li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/core/ggsn/hr.htm?region=${msc.region}&ggsnName=${ggsn.ggsnName}&startDate=${startDate}&startHour=${startHour}&endDate=${endDate}&endHour=${endHour}"><span>Báo cáo giờ</span></a></li>
  <li class=""><a href="${pageContext.request.contextPath}/report/core/ggsn/dy.htm?region=${msc.region}&ggsnName=${ggsn.ggsnName}&startDate=${startDate}&endDate=${endDate}"><span>Báo cáo ngày</span></a></li>
  <li class=""><a href="${pageContext.request.contextPath}/report/core/ggsn/wk.htm?region=${msc.region}"><span>Báo cáo tuần</span></a></li>
...
<div  id="doublescroll">
		<display:table name="${HrGGSNQos}" id="HrGGSNQos" requestURI="" pagesize="100" class="simple3" export="true">
