...
<ul class="ui-tabs-nav">
  <li class=""><a href="${pageContext.request.contextPath}/report/radio/ibc/province/hr/detail.htm?province=${province}"><span>Báo cáo giờ</span></a></li>
  <li class=""><a href="${pageContext.request.contextPath}/report/radio/ibc/province/dy/detail.htm?province=${province}"><span>Báo cáo ngày</span></a></li>
  <li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio/ibc/province/wk/detail.htm?province=${province}&endWeek=${endWeek}&endYear=${endYear}"><span>Báo cáo tuần</span></a></li>
...
<display:table name="${VRpWkProvinceIbcList}" id="VRpWkProvinceIbc" requestURI="" pagesize="100" class="simple2" export="true" sort="list">
		...
		<display:column titleKey="PROVINCE" media="html" sortable="true" sortProperty="province">
	    	<a href="${pageContext.request.contextPath}/report/radio/ibc/district/wk/list.htm?province=${VRpWkProvinceIbc.province}&endWeek=${VRpWkProvinceIbc.week}&endYear=${VRpWkProvinceIbc.year}&startWeek=${VRpWkProvinceIbc.week}&startYear=${VRpWkProvinceIbc.year}">${VRpWkProvinceIbc.province}</a>
	    </display:column>
