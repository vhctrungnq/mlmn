...
<content tag="heading">GPRS QOS ${province} REPORT</content>
<ul class="ui-tabs-nav">
  ...
  <li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio/province-gprs-qos/wk/details.htm?province=${province}&endWeek=${endWeek}&endYear=${endYear}"><span>Báo cáo tuần</span></a></li>
  ...
  <li class=""><a href="${pageContext.request.contextPath}/report/radio/province-gprs-qos/wk/bhDetails.htm?province=${province}&endWeek=${endWeek}&endYear=${endYear}"><span>Báo cáo BH tuần</span></a></li>
...
<display:table name="${vRpWkProvinceGprsQosDetails}" id="vRpWkProvinceGprsQosDetail" requestURI="" pagesize="100" class="simple2" export="true">
	    ...
	    <display:column titleKey="PROVINCE" media="html">
	    	<a href="${pageContext.request.contextPath}/report/radio/province-gprs-qos/wk/details.htm?province=${vRpWkProvinceGprsQosDetail.province}&endWeek=${week}&endYear=${year}">${vRpWkProvinceGprsQosDetail.province}</a>&nbsp;
	    </display:column>
	...
	$(function() {
		$( '.checkAll' ).live( 'change', function() {
			...
			if($( this ).is( ':checked' )){
				for (var i=6;i<=14;i++)
				{
					$('#vRpWkProvinceGprsQosDetail td:nth-child('+i+'),#vRpWkProvinceGprsQosDetail th:nth-child('+i+')').show();
				}
			} else {
				for (var i=6;i<=14;i++)
				{
					$('#vRpWkProvinceGprsQosDetail td:nth-child('+i+'),#vRpWkProvinceGprsQosDetail th:nth-child('+i+')').hide();
				}
			}
		});
