...
<title>bsc ol ul handover hourly report</title>
<content tag="heading">OL-UL HANDOVER BSC ${bscid} REPORT</content>
<ul class="ui-tabs-nav">
  <li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio/bsc/ho/hr.htm?bscid=${bscid}&endDate=${endDate}"><span>Báo cáo giờ</span></a></li>
  <li class=""><a href="${pageContext.request.contextPath}/report/radio/bsc/ho/dy.htm?bscid=${bscid}&endDate=${endDate}"><span>Báo cáo ngày</span></a></li>
</ul>
...
<display:table name="${hrBscHsrOulQosList}" id="hrBscHsrOulQos" requestURI="" pagesize="100" class="simple2" export="true">
