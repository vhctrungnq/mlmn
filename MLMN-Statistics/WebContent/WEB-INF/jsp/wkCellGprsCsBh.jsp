...
<ul class="ui-tabs-nav">
  ...
  <li class=""><a href="${pageContext.request.contextPath}/report/radio/cell-gprs-cs/wk/detail.htm?cellid=${cellid}&bscid=${bscid}&endWeek=${endWeek}&endYear=${endYear}"><span>Báo cáo tuần</span></a></li>
  ...
  <li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio/cell-gprs-cs/wk/bh.htm?cellid=${cellid}&bscid=${bscid}&endWeek=${endWeek}&endYear=${endYear}"><span>Báo cáo BH tuần</span></a></li>
  <li class=""><a href="${pageContext.request.contextPath}/report/radio/cell-gprs-cs/mn/bh.htm?cellid=${cellid}&bscid=${bscid}"><span>Báo cáo BH tháng</span></a></li>
	...
	<div  id="doublescroll">
<display:table name="${vRpWkCellGprsCsBh}" id= "vRpWkCellGprsCsBh" requestURI="" pagesize="100" class="simple2" export="true">
		<display:column property ="week" title="WEEK" headerClass="master-header-1"/>
