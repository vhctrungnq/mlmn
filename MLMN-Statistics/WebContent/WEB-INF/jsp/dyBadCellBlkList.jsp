...
<content tag="heading">LIST CELL CONGESTION TCH DAILY</content>
<ul class="ui-tabs-nav">
	<li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio/bad-cell-blk/by-cell/list.htm?bscid=${bscid}&cellid=${cellid}&startDate=${startDate}&endDate=${endDate}"><span>Cell nghẽn TCH</span></a></li>
...
<div class="ui-tabs-panel">
	...
	<div  style="overflow: auto;">
		<display:table name="${dyBadCellList}" id="dyBadCell" requestURI="" pagesize="100" class="simple3" sort="external" defaultsort="1" export="true">
		    ...
		    <display:column property="tBlks" decorator="vn.com.vhc.vmsc2.statistics.web.utils.NumberDecorator" titleKey="T_BLKS"  sortable="true"/>
		    <display:column property="tBlkr" titleKey="T_BLKR" sortable="true"/>
		</display:table>
	</div>
</div>
