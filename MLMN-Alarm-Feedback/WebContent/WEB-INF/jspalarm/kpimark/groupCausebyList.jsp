...
<ul class="ui-tabs-nav">
	...
	<li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/alarm/kpi-mark-group-causeby/list.htm"><span><fmt:message key="kpismark.title.groupcauseby"/></span></a></li>
...
<script type="text/javascript">
	...
	$('#Menu').on('itemclick', function (event) {
		...
		if ($.trim($(args).text()) == '<fmt:message key="global.button.exportExcel"/>') {
				window.open('${pageContext.request.contextPath}/alarm/kpi-mark-group-causeby/exportData.htm?startDate='+"<c:out value='${startDate}'/>"+
    ...
    if(columnindex < 15){
   	...
   	window.open('${pageContext.request.contextPath}/alarm/kpi-mark-detail/list.htm?team='+team+ '&group='+group+ '&startDate='+startDate+ '&endDate='+endDate+ '&siteLevel='+sitelevel+'&causeby='+causeby+ '&shiftTime='+shiftTime ,'_blank');
