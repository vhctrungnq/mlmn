...
<content tag="heading">LIST CELL TRAFFIC &lt; 10 ERLANG WEEKLY OF DISTRICT</content>
<ul class="ui-tabs-nav">
	...
	<li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio/bad-cell-traff/by-district/list.htm?startDate=${startDate}&endDate=${endDate}"><span>Cell lưu lượng &lt; 10 Erlang của District</span></a></li>
...
<div class="ui-tabs-panel">
	<a href="${pageContext.request.contextPath}/report/radio/bad-cell-traff/by-district/list.htm?startDate=${startDate}&endDate=${endDate}"><span>Theo Ngày</span></a>
<span>Theo Tuần</span>
<a href="${pageContext.request.contextPath}/report/radio/bad-cell-traff/by-district/mnList.htm?endMonth=${endMonth}&endYear=${endYear}"><span>Theo Tháng</span></a>
