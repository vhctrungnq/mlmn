...
import vn.com.vhc.vmsc2.statistics.dao.VRpHrBscDAO;
...
@Controller
@RequestMapping("/report/radio/bsc/hr/*")
public class HrBscQosController extends BaseController {
	@Autowired
	private VRpHrBscDAO vRpHrBscDao;
	@Autowired
	...
	public String showReport(@RequestParam(required = false) String region,@RequestParam(required = false) String bscid, @RequestParam(required = false) String startHour,
		...
		List<VRpHrBsc> vRpHrBscList = new ArrayList<VRpHrBsc>();
		...
		for (VRpHrBsc vRpHrBsc : vRpHrBscList) {
			categories.add(Integer.toString(vRpHrBsc.getHour()) + ":00 " + ddf.format(vRpHrBsc.getDay()));
			cssrList.add(vRpHrBsc.getCssr());
			tTrafList.add(vRpHrBsc.gettTraf());
			tTrafhList.add(vRpHrBsc.gettTrafh());
			haftrateList.add(vRpHrBsc.getHalfrate());
			tDrprList.add(vRpHrBsc.gettDrpr());
			tBlkrList.add(vRpHrBsc.gettBlkr());
			sDrprList.add(vRpHrBsc.getsDrpr());
			sBlkrList.add(vRpHrBsc.getsBlkr());
		}
