...
<title>Báo cáo District Ibc ${district}/${province}</title>
<content tag="heading">DISTRICT IBC ${district}/${province} REPORT</content>
<ul class="ui-tabs-nav">
  <li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio/ibc/district/hr/detail.htm?province=${province}&district=${district}&endDate=${endDate}"><span>Báo cáo giờ</span></a></li>
  <li class=""><a href="${pageContext.request.contextPath}/report/radio/ibc/district/dy/detail.htm?province=${province}&district=${district}&endDate=${endDate}"><span>Báo cáo ngày</span></a></li>
...
<display:table name="${vRpHrDistrictIbcList}" id="vRpHrDistrictIbc" requestURI="" pagesize="100" class="simple2" export="true" sort="list">
			    ...
			    <display:column titleKey="PROVINCE" media="html" sortable="true" sortProperty="province">
			    	<a href="${pageContext.request.contextPath}/report/radio/ibc/province/hr/detail.htm?province=${vRpHrDistrictIbc.province}&endDate=<fmt:formatDate pattern="dd/MM/yyyy" value="${vRpHrDistrictIbc.day}"/>">${vRpHrDistrictIbc.province}</a>
			    </display:column>
			    <display:column property="district" titleKey="DISTRICT" class="margin" headerClass="margin" sortable="true"/>
