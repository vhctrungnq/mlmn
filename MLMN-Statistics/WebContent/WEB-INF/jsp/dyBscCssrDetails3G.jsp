...
<style type="text/css">    #doublescroll { overflow: auto; overflow-y: hidden; }    #doublescroll p { margin: 0; padding: 1em; white-space: nowrap; }</style><title>rnc speech cssr qos</title>
<content tag="heading">RNC SPEECH CSSR QoS REPORT</content>
<ul class="ui-tabs-nav">
  <li class=""><a href="${pageContext.request.contextPath}/report/radio3g/rnc/cssr/hr.htm?bscid=${bscid}&endDate=${endDate}"><span>Báo cáo giờ</span></a></li>
  <li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio3g/rnc/cssr/dy.htm?bscid=${bscid}&endDate=${endDate}"><span>Báo cáo ngày</span></a></li>
</ul>
<div class="ui-tabs-panel">
		...
		<div  id="doublescroll">
			<display:table name="${dyBscCssrDetails3G}" id="dyBscCssrDetails3G" requestURI="" pagesize="100" class="simple5" export="true" sort="list">
		    ...
		    <display:column titleKey="RNC Name" media="html" sortable="true" headerClass="master-header-1" sortProperty="bscid">
		    	<a href="${pageContext.request.contextPath}/report/radio3g/rnc/cssr/hr.htm?bscid=${dyBscCssrDetails3G.bscid}&startDate=<fmt:formatDate pattern="dd/MM/yyyy" value="${dyBscCssrDetails3G.day}"/>&endDate=<fmt:formatDate pattern="dd/MM/yyyy" value="${dyBscCssrDetails3G.day}"/>">${dyBscCssrDetails3G.bscid}</a>
		    </display:column>
