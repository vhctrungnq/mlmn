...
<content tag="heading">MSC CHANNEL ASSIGNMENT BC HOURLY REPORT</content>
...
<div  id="doublescroll">
		<display:table name="${hrMSCCABC}" id="hrMSCCABC" requestURI="" pagesize="100" class="simple3" export="true">
