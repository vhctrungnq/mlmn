...
<content tag="heading">GPRS-CS PROVINCE MONTHLY REPORT</content>
<ul class="ui-tabs-nav">
	...
	<li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio/province-gprs-cs/mn/list.htm"><span>Báo cáo tháng</span></a></li>
...
<div class="ui-tabs-panel">
	...
	<br/>
		<div  id="doublescroll">
<display:table name="${vRpMnProvinceGprsCs}" id="vRpMnProvinceGprsCs" requestURI="" pagesize="100" class="simple2" export="true">
	    ...
	    <display:column titleKey="PROVINCE" media="html">
	    	<a href="${pageContext.request.contextPath}/report/radio/province-gprs-cs/mn/details.htm?province=${vRpMnProvinceGprsCs.province}&endMonth=${vRpMnProvinceGprsCs.month}&endYear=${vRpMnProvinceGprsCs.year}">${vRpMnProvinceGprsCs.province}</a>&nbsp;
	    </display:column>
