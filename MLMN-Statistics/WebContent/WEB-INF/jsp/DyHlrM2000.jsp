...
<content tag="heading">M2000 DAILY REPORT</content>
 
<ul class="ui-tabs-nav">
  <li class=""><a href="${pageContext.request.contextPath}/report/core/RpHlrM2000/hr.htm?nodeid=${node.hlrid}&startDate=${startDate}&startHour=${startHour}&endDate=${endDate}&endHour=${endHour}"><span>Báo cáo giờ</span></a></li>
  <li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/core/RpHlrM2000/dy.htm?nodeid=${node.hlrid}&startDate=${startDate}&endDate=${endDate}"><span>Báo cáo ngày</span></a></li>
</ul>
...
<div  style="overflow: auto;">
		<display:table name="${DyHlrM2000}" id="DyHlrM2000" requestURI="" pagesize="100" class="simple3" export="true">
			
			<display:column property="nodeid" titleKey="SYSTEM" headerClass="hide" class="hide"/>
		    <display:column title="SYSTEM" media="html">
		   	 	<a href="${pageContext.request.contextPath}/report/core/RpHlrM2000/hr.htm?nodeid=${DyHlrM2000.nodeid}&startDate=<fmt:formatDate pattern="dd/MM/yyyy" value="${DyHlrM2000.day}"/>&endDate=<fmt:formatDate pattern="dd/MM/yyyy" value="${DyHlrM2000.day}"/>">${DyHlrM2000.nodeid}</a>
		    </display:column>
