...
<ul class="ui-tabs-nav">
  ...
  <li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio/ibc/bsc/dy/bh.htm?bscid=${bscid}&endDate=${endDate}"><span>Báo cáo BH ngày</span></a></li>
  ...
  <li class=""><a href="${pageContext.request.contextPath}/report/radio/ibc/bsc/mn/bh.htm?bscid=${bscid}"><span>Báo cáo BH tháng</span></a></li>
	...
	<display:table name="${vRpDyBscBhIbcList}" id="vRpDyBscBhIbc" requestURI="" pagesize="100" class="simple2" export="true" sort="list">
	    ...
	    <display:column titleKey="BSC" media="html" headerClass="margin" class="margin" sortable="true" sortProperty="bscid">
	    	<a href="${pageContext.request.contextPath}/report/radio/ibc/bsc/hr/detail.htm?bscid=${vRpDyBscBhIbc.bscid}&endDate=<fmt:formatDate pattern="dd/MM/yyyy" value="${vRpDyBscBhIbc.day}"/>">${vRpDyBscBhIbc.bscid}</a>
	    </display:column>  
