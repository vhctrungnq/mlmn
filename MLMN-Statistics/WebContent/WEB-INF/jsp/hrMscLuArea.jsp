...
<content tag="heading">MSC LOCATION UPDATE AREA HOURLY REPORT</content>

<ul class="ui-tabs-nav">
  <li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/core-era/lu-area/msc/hr.htm?mscid=${msc.mscid}&startDate=${startDate}&startHour=${startHour}&endDate=${endDate}&endHour=${endHour}"><span>Báo cáo giờ</span></a></li>
  <li class=""><a href="${pageContext.request.contextPath}/report/core-era/lu-area/msc/dy.htm?mscid=${msc.mscid}&startDate=${startDate}&endDate=${endDate}"><span>Báo cáo ngày</span></a></li>
</ul>
...
<div  id="doublescroll">
		<display:table name="${hrMscluarea}" id="hrMscluarea" requestURI="" pagesize="100" class="simple3" export="true">
		   <display:column property="mscid" titleKey="MSC" headerClass="hide" class="hide"/>
		    <display:column title="MSC" media="html">
		   	 	<a target="_blank" href="${pageContext.request.contextPath}/report/core-era/lu-area/msc/detail.htm?mscid=${hrMscluarea.mscid}&startDate=<fmt:formatDate pattern="dd/MM/yyyy" value="${hrMscluarea.day}"/>&endDate=<fmt:formatDate pattern="dd/MM/yyyy" value="${hrMscluarea.day}"/>">${hrMscluarea.mscid}</a>
		    </display:column>
