...
<content tag="heading">LIST BAD CELL 3G BY PROVINCE DAILY</content>
<ul class="ui-tabs-nav">
	<li class=""><a href="${pageContext.request.contextPath}/report/radio3g/bad-cell/by-cell/list.htm?cellid=${cellid}&startDate=${startDate}&endDate=${endDate}"><span>Bad Cell</span></a></li>
	...
	<li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio3g/bad-cell/by-province/list.htm?province=${province}&startDate=${startDate}&endDate=${endDate}"><span>Bad Cell by Province</span></a></li>
...
<div class="ui-tabs-panel">
	<span>theo ngày</span>&nbsp;
	<a href="${pageContext.request.contextPath}/report/radio3g/bad-cell/by-province/wk/list.htm?province=${province}"><span>theo tuần</span></a>&nbsp;
	<a href="${pageContext.request.contextPath}/report/radio3g/bad-cell/by-province/mn/list.htm?province=${province}"><span>theo tháng</span></a>
	<br/>
		...
		<table width="100%" class="form">
			<tr>
			  ...
			  <form method="get" action="list.htm" name="frmSample" onSubmit="return ValidateForm()">
					...
					Province <input name="province" id="province" value="${province}" size="10" onchange="xl()">
