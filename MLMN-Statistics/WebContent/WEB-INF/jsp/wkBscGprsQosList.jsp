...
<content tag="heading">BSC GPRS-QOS WEEKLY REPORT</content>
<ul class="ui-tabs-nav">
	<li class=""><a href="${pageContext.request.contextPath}/report/radio/bsc-gprs-qos/dy/list.htm"><span>Báo cáo ngày</span></a></li>
	<li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio/bsc-gprs-qos/wk/list.htm"><span>Báo cáo tuần</span></a></li>
		...
		<table width="100%" class="form">
			<tr>
			  ...
			  <form method="get" action="list.htm" name="frmSample" onSubmit="return ValidateFormWeek()">
					...
					<input value="${startWeek}" name="startWeek" id="startWeek" size="2" maxlength="2" onchange="javascript:checkNumber(document.frmSample.startWeek);">
...
<display:table name="${vRpWkBscGprsQos}" id="vRpWkBscGprsQos" requestURI="" pagesize="100" class="simple2" export="true">
	    ...
	    <display:column titleKey="BSC" media="html" sortable="true">
	    	<a href="${pageContext.request.contextPath}/report/radio/bsc-gprs-qos/wk/detail.htm?bscid=${vRpWkBscGprsQos.bscid}&endWeek=${week}&endYear=${year}">${vRpWkBscGprsQos.bscid}</a>&nbsp;
	    </display:column> 
