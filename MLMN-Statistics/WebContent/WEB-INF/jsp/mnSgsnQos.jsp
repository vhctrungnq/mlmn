...
<ul class="ui-tabs-nav">
  ...
  <li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/core/sgsn/mn/detail.htm?sgsnid=${sgsnid}&endMonth=${endMonth}&endYear=${endYear}"><span>Báo cáo tháng</span></a></li>
</ul>
	...
	<display:table name="${vRpMnSgsnQosList}" id="vRpMnSgsnQos" requestURI="" pagesize="100" class="simple2" export="true">
		...
		<display:column property="sgsnName" titleKey="SGSN Name" sortable="true"  headerClass="master-header-1"/>
