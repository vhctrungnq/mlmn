 ...
 */
@Controller
@RequestMapping("/report/core/sgsn-rau-2g/*")
public class SgsnRau2gController extends BaseController {
	@Autowired
	...
	public String showReport(@RequestParam(required = false) String sgsnid, @RequestParam(required = false) String startHour,
		...
		sgsnid = ModelAddtributes.checkSgsn(model, sgsnList, sgsnid, "sgsn-rau-2g");
