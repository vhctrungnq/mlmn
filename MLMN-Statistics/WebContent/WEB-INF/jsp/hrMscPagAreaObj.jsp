...
<content tag="heading">MSC PAGING FOR AREA OBJ HOURLY REPORT</content>
...
<div  id="doublescroll">
		<display:table name="${hrMscPagareaObj}" id="hrMscPagareaObj" requestURI="" pagesize="100" defaultsort="1" class="simple3" export="true">
		    <display:column property="mscid" titleKey="SYSTEM" headerClass="hide" class="hide"/>
		    <display:column title="SYSTEM" media="html">
		   	 	<a target="_blank" href="${pageContext.request.contextPath}/report/core-era/msc-paging/list.htm?mscid=${hrMscPagareaObj.mscid}&startDate=<fmt:formatDate pattern="dd/MM/yyyy" value="${hrMscPagareaObj.day}"/>&endDate=<fmt:formatDate pattern="dd/MM/yyyy" value="${hrMscPagareaObj.day}"/>">${hrMscPagareaObj.mscid}</a>
		    </display:column>
		    <display:column property="obj" titleKey="OBJ" sortable="true"/>
