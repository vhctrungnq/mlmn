...
<ul class="ui-tabs-nav">
	<li class=""><a href="${pageContext.request.contextPath}/report/core/linkset/hr/detail.htm?fromNode=${fromNode}&toNode=${toNode}&day=${day}"><span>Báo cáo giờ</span></a></li>
	<li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/core/linkset/dy/detail.htm?fromNode=${fromNode}&toNode=${toNode}"><span>Báo cáo ngày</span></a></li>
		...
		<tr>
			...
			<td width="20%" valign="top">
			    <table class="simple2">
			        <tr>
			            <td>Số Linkset </td>
			            <td>${dyLinksetReports.linksets}</td>
			        </tr>
			        <tr>
			            <td>Linkset Traffic </td>
			            <td>${dyLinksetReports.linksetTraf}</td>
			        </tr>
			        <tr>
			            <td>Utilisation (%)</td>
			            <td>${dyLinksetReports.linksetUtil}%</td>
			        </tr>
			    </table>
	    	</td>
	    	<td width="2%" valign="top"/>
			...
			<td valign="top">
			  <div id="notaccordion" style="width: 500px; margin: 0 auto">
				<c:forEach var="dyLinkset" items="${dyLinksets}">
				  <h3><a href="#">Linkset ${dyLinkset.linksetid}</a></h3>
				  <div>
					<table class="simple2">
						<tr>
							<td><b>Linkset Name</b></td>
							<td><b>${dyLinkset.linksetid}</b></td>	
						</tr>
						<tr>
							<td>From Node</td>
							<td>${dyLinkset.fromNode}</td>	
						</tr>
						<tr>
							<td>To Node</td>
							<td>${dyLinkset.toNode}</td>	
						</tr>
						<tr>
							<td>No. Link</td>
							<td>${dyLinkset.links}</td>	
						</tr>
						<tr>
							<td>Linkset traffic (Erlang)</td>
							<td>${dyLinkset.linksetTraf}</td>	
						</tr>
						<tr>
							<td>Utilisation (%)</td>
							<td>${dyLinkset.linksetUtil}%</td>	
						</tr>
					</table>
			      </div>
		        </c:forEach>
