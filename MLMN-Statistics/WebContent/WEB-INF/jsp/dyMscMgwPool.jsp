...
<content tag="heading">MSC MGW POOL PROCCESS STS DATA DAILY REPORT</content>
 
<ul class="ui-tabs-nav">
  <li class=""><a href="${pageContext.request.contextPath}/report/core/pool-process/hr.htm?mscid=${msc.mscid}&startDate=${startDate}&endDate=${endDate}"><span>Báo cáo giờ</span></a></li>
  <li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/core/pool-process/dy.htm?mscid=${msc.mscid}&startDate=${startDate}&endDate=${endDate}"><span>Báo cáo ngày</span></a></li>
</ul>
...
<div  id="doublescroll">
		<display:table name="${DyMscpool}" id="DyMscpool" requestURI="" pagesize="100" class="simple3" export="true">
			<display:column property="mscid" titleKey="SYSTEM" headerClass="hide" class="hide"/>		   
		    <display:column title="SYSTEM" media="html">
		   	 	<a href="${pageContext.request.contextPath}/report/core/pool-process/hr.htm?mscid=${DyMscpool.mscid}&startDate=<fmt:formatDate pattern="dd/MM/yyyy" value="${DyMscpool.day}"/>&endDate=<fmt:formatDate pattern="dd/MM/yyyy" value="${DyMscpool.day}"/>">${DyMscpool.mscid}</a>
		    </display:column>
