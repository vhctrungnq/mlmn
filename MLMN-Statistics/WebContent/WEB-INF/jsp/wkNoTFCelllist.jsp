...
<content tag="heading">NO TRAFFIC CELL WEEKLY REPORT</content>

<ul class="ui-tabs-nav">
  <li class=""><a href="${pageContext.request.contextPath}/report/radio/bad-cell/Notraffic/dy.htm?"><span>Báo cáo ngày</span></a></li>
  <li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio/bad-cell/Notraffic/wk.htm?bscid=${bsc.bscid}&cellid=${cell.cellid}&startWeek=${startWeek}&startYear=${startYear}&endWeek=${endWeek}&endYear=${endYear}"><span>Báo cáo tuần</span></a></li>
  <li class=""><a href="${pageContext.request.contextPath}/report/radio/bad-cell/Notraffic/mn.htm?"><span>Báo cáo tháng</span></a></li>
</ul>
  
<div class="ui-tabs-panel">
 <form:form commandName="filterno" method="post" action="wk.htm" name = "frmSample" onSubmit = "return ValidateFormWeek()">
...
<div  style="overflow: auto;">
  <display:table name="${Vrpwkcell}" id="Vrpwkcell" requestURI="" pagesize="100" class="simple3" export="true">
      ...
      <display:column property ="tUtil"  titleKey="TCH UTILITY RATE(%) = 0" />
  </display:table>
 </div>
