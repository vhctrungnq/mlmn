...
<title>CELL DATA 2G YEAR REPORT</title>
<content tag="heading">CELL DATA 2G YEAR REPORT</content>
	<ul class="ui-tabs-nav">
		...
		<li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio/cell-data/yr/list.htm"><span>Báo cáo năm</span></a></li>	
	</ul>
<div class="ui-tabs-panel">
	...
	<div  style="overflow: auto;" class="tableStandar">
		<display:table name="${vRpYrCellData2gList}" style = "width: 150%" id="item" requestURI="" pagesize="100" export="false" sort="external" defaultsort="1" >
