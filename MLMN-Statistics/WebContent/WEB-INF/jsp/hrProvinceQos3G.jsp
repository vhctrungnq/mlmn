...
<content tag="heading">QOS PROVINCE 3G ${province} REPORT</content>
<ul class="ui-tabs-nav">
  <li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio3g/province/hr/detail.htm?province=${province}&endDate=${endDate}"><span>Báo cáo giờ</span></a></li>
  <li class=""><a href="${pageContext.request.contextPath}/report/radio3g/province/dy/detail.htm?province=${province}&endDate=${endDate}"><span>Báo cáo ngày</span></a></li>
  ...
  <li class=""><a href="${pageContext.request.contextPath}/report/radio3g/province/mn/bh.htm?province=${province}"><span>Báo cáo BH tháng</span></a></li> --%>
	...
	<br/>
	<div  id="doublescroll">
	<display:table style = "width: 200%" name="${vRpHrProvinceList}" id="vRpHrProvince" requestURI="" pagesize="100" class="simple2" export="true" sort="list">
	    ...
	    <display:column titleKey="Province" media="html"  sortable="true" class="margin"  headerClass="master-header-1 margin" sortProperty="province" style = "width: 120px">
	    	<a href="${pageContext.request.contextPath}/report/radio3g/cell/dy/list.htm?province=${vRpHrProvince.province}&day=<fmt:formatDate pattern="dd/MM/yyyy" value="${vRpHrProvince.day}"/>">${vRpHrProvince.province}</a>
	    </display:column>
	    ...
	    <display:column titleKey="SPEECH_CSSR" class="SPEECH_CSSR" sortable="true" headerClass="master-header-4" media="html" sortProperty="speechCssr">
	    	<a href="${pageContext.request.contextPath}/report/radio3g/province/cssr/hr.htm?province=${vRpHrProvince.province}&endDate=<fmt:formatDate pattern="dd/MM/yyyy" value="${vRpHrProvince.day}"/>">${vRpHrProvince.speechCssr}</a>
	    </display:column>
	    ...
	    <display:column titleKey="SPEECH_DRPR" class="SPEECH_DRPR" sortable="true" headerClass="master-header-5" media="html" sortProperty="speechDrpr">
	    	<a href="${pageContext.request.contextPath}/report/radio3g/province/drop/hr.htm?province=${vRpHrProvince.province}&endDate=<fmt:formatDate pattern="dd/MM/yyyy" value="${vRpHrProvince.day}"/>">${vRpHrProvince.speechDrpr}</a>
	    </display:column>
