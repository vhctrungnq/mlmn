...
<title><fmt:message key="feedback.title.timKiemBaoCaoXLPATN"/></title>
<content tag="heading"><fmt:message key="feedback.title.timKiemBaoCaoXLPATN"/></content>
			...
			<td align="left"><form method="post" action="list.htm">
					<table width="100%" border="0" cellspacing="3" cellpadding="0">
						...
						<tr>
							...
							<td colspan="5">
								<input class="wid97" type="text" id="nguyenNhan" name="nguyenNhan" value="${nguyenNhan}" />
							</td>
							<td><spring:message code="qLThongTinPhanAnh.toXuLy"/></td>
							<td>
								<div class="psr ovh select wid90">
									<select name="deptProcess" class="select" id="deptProcess">
										<option value="">--Tất cả--</option>
		...
		<tr>
			<td colspan="2">
				...
				<div style="width:100%;overflow:auto; ">
					<div style="width:100%;overflow:auto; ">
						<display:table name="${bcXuLyPATheoNgayList}" class="simple2" id="item" requestURI="" pagesize="50" sort="external" defaultsort="1" decorator="subtotaler" export="true">
							<display:column property="abbreviated" titleKey="qLThongTinPhanAnh.toXuLy" total="true" group="1" style="border:0;border-left:1px solid #ddd;max-width:200px;word-wrap:break-word;" />
