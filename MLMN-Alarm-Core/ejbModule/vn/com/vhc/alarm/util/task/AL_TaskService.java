 ...
 * @author thangqm
 */
public abstract class AL_TaskService {
    private static Logger logger =
        Logger.getLogger(AL_TaskService.class.getName());

    private ExecutorService threadPool;
    private BlockingQueue<AL_TaskInfo> inputQueue;
    ...
    private List<AL_TaskInfo> initQueue = new ArrayList<AL_TaskInfo>();
    private List<String> currentTaskInfos =
        Collections.synchronizedList(new ArrayList<String>());

    public AL_TaskService(String name) {
	...
	public final void processTasks() {
        try {
            ...
            inputQueue = new ArrayBlockingQueue<AL_TaskInfo>(totalTasks);
     ...
     */
    public abstract void doTask(AL_TaskInfo input);
    ...
    public final void addTask(AL_TaskInfo info) {
        initQueue.add(info);
    }

    public final void retryTask(AL_TaskInfo info) throws AL_IllegalServiceStateException {
        if (inputQueue != null) {
            inputQueue.add(info);
            increaseRetryTasks();
        } else {
            throw new AL_IllegalServiceStateException("Service not initialized");
        }
    }
