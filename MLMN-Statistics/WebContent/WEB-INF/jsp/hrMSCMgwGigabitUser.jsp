...
<content tag="heading">MSC MGW GIGABIT USER ETHERNET STS DATA HOURLY REPORT</content>
...
<div  id="doublescroll">
		<display:table name="${HrMscgigabituser}" id="HrMscgigabituser" requestURI="" pagesize="100" class="simple3" export="true">
