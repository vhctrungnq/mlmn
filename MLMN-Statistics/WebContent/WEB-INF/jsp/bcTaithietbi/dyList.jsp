...
<ul class="ui-tabs-nav">
	...
	<li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/taithietbi/dy.htm?type=${type}"><span>Báo cáo ngày</span></a></li>
...
<br>
	<form method="post" action="dy.htm?type=${type}">
...
<div  style="overflow: auto;">
	<display:table name="${dataList}" id="item" requestURI="" pagesize="100" class="simple2" export="true">
			<display:column property="day" format="{0,date,dd/MM/yyyy}" title="Ngày" sortName="day" sortable="true" headerClass="master-header-1 margin" class="margin"/>
