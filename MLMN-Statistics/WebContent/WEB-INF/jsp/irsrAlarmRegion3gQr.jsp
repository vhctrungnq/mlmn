...
<content tag="heading">REGION IRSR 3G QUARTER LIST</content>
<ul class="ui-tabs-nav">
	...
	<li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio3g/irsr/by-region/qr/list.htm"><span>IRSR by Center</span></a></li>
</ul>
<div class="ui-tabs-panel">
	...
	<div  style="overflow: auto;">
		<display:table name="${qrIrsrAlarmRegion3gList}" id="qrIrsrAlarmRegion3g" requestURI="" pagesize="100" class="simple3" export="true">		
