...
<content tag="heading">MSC CALL SETUP SUCCESS DAILY REPORT ${mscid}</content>
<ul class="ui-tabs-nav">
  ...
  <li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/core-era/call-setup-success/dy/detail.htm?mscid=${mscid}&startDate=${startDate}&endDate=${endDate}"><span>Báo cáo ngày</span></a></li>
</ul>
...
<div  style="overflow: auto;width: 100%;">
		<display:table name="${dyMscCallSetupBcdetail}" id="dyMscCallSetupBcdetail" requestURI="" pagesize="100" class="simple3" export="true">
			<display:column property ="mscid" titleKey="MSC" class="hide" headerClass="hide"/>
			<display:column titleKey="MSC" media="html">
			    	<a href="${pageContext.request.contextPath}/report/core-era/call-setup-success/hr/detail.htm?mscid=${dyMscCallSetupBcdetail.mscid}&startDate=<fmt:formatDate pattern="dd/MM/yyyy" value="${dyMscCallSetupBcdetail.day}"/>&endDate=<fmt:formatDate pattern="dd/MM/yyyy" value="${dyMscCallSetupBcdetail.day}"/>">${dyMscCallSetupBcdetail.mscid}</a>
			</display:column>
