...
<content tag="heading">NO TRAFFIC BSC GPRS HOURLY REPORT</content>

<ul class="ui-tabs-nav">
  <li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio/bsc-gprs-no-traff/hr/list.htm?bscid=${bsc.bscid}&startHour=${startHour}&startDate=${startDate}&endHour=${endHour}&endDate=${endDate}"><span>Báo cáo giờ</span></a></li>
  <li class=""><a href="${pageContext.request.contextPath}/report/radio/bsc-gprs-no-traff/dy/list.htm?bscid=${bsc.bscid}"><span>Báo cáo ngày</span></a></li>
	...
	<form:form method="post" commandName="filter" action="list.htm" name = "frmSample" onSubmit = "return ValidateForm()">
		<table width="100%" class="form">
			<tr>
			    <td align="left">
				 BSC
					<select name="bscid" id="bscid" onchage="xl()">
