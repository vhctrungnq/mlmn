...
<content tag="heading">MSC SMS DAILY REPORT</content>
 
<ul class="ui-tabs-nav">
  <li class=""><a href="${pageContext.request.contextPath}/report/core-era/msc-sms/hr.htm?mscid=${msc.mscid}&startDate=${startDate}&endDate=${endDate}"><span>Báo cáo giờ</span></a></li>
  <li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/core-era/msc-sms/dy.htm?mscid=${msc.mscid}&startDate=${startDate}&endDate=${endDate}"><span>Báo cáo ngày</span></a></li>
</ul>
...
<div  id="doublescroll">
		<display:table name="${dyMSCSMS}" id="dyMSCSMS" requestURI="" pagesize="100" class="simple3" export="true">
		    <display:column property="mscid" titleKey="SYSTEM" headerClass="hide" class="hide"/>
		    <display:column title="SYSTEM" media="html">
		   	 	<a href="${pageContext.request.contextPath}/report/core-era/msc-sms/hr.htm?mscid=${dyMSCSMS.mscid}&startDate=<fmt:formatDate pattern="dd/MM/yyyy" value="${dyMSCSMS.day}"/>&endDate=<fmt:formatDate pattern="dd/MM/yyyy" value="${dyMSCSMS.day}"/>">${dyMSCSMS.mscid}</a>
		    </display:column>
		    <display:column property ="day" format="{0,date,dd/MM/yyyy}" titleKey="Day" />
		    <display:column property="termReceivedReq" titleKey="Request mobile terminate SMS-MSs recived MSC/VRL Server"/>
		    <display:column property="termSmsSent" titleKey="Mobile terminate SMS sent CM layer-MSs MSC/VLR server"/>
		    <display:column property="termSmsTransCmSucc" titleKey="Sucessful terminate SMS tranferred on CMlayer-MSs MSC/VLR Server"/>
		    <display:column property="termSmsTransSmSucc" titleKey="Sucessful terminate SMS tranferred on SM-RLlayer-MSs MSC/VLR Server"/>
		    <display:column property="termSmsSucc" titleKey="Succ SMS TERM (%)"/>
		    <display:column property="termMscSmsSucc" titleKey="Succ SMS TERM_MSC(%)"/>
		    <display:column property="termMscSentSmsSucc" titleKey="Succ SMS TERM send sms (%)"/>
		</display:table>
	</div>
