...
<style type="text/css">    #doublescroll { overflow: auto; overflow-y: hidden; }    #doublescroll p { margin: 0; padding: 1em; white-space: nowrap; }</style><title>province speech cssr hourly report</title>
<content tag="heading">SPEECH CSSR PROVINCE ${province}</content>
<ul class="ui-tabs-nav">
  <li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio3g/province/cssr/hr.htm?province=${province}&endDate=${endDate}"><span>Báo cáo giờ</span></a></li>
  <li class=""><a href="${pageContext.request.contextPath}/report/radio3g/province/cssr/dy.htm?province=${province}&endDate=${endDate}"><span>Báo cáo ngày</span></a></li>
</ul>
	...
	<div  id="doublescroll">
	<display:table name="${hrProvinceCssrDeta3G}" id="hrProvinceCssrDeta3G" requestURI="" pagesize="100" class="simple5" export="true">
	    ...
	    <display:column titleKey="Hour" sortable="true" class="margin" headerClass="master-header-1 margin" sortProperty="hour">
	    	${hrProvinceCssrDeta3G.hour}:00
	    </display:column>
