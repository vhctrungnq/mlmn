...
<title>Báo cáo BW link truyền dẫn tuần</title>
<content tag="heading">Báo cáo BW link truyền dẫn tuần</content>
...
<ul class="ui-tabs-nav">
	...
	<li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/core/ipbb-link/wk-link.htm"><span>Báo cáo tuần</span></a></li>
...
<br>
<form method="get" action="wk-link.htm">
		...
		<tr>
			<td align="left">
               ...
               &nbsp;&nbsp;Link 
		        ...
		        &nbsp;&nbsp;Từ tuần <input value="${startWeek}" name="startWeek" id="startWeek" maxlength="2" class="wid3">
		        &nbsp;năm <input value="${startYear}" name="startYear" id="startYear" maxlength="4" class="wid5">
		        
                &nbsp;&nbsp;đến tuần <input value="${endWeek}" name="endWeek" id="endWeek" maxlength="2" class="wid3">
...
<div  style="overflow: auto;" class="wid100" >
	<display:table name="${weekList}" id="weekList" requestURI="" pagesize="100" class="simple2" export="true">
			<display:column property="year" titleKey="year" sortName="year" sortable="true" headerClass="master-header-1"/>
			<display:column property="week" titleKey="week" sortName="week" sortable="true" headerClass="master-header-1 margin" class="margin"/>
