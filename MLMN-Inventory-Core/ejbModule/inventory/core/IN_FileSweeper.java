...
public class IN_FileSweeper {
    private static Logger logger =
        Logger.getLogger(IN_FileSweeper.class.getName());
    private long backupDay;
    private File rootDir;

    public IN_FileSweeper(String rootDir, long backupDay) throws IOException {
    ...
    public static void main(String[] args) throws IOException {
        new IN_FileSweeper("H:\\Temp\\test.txt", 30).doSweep();
    }
