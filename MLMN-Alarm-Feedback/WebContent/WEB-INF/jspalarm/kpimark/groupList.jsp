...
<ul class="ui-tabs-nav">
	...
	<li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/alarm/kpi-mark-group/list.htm"><span><fmt:message key="kpismark.title.group"/></span></a></li>
					...
					<table border="0" cellspacing="1" cellpadding="0" width="100%">
						<tr> 
							...
							<td>
								...
								<td align="right"><input type="button" value="<fmt:message key="global.button.import"/>" id='importFile' /></td>
						</tr>				
					</table>
				</form:form>
			</td>
...
<script type="text/javascript">
	...
	$('#Menu').on('itemclick', function (event) {
		...
		if ($.trim($(args).text()) == '<fmt:message key="global.button.exportExcel"/>') {
				window.open('${pageContext.request.contextPath}/alarm/kpi-mark-group/exportData.htm?startDate='+"<c:out value='${startDate}'/>"+
  ...
  //call view detail   
    ...
    var sitelevel = 0; 
    var shiftTime = ''; 
    if(columnindex % 3 == 0 && columnindex > 3)
    {
    	if(columnindex % 9 == 6)
        {
    		sitelevel = 1;
    	...
    	if(row.teamGroups!=null)
    	{
    		group=row.teamGroups;
    	} 
    	window.open('${pageContext.request.contextPath}/alarm/kpi-mark-detail/list.htm?team='+team+ '&group='+group+ '&startDate='+startDate+ '&endDate='+endDate+ '&siteLevel='+sitelevel+ '&shiftTime='+shiftTime ,'_blank');
