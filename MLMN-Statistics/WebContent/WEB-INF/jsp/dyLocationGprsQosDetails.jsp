...
<title>location gprs qos daily report</title>
...
<ul class="ui-tabs-nav">
  ...
  <li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio/location-gprs-qos/dy/details.htm?location=${location}&endDate=${endDate}"><span>Báo cáo ngày</span></a></li>
...
<display:table name="${vRpDyLocationGprsQosDetails}" id="vRpDyLocationGprsQosDetail" requestURI="" pagesize="100" class="simple2" export="true">
	...
	$(function() {
		...
		$( '.checkAll' ).live( 'change', function() {
			...
			if($( this ).is( ':checked' )){
				for (var i=4;i<=12;i++)
				{
					$('#vRpDyLocationGprsQosDetail td:nth-child('+i+'),#vRpDyLocationGprsQosDetail th:nth-child('+i+')').show();
				}
			} else {
				for (var i=4;i<=12;i++)
				{
					$('#vRpDyLocationGprsQosDetail td:nth-child('+i+'),#vRpDyLocationGprsQosDetail th:nth-child('+i+')').hide();
				}
			}
		});
