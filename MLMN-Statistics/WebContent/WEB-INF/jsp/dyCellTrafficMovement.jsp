...
<content tag="heading">CELL UNSTABLE TRAFFIC</content>
<ul class="ui-tabs-nav">
   <li class="${hr }"><a href="${pageContext.request.contextPath}/report/radio/cell/traffic-movment/hr.htm"><span>Báo cáo giờ</span></a></li>
   <li class="${dy }"><a href="${pageContext.request.contextPath}/report/radio/cell/traffic-movment/dy.htm"><span>Báo cáo ngày</span></a></li>
</ul>
	...
	<div id="doublescroll">
		<display:table name="${cellMovementList}" id="cellMovementList" requestURI="" pagesize="100" class="simple2" export="true">
			    ...
			    <display:column titleKey="CELLID"  headerClass="master-header-1 margin" media="html" sortable="true" class="margin" sortName="cellid">
			    	<a href="${pageContext.request.contextPath}/report/radio/cell/traffic-movment/hr.htm?cellid=${cellMovementList.cellid}&bscid=${cellMovementList.bscid}&startDate=<fmt:formatDate pattern="dd/MM/yyyy" value="${cellMovementList.day}"/>">${cellMovementList.cellid}</a>
			    </display:column>
			    <display:column property ="tDef" titleKey="T_DEF" headerClass="master-header-2"  class="rightColumnMana" sortable="true"/>
			    <display:column property="tAvail" titleKey="T_AVAIL" class="rightColumnMana" headerClass="master-header-2" sortable="true"/>
