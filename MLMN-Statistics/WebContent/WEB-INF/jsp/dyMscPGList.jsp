...
<content tag="heading">MSC PAGING DAILY REPORT</content>

<ul class="ui-tabs-nav">
  <li class=""><a href="${pageContext.request.contextPath}/report/core-era/msc-pag-glo/hr.htm?mscid=${msc.mscid}&startDate=${startDate}&endDate=${endDate}"><span>Báo cáo giờ</span></a></li>
  <li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/core-era/msc-pag-glo/dy.htm?mscid=${msc.mscid}&startDate=${startDate}&endDate=${endDate}"><span>Báo cáo ngày</span></a></li>
</ul>
...
<div  style=" overflow-x: auto;overflow-y: hidden;">
		<display:table name="${dyMSCPG}" id="dyMSCPG" requestURI="" pagesize="100" class="simple3" export="true">
		     <display:column property="mscid" titleKey="SYSTEM" headerClass="hide" class="hide"/>
		     <display:column title="SYSTEM" media="html">
		   	 	<a href="${pageContext.request.contextPath}/report/core-era/msc-pag-glo/hr.htm?mscid=${dyMSCPG.mscid}&startDate=<fmt:formatDate pattern="dd/MM/yyyy" value="${dyMSCPG.day}"/>&endDate=<fmt:formatDate pattern="dd/MM/yyyy" value="${dyMSCPG.day}"/>">${dyMSCPG.mscid}</a>
		    </display:column>
...
<table style="width: 99%">
  <tr>
    <td><div id="chartGSM" style="width: 100%; margin: 1em auto"></div></td>
  </tr>
  <tr>
    <td><div id="chartWDCA" style="width: 100%; margin: 1em auto"></div></td>
  </tr>
</table>
