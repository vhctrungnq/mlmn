...
<content tag="heading">RNC QOS 3G MONTHLY REPORT</content>
<ul class="ui-tabs-nav">
	...
	<li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio3g/rnc/mn/list.htm"><span>Báo cáo tháng</span></a></li>
...
<display:table name="${vRpMnBsc}" id="vRpMnBsc" requestURI="" pagesize="100" class="simple2" export="true">
	    ...
	    <display:column titleKey="RNC" media="html" sortable="true" headerClass="master-header-1" sortProperty="bscid">
	    	<a href="${pageContext.request.contextPath}/report/radio3g/rnc/mn/detail.htm?bscid=${vRpMnBsc.bscid}&endMonth=${vRpMnBsc.month}&endYear=${vRpMnBsc.year}">${vRpMnBsc.bscid}</a>
	    </display:column>
	    ...
	    <display:column titleKey="Cells" media="html" sortable="true" headerClass="master-header-1 margin" class="margin" sortProperty="cells">
	    	<a href="${pageContext.request.contextPath}/report/radio3g/cell/mn/list.htm?bscid=${vRpMnBsc.bscid}&month=${vRpMnBsc.month}&year=${vRpMnBsc.year}"><fmt:formatNumber pattern="#,###,###,##0.##" value="${vRpMnBsc.cells}"/></a>
	    </display:column>
