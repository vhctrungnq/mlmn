...
<content tag="heading">GPRS CS DISTRICT MONTHLY REPORT ${district}/${province}</content>
<ul class="ui-tabs-nav">
  ...
  <li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio/district-gprs-cs/mn/details.htm?province=${province}&district=${district}&endMonth=${endMonth}&endYear=${endYear}"><span>Báo cáo tháng</span></a></li>
  ...
  <li class=""><a href="${pageContext.request.contextPath}/report/radio/district-gprs-cs/mn/bhDetails.htm?province=${province}&district=${district}&endMonth=${endMonth}&endYear=${endYear}"><span>Báo cáo BH tháng</span></a></li>
</ul>
<div class="ui-tabs-panel">
	...
	<br/>
	<div  id="doublescroll">
<display:table name="${vRpMnDistrictGprsCsDetails}" id="vRpMnDistrictGprsCsDetail" requestURI="" pagesize="100" class="simple2" export="true">
	    ...
	    <display:column titleKey="PROVINCE" media="html">
	    	<a href="${pageContext.request.contextPath}/report/radio/province-gprs-cs/mn/details.htm?province=${vRpMnDistrictGprsCsDetail.province}&endMonth=${vRpMnDistrictGprsCsDetail.month}&endYear=${vRpMnDistrictGprsCsDetail.year}">${vRpMnDistrictGprsCsDetail.province}</a>&nbsp;
	    </display:column>
	    ...
	    <display:column titleKey="DISTRICT" media="html">
	    	<a href="${pageContext.request.contextPath}/report/radio/district-gprs-cs/mn/details.htm?province=${vRpMnDistrictGprsCsDetail.province}&district=${vRpMnDistrictGprsCsDetail.district}&endMonth=${vRpMnDistrictGprsCsDetail.month}&endYear=${vRpMnDistrictGprsCsDetail.year}">${vRpMnDistrictGprsCsDetail.district}</a>&nbsp;
	    </display:column>
	...
	$(function() {
		$( '.checkAll' ).live( 'change', function() {
			...
			if($( this ).is( ':checked' )){
				for (var i=8;i<=21;i++)
				{
					$('#vRpMnDistrictGprsCsDetail td:nth-child('+i+'),#vRpMnDistrictGprsCsDetail th:nth-child('+i+')').show();
				}
			} else {
				for (var i=8;i<=21;i++)
				{
					$('#vRpMnDistrictGprsCsDetail td:nth-child('+i+'),#vRpMnDistrictGprsCsDetail th:nth-child('+i+')').hide();
				}
			}
		});
