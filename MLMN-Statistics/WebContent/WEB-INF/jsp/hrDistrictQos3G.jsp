...
<content tag="heading">DISTRICT QOS 3G ${district}/${province} REPORT</content>
<ul class="ui-tabs-nav">
  <li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio3g/district/hr/detail.htm?province=${province}&district=${district}&endDate=${endDate}"><span>Báo cáo giờ</span></a></li>
  <li class=""><a href="${pageContext.request.contextPath}/report/radio3g/district/dy/detail.htm?province=${province}&district=${district}&endDate=${endDate}"><span>Báo cáo ngày</span></a></li>
  ...
  <li class=""><a href="${pageContext.request.contextPath}/report/radio3g/district/mn/bh.htm?province=${province}&district=${district}"><span>Báo cáo BH tháng</span></a></li> --%>
	...
	<br/>
		...
		<br/>
			<div  id="doublescroll">
<display:table style = "width: 200%" name="${vRpHrDistrictList}" id="vRpHrDistrict" requestURI="" pagesize="100" class="simple2" export="true" sort="list">
			    ...
			    <display:column title="Province" media="html" sortable="true" headerClass="master-header-1 margin" class="margin" sortProperty="province" style = "width: 120px">
			    	<a href="${pageContext.request.contextPath}/report/radio3g/province/hr/detail.htm?province=${vRpHrDistrict.province}&endDate=<fmt:formatDate pattern="dd/MM/yyyy" value="${vRpHrDistrict.day}"/>">${vRpHrDistrict.province}</a>
			    </display:column>
			    <display:column property="district" title="District" class="margin" headerClass="master-header-1" sortable="true" style = "width: 120px"/>
