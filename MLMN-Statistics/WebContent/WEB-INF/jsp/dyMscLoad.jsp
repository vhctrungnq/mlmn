...
<content tag="heading">MSC LOAD ${title} REPORT</content>
...
<%-- 		    <display:column class="rightColumnMana"   decorator="vn.com.vhc.vmsc2.statistics.web.utils.NumberDecorator" property ="bhca"  titleKey="BHCA"  sortable="true" />
			<display:column class="rightColumnMana"   decorator="vn.com.vhc.vmsc2.statistics.web.utils.NumberDecorator" property ="bhcaPercent"  titleKey="BHCA Percent"  sortable="true" />
			<display:column class="rightColumnMana"   decorator="vn.com.vhc.vmsc2.statistics.web.utils.NumberDecorator" property ="vlrsubs"  titleKey="VLR subs"  sortable="true" />
			<display:column class="rightColumnMana"   decorator="vn.com.vhc.vmsc2.statistics.web.utils.NumberDecorator" property ="vlrsubsPercent"  titleKey="VLR subs Percent"  sortable="true" /> --%>
			<c:if test="${level == 'dy'}">
			...
			<c:if test="${level != 'hr'}">
			<display:column class="rightColumnMana"   decorator="vn.com.vhc.vmsc2.statistics.web.utils.NumberDecorator" property ="bhLoad"  titleKey="BH Load (%)"  sortable="true" headerClass="master-header-4"/>
