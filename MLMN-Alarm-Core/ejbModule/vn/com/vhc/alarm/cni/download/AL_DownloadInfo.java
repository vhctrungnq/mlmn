...
public  class AL_DownloadInfo extends AL_TaskInfo  implements AL_DBDownloadParam  {
	private Integer id;
	...
	public AL_DownloadInfo() {
		this.messageCode = "VMS-0300"; // convert success
	}

	public AL_DownloadInfo(int id, String ne, String ipAddress,
