...
<ul class="ui-tabs-nav">
  ...
  <li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio/district-gprs-cs/wk/details.htm?province=${province}&district=${district}&endWeek=${endWeek}&endYear=${endYear}"><span>Báo cáo tuần</span></a></li>
  ...
  <li class=""><a href="${pageContext.request.contextPath}/report/radio/district-gprs-cs/wk/bhDetails.htm?province=${province}&district=${district}&endWeek=${endWeek}&endYear=${endYear}"><span>Báo cáo BH tuần</span></a></li>
...
<div class="ui-tabs-panel">
	...
	<br/>
   	<div  id="doublescroll">
<display:table name="${vRpWkDistrictGprsCsDetails}" id="vRpWkDistrictGprsCsDetail" requestURI="" pagesize="100" class="simple2" export="true">
	    ...
	    <display:column titleKey="PROVINCE" media="html">
	    	<a href="${pageContext.request.contextPath}/report/radio/province-gprs-cs/wk/bhDetails.htm?province=${vRpWkDistrictGprsCsDetail.province}&endWeek=${week}&endYear=${year}">${vRpWkDistrictGprsCsDetail.province}</a>&nbsp;
	    </display:column>
	    ...
	    <display:column titleKey="DISTRICT" media="html">
	    	<a href="${pageContext.request.contextPath}/report/radio/district-gprs-cs/wk/details.htm?province=${vRpWkDistrictGprsCsDetail.province}&district=${vRpWkDistrictGprsCsDetail.district}&endWeek=${week}&endYear=${year}">${vRpWkDistrictGprsCsDetail.district}</a>&nbsp;
	    </display:column>
	...
	$(function() {
		$( '.checkAll' ).live( 'change', function() {
			...
			if($( this ).is( ':checked' )){
				for (var i=8;i<=21;i++)
				{
					$('#vRpWkDistrictGprsCsDetail td:nth-child('+i+'),#vRpWkDistrictGprsCsDetail th:nth-child('+i+')').show();
				}
			} else {
				for (var i=8;i<=21;i++)
				{
					$('#vRpWkDistrictGprsCsDetail td:nth-child('+i+'),#vRpWkDistrictGprsCsDetail th:nth-child('+i+')').hide();
				}
			}
		});
