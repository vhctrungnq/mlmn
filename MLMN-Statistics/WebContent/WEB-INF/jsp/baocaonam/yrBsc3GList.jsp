...
<content tag="heading">RNC QOS 3G YEARLY REPORT</content>
<ul class="ui-tabs-nav">
	...
	<li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio3g/rnc/yr/list.htm"><span>Báo cáo năm</span></a></li>
</ul>
...
<div  style="overflow: auto;" class="tableStandar" id = "doublescroll">
	<display:table name="${vRpYrBsc3GList}" id="item" requestURI="" pagesize="100" class="simple2" export="true">
