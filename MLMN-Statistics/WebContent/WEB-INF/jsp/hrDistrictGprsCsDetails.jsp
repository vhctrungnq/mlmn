...
<title>district gprs cs hourly report</title>
<content tag="heading">GPRS-CS DISTRICT ${district}/${province} REPORT</content>
<ul class="ui-tabs-nav">
  <li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio/district-gprs-cs/hr/details.htm?province=${province}&district=${district}&endDate=${endDate}"><span>Báo cáo giờ</span></a></li>
  ...
  <li class=""><a href="${pageContext.request.contextPath}/report/radio/district-gprs-cs/mn/bhDetails.htm?province=${province}&district=${district}"><span>Báo cáo BH tháng</span></a></li>
        ...
        <tr>
			<td align="left">
				...
				<% 
					...
					String[]  districtGprsCsNameArray = {"csxLevel1","csxLevel2","csxLevel3","csxLevel4","mcsxLevel1","mcsxLevel2","mcsxLevel3","mcsxLevel4","mcsxLevel5","mcsxLevel6","mcsxLevel7","mcsxLevel8","mcsxLevel9"};
					int i;
	...
	<br/>
	<div  id="doublescroll">
<display:table style = "width: 150%" name="${vRpHrDistrictGprsCsDetails}" id="vRpHrDistrictGprsCsDetail" requestURI="" pagesize="100" class="simple2" export="true">
		<display:column property="day" format="{0,date,dd/MM/yyyy}" titleKey="DAY"/>
	    <display:column titleKey="HOUR">
	    	${vRpHrDistrictGprsCsDetail.hour}:00
	    </display:column>
		<display:column property="region" titleKey="TT"/>
	    <display:column property="district" titleKey="DISTRICT" style = "width: 120px"/>
	    <display:column property="province" titleKey="PROVINCE" style = "width: 120px"/> 
	...
	$(function() {
		...
		$( '.checkAll' ).live( 'change', function() {
			...
			if($( this ).is( ':checked' )){
				for (var i=6;i<=18;i++)
				{
					$('#vRpHrDistrictGprsCsDetail td:nth-child('+i+'),#vRpHrDistrictGprsCsDetail th:nth-child('+i+')').show();
				}
			} else {
				for (var i=6;i<=18;i++)
				{
					$('#vRpHrDistrictGprsCsDetail td:nth-child('+i+'),#vRpHrDistrictGprsCsDetail th:nth-child('+i+')').hide();
				}
			}
		});
