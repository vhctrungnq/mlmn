...
<content tag="heading">GPRS-QOS PROVINCE MONTHLY ${province}</content>
<ul class="ui-tabs-nav">
  ...
  <li class=""><a href="${pageContext.request.contextPath}/report/radio/province-gprs-qos/mn/details.htm?province=${province}&endMonth=${endMonth}&endYear=${endYear}"><span>Báo cáo tháng</span></a></li>
  ...
  <li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio/province-gprs-qos/mn/bhDetails.htm?province=${province}&endMonth=${endMonth}&endYear=${endYear}"><span>Báo cáo BH tháng</span></a></li>
</ul>
<div class="ui-tabs-panel">
	  <form method="get" action="bhDetails.htm" name = "frmSample" onSubmit="return ValidateFormYear()">
...
<display:table name="${vRpMnProvinceGprsQosBhDetails}" id="vRpMnProvinceGprsQosBhDetail" requestURI="" pagesize="100" class="simple2" export="true">
	    ...
	    <display:column titleKey="PROVINCE" media="html">
	    	<a href="${pageContext.request.contextPath}/report/radio/province-gprs-qos/mn/bhDetails.htm?province=${vRpMnProvinceGprsQosBhDetail.province}&endMonth=${vRpMnProvinceGprsQosBhDetail.month}&endYear=${vRpMnProvinceGprsQosBhDetail.year}">${vRpMnProvinceGprsQosBhDetail.province}</a>&nbsp;
	    </display:column>
	...
	$(function() {
		$( '.checkAll' ).live( 'change', function() {
			...
			if($( this ).is( ':checked' )){
				for (var i=6;i<=13;i++)
				{
					$('#vRpMnProvinceGprsQosBhDetail td:nth-child('+i+'),#vRpMnProvinceGprsQosBhDetail th:nth-child('+i+')').show();
				}
			} else {
				for (var i=6;i<=13;i++)
				{
					$('#vRpMnProvinceGprsQosBhDetail td:nth-child('+i+'),#vRpMnProvinceGprsQosBhDetail th:nth-child('+i+')').hide();
				}
			}
		});
