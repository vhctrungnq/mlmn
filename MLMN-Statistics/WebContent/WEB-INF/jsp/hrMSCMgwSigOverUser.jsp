...
<content tag="heading">MSC MGW SIGNALLING OVER USER STS DATA HOURLY REPORT</content>
...
<div  id="doublescroll">
		<display:table name="${HrMscsigoveruser}" id="HrMscsigoveruser" requestURI="" pagesize="100" class="simple3" export="true">
