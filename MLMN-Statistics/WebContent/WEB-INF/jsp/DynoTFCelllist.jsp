...
<ul class="ui-tabs-nav">
  <li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio/bad-cell/Notraffic/dy.htm?bscid=${bsc.bscid}&cellid=${cell.cellid}&startDate=${startDate}&endDate=${endDate}"><span>Báo cáo ngày</span></a></li>
...
<div class="ui-tabs-panel">
 <form:form commandName="filterno" method="post" action="dy.htm" name = "frmSample" onSubmit = "return ValidateForm()">
