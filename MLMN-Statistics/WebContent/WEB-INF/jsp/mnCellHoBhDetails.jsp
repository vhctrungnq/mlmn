...
<content tag="heading">CELL HANDOVE MONTHLY REPORT ${cellid}</content>
<ul class="ui-tabs-nav">
  ...
  <li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio/cell-ho/mn/bhDetails.htm?bscid=${bscid}&cellid=${cellid}"><span>Báo cáo BH tháng</span></a></li>
</ul>
...
<display:table name="${vRpMnCellHoBhDetails}" id="vRpMnCellHoBhDetail" requestURI="" pagesize="100" class="simple2" export="true">
	...
	$(function() {
		$( '.checkAll' ).live( 'change', function() {
			...
			if($( this ).is( ':checked' )){
				for (var i=5;i<=8;i++)
				{
					$('#vRpMnCellHoBhDetail td:nth-child('+i+'),#vRpMnCellHoBhDetail th:nth-child('+i+')').show();
				}
			} else {
				for (var i=5;i<=8;i++)
				{
					$('#vRpMnCellHoBhDetail td:nth-child('+i+'),#vRpMnCellHoBhDetail th:nth-child('+i+')').hide();
				}
			}
		});
