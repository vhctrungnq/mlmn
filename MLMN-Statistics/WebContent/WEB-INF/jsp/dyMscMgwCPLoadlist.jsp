...
<content tag="heading">MSC MGW PROCCESSOR LOAD STS DATA DAILY REPORT</content>
 
<ul class="ui-tabs-nav">
  <li class=""><a href="${pageContext.request.contextPath}/report/core/processor-load/hr.htm?mscid=${msc.mscid}&startDate=${startDate}&endDate=${endDate}"><span>Báo cáo giờ</span></a></li>
  <li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/core/processor-load/dy.htm?mscid=${msc.mscid}&startDate=${startDate}&endDate=${endDate}"><span>Báo cáo ngày</span></a></li>
</ul>
...
<div  id="doublescroll">
		<display:table name="${vRpDyMscMgwCPLoad}" id="vRpDyMscMgwCPLoad" requestURI="" pagesize="100" class="simple3" export="true">
		   <display:column property ="mscid" titleKey="MSC" class="hide" headerClass="hide"/>
		   <display:column title="MSC" media="html">
        		<a href="${pageContext.request.contextPath}/report/core/processor-load/hr.htm?mscid=${vRpDyMscMgwCPLoad.mscid}&startDate=<fmt:formatDate pattern="dd/MM/yyyy" value="${vRpDyMscMgwCPLoad.day}"/>&endDate=<fmt:formatDate pattern="dd/MM/yyyy" value="${vRpDyMscMgwCPLoad.day}"/>">${vRpDyMscMgwCPLoad.mscid}</a>
   			</display:column>
		    <display:column property ="day" format="{0,date,dd/MM/yyyy}" titleKey="DAY" />
		    <display:column property="processorload" titleKey="PROCESSORLOAD"/>
		</display:table>
</div>
<br/>
