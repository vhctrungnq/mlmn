...
<ul class="ui-tabs-nav">
  ...
  <li class=""><a href="${pageContext.request.contextPath}/report/radio/location/mn/detail.htm?location=${location}&endMonth=${endMonth}&endYear=${endYear}"><span>Báo cáo tháng</span></a></li>
  ...
  <li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio/location/mn/bh.htm?location=${location}&endMonth=${endMonth}&endYear=${endYear}"><span>Báo cáo BH tháng</span></a></li>
</ul>
	...
	<display:table name="${vRpMnLocationBhList}" id="vRpMnLocationBh" requestURI="" pagesize="100" class="simple2" export="true">
	...
	$(function() {
		$( '.checkAll' ).live( 'change', function() {
			...
			if($( this ).is( ':checked' )){
				for (var i=5;i<=22;i++)
				{
					$('#vRpMnLocationBh td:nth-child('+i+'),#vRpMnLocationBh th:nth-child('+i+')').show();
				}
			} else {
				for (var i=5;i<=22;i++)
				{
					$('#vRpMnLocationBh td:nth-child('+i+'),#vRpMnLocationBh th:nth-child('+i+')').hide();
				}
			}
		});
