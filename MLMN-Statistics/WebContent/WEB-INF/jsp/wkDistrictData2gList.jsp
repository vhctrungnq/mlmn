...
<content tag="heading">DISTRICT DATA 2G WEEKLY REPORT</content>
<ul class="ui-tabs-nav">
	<li class=""><a href="${pageContext.request.contextPath}/report/radio/district-data/dy/list.htm"><span>Báo cáo ngày</span></a></li>
	<li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio/district-data/wk/list.htm"><span>Báo cáo tuần</span></a></li>
		...
		<div  style="overflow: auto;">
			<display:table name="${vRpWkDistrict}" id="vRpWkDistrict" requestURI="" pagesize="100" class="simple2" export="true" sort="list">
			    ...
			    <display:column titleKey="DISTRICT" media="html" sortable="true" sortProperty="district">
			    	<a href="${pageContext.request.contextPath}/report/radio/district-data/wk/detail.htm?province=${vRpWkDistrict.province}&district=${vRpWkDistrict.district}&endWeek=${vRpWkDistrict.week}&endYear=${vRpWkDistrict.year}">${vRpWkDistrict.district}</a>
			    </display:column>
			    ...
			    <display:column titleKey="CELLS" media="html" sortable="true" sortProperty="cells">
			    	<a href="${pageContext.request.contextPath}/report/radio/cell-data/wk/list.htm?province=${vRpWkDistrict.province}&week=${vRpWkDistrict.week}&year=${vRpWkDistrict.year}"><fmt:formatNumber pattern="#,###,###,##0.##" value="${vRpWkDistrict.cells}"/></a>
			    </display:column>
