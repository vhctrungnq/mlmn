...
<title><fmt:message key="alarmLog3G.title"/></title>
<content tag="heading"><fmt:message key="alarmLog3G.title"/></content>

<div class="ui-tabs-panel">
<form:form commandName="filter" method="post" action="list3g.htm">
<input type="hidden" name="reloadStr" id="reloadStr" value="${reloadStr}">
	...
	<tr>	
		...
		<td><fmt:message key="filter.alarmLog.rncid"/></td>
		<td>
 ...
 <div id = "doublescroll">
	<display:table name="${alarm3GList}" class="simple4" id="alarmList" requestURI="" pagesize="100" sort="external" defaultsort="1" export="true">
		...
		<display:column property="bscid" titleKey="filter.alarmLog.rncid" sortable="true" sortName="BSCID" class="styleBsc"/>
	  	<display:column property="siteCell" titleKey="table.alarmLog.site" sortable="true" sortName="SITE_CELL" class="styleBsc"/> 
...
/*  	$("#bscid").change(function(){
		$.getJSON("${pageContext.request.contextPath}/ajax/getRncByVendor.htm",{team: $(this).val()}, function(j){
 ...
 <script type="text/javascript">
	...
	$("#bscid").change(function(){
		$.getJSON("${pageContext.request.contextPath}/ajax/getSite3GByBsc.htm",{term: $(this).val()}, function(j){
