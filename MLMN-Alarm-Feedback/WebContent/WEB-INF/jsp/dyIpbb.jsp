...
<content tag="heading">BIỂU ĐỒ TẢI IPBB THEO NGÀY</content>
<ul class="ui-tabs-nav">
	<li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/chart/rp/ipbb/dy.htm"><span>Báo cáo ngày</span></a></li>
