...
<style type="text/css">    #doublescroll { overflow: auto; overflow-y: hidden; }    #doublescroll p { margin: 0; padding: 1em; white-space: nowrap; }</style><title>province speech cssr qos</title>
<content tag="heading">PROVINCE SPEED CSSR QoS REPORT</content>
<ul class="ui-tabs-nav">
  <li class=""><a href="${pageContext.request.contextPath}/report/radio3g/province/cssr/hr.htm?province=${province}&endDate=${endDate}"><span>Báo cáo giờ</span></a></li>
  <li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio3g/province/cssr/dy.htm?province=${province}&endDate=${endDate}"><span>Báo cáo ngày</span></a></li>
</ul>
<div class="ui-tabs-panel">
		...
		<div  id="doublescroll">
			<display:table name="${dyProvinceCssrDeta3G}" id="dyProvinceCssrDeta3G" requestURI="" pagesize="100" class="simple5" export="true" sort="list">
			    ...
			    <display:column titleKey="Province" media="html" sortable="true" headerClass="master-header-1" sortProperty="province">
			    	<a href="${pageContext.request.contextPath}/report/radio3g/province/cssr/hr.htm?province=${dyProvinceCssrDeta3G.province}&startDate=<fmt:formatDate pattern="dd/MM/yyyy" value="${dyProvinceCssrDeta3G.day}"/>&endDate=<fmt:formatDate pattern="dd/MM/yyyy" value="${dyProvinceCssrDeta3G.day}"/>">${dyProvinceCssrDeta3G.province}</a>
			    </display:column>
