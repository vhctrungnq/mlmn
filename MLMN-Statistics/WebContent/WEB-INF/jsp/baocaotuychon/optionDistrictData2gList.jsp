...
<title>Báo cáo tùy chọn district data 2g</title>
<content tag="heading">Báo cáo tùy chọn district data 2g</content>
...
<%-- 		<div class="pageSize">
			...
			<display:table name="${optionDistrictData2gList}" class="simple2" id="item" requestURI="" pagesize="100" export="true" >
