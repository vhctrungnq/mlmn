...
<title>Cập nhật thông tin RNC</title>
<content tag="heading">Cập nhật thông tin RNC</content>

<form:form commandName="bsc3g" method="post" action="form.htm">
	<form:hidden path="region" />
	<form:hidden path="launchDate" />
	
    <table class="simple2">
        <tr>
            <td width="200"><b>RNC<font color = "red">(*)</font></b></td>
            <td class = "mwid110">            	
              <c:choose>
                <c:when test="${empty bsc3g.region}">
                    <form:input path="bscid" maxlength="30"/>
                </c:when>
                <c:otherwise>
                    <b><i>${bsc3g.bscid}</i></b><form:hidden path="bscid" />
                </c:otherwise>
              </c:choose>
