...
<title>Báo cáo tùy chọn district qos</title>
<content tag="heading">Báo cáo tùy chọn district qos</content>
...
<%-- 		<div class="pageSize">
			...
			<display:table name="${optionDistrictList}" class="simple2" id="item" requestURI="" pagesize="100" export="true">
