...
<content tag="heading">MSC CHANNEL ASSIGNMENT DAILY REPORT</content>
 
<ul class="ui-tabs-nav">
  <li class=""><a href="${pageContext.request.contextPath}/report/core-era/channel-assig/msc/hr.htm?mscid=${msc.mscid}&startDate=${startDate}&endDate=${endDate}"><span>Báo cáo giờ</span></a></li>
  <li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/core-era/channel-assig/msc/dy.htm?mscid=${msc.mscid}&startDate=${startDate}&endDate=${endDate}"><span>Báo cáo ngày</span></a></li>
</ul>
...
<div  id="doublescroll">
		<display:table name="${dyMSCChanel}" id="dyMSCChanel" requestURI="" pagesize="100" class="simple3" export="true">
		    <display:column property="mscid" titleKey="SYSTEM" headerClass="hide" class="hide"/>
		    <display:column title="SYSTEM" media="html">
		   	 	<a href="${pageContext.request.contextPath}/report/core-era/channel-assig/msc/hr.htm?mscid=${dyMSCChanel.mscid}&startDate=<fmt:formatDate pattern="dd/MM/yyyy" value="${dyMSCChanel.day}"/>&endDate=<fmt:formatDate pattern="dd/MM/yyyy" value="${dyMSCChanel.day}"/>">${dyMSCChanel.mscid}</a>
		    </display:column>
