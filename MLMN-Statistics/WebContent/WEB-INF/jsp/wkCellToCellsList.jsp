...
<title>CELL TO CELLS HADOVER LIST</title>
<content tag="heading">LIST CELL TO CELLS HADOVER FROM ${startWeek}/${startYear} TO ${endWeek}/${endYear}</content>
<ul class="ui-tabs-nav">
	<!-- li class=""><a href="${pageContext.request.contextPath}/report/radio/cell-to-cells/hr/list.htm?bscid=${bscid}&fromCell=${fromCell}"><span>Báo cáo giờ</span></a></li> -->
	<li class=""><a href="${pageContext.request.contextPath}/report/radio/cell-to-cells/dy/list.htm?bscid=${bscid}&fromCell=${fromCell}"><span>Báo cáo ngày</span></a></li>
	<li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio/cell-to-cells/wk/list.htm?bscid=${bscid}&fromCell=${fromCell}"><span>Báo cáo tuần</span></a></li>
...
<div class="ui-tabs-panel">
	...
	<display:table name="${wkCellToCellsQos}" id="wkCellToCells" requestURI="" pagesize="100" class="simple2" export="true" sort="list">
