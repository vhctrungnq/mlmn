...
<form:form method="post" action="upload.htm" enctype="multipart/form-data" >
	...
	<table class="simple2">
		...
		<tr>
				...
				<td colspan="2">
					<ul>
						...
						<li>File mẫu:&nbsp;<a style="color: blue; " title="ImportMappingExample" href="${pageContext.request.contextPath}/upload/ImportMappingExample.xls">ImportMappingExample.xls</a>
						</li>
					</ul>
			</td>
		</tr>
		...
		<div style="width:100%;overflow:auto; ">
				<display:table name="${importMappingList}" class="simple2" id="item" requestURI="">
