...
public class IPBBConverterCacti extends STS_BasicConverter {

    private static Logger logger =
        Logger.getLogger(IPBBConverterCacti.class.getName());
    ...
    public void convertFile(File file, String direcPath,
        ...
        try {
            ...
            String header = "";
            String strFileName = fileName.substring(fileName.indexOf("_")+1, fileName.lastIndexOf(".csv"));
