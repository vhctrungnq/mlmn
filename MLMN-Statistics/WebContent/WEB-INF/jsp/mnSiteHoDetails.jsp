...
<ul class="ui-tabs-nav">
  ...
  <li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio/site-ho/mn/details.htm?bscid=${bscid}&siteid=${siteid}&endMonth=${endMonth}&endYear=${endYear}"><span>Báo cáo tháng</span></a></li>
  ...
  <li class=""><a href="${pageContext.request.contextPath}/report/radio/site-ho/mn/bhDetails.htm?bscid=${bscid}&siteid=${siteid}&endMonth=${endMonth}&endYear=${endYear}"><span>Báo cáo BH tháng</span></a></li>
</ul>
...
<display:table name="${vRpMnSiteHoDetails}" id="vRpMnSiteHoDetail" requestURI="" pagesize="100" class="simple2" export="true">
	...
	$(function() {
		$( '.checkAll' ).live( 'change', function() {
			...
			if($( this ).is( ':checked' )){
				for (var i=6;i<=11;i++)
				{
					$('#vRpMnSiteHoDetail td:nth-child('+i+'),#vRpMnSiteHoDetail th:nth-child('+i+')').show();
				}
			} else {
				for (var i=6;i<=11;i++)
				{
					$('#vRpMnSiteHoDetail td:nth-child('+i+'),#vRpMnSiteHoDetail th:nth-child('+i+')').hide();
				}
			}
		});
