...
<content tag="heading">MSC CALL SETUP SUCCESS HOURLY REPORT ${mscid}</content>
<ul class="ui-tabs-nav">
  <li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/core-era/call-setup-success/hr/detail.htm?mscid=${mscid}&startDate=${startDate}&endDate=${endDate}"><span>Báo cáo giờ</span></a></li>
  <li class=""><a href="${pageContext.request.contextPath}/report/core-era/call-setup-success/dy/detail.htm?mscid=${mscid}&startDate=${startDate}&endDate=${endDate}"><span>Báo cáo ngày</span></a></li>
</ul>
...
<form method="get" action="detail.htm">
		<display:table name="${hrMscCallSetupBc}" id="hrMscCallSetupBc" requestURI="" pagesize="100" class="simple3" export="true">
