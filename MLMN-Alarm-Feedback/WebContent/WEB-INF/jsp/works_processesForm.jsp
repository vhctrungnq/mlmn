...
<c:choose>
  <c:when test="${ProcessesAddEdit == 'Y'}">
      <title><spring:message code="header.title.processesFormAdd"/></title>
	  <content tag="heading"><spring:message code="header.title.processesFormAdd"/></content>
  </c:when>
  <c:when test="${ProcessesAddEdit == 'N'}">
      <title><spring:message code="header.title.processesFormEdit"/></title>
	  <content tag="heading"><spring:message code="header.title.processesFormEdit"/></content>
  </c:when>
  <c:otherwise>
      ...
      <tr>
       ...
       <tr>
           ...
           <td colspan="3">
               ...
               <input class="button" type="button" value="<spring:message code="button.cancel"/>" onClick='window.location="formContentDetails.htm?id=" + ${w_working_processes.idWorks}'>
           </td>
       </tr>
    </table>
