...
<title>Báo cáo tùy chọn province qos 3g </title>
<content tag="heading">Báo cáo tùy chọn province qos 3g</content>
...
<div>
	...
	<div id="doublescroll" style="width:100%">
			<display:table name="${optionProvince3gList}" class="simple2" id="item"  export = "true" requestURI="" pagesize="100">
<%-- 			<display:column property="sdatetime" titleKey="option.cellgprscs.starttime" headerClass="master-header-1"/>
		    ...
		    <display:column property="speechCssr" titleKey="SPEECH_CSSR" sortable="true" />
		    ...
		    <display:column property="speechDrpr" titleKey="SPEECH_DRPR" sortable="true" />
