...
<ul class="ui-tabs-nav">
	...
	<li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/alarm/kpi-mark-team/list.htm"><span><fmt:message key="kpismark.title.team"/></span></a></li>
...
<script type="text/javascript">
	...
	$('#Menu').on('itemclick', function (event) {
		...
		if ($.trim($(args).text()) == '<fmt:message key="global.button.exportExcel"/>') {
				window.open('${pageContext.request.contextPath}/alarm/kpi-mark-team/exportData.htm?startDate='+"<c:out value='${startDate}'/>"+
    ...
    if(columnindex % 3 == 0 && columnindex > 3)
    {
    	...
    	window.open('${pageContext.request.contextPath}/alarm/kpi-mark-detail/list.htm?team='+team+ '&startDate='+startDate+ '&endDate='+endDate+ '&siteLevel='+sitelevel+ '&shiftTime='+shiftTime ,'_blank');
