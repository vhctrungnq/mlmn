...
<ul class="ui-tabs-nav">
  <li class=""><a href="${pageContext.request.contextPath}/report/radio/district/hr/detail.htm?province=${province}&district=${district}&day=${endDate}"><span>Báo cáo giờ</span></a></li>
  ...
  <li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio/district/dy/bh.htm?province=${province}&district=${district}"><span>Báo cáo BH ngày</span></a></li>
  <li class=""><a href="${pageContext.request.contextPath}/report/radio/district/wk/bh.htm?province=${province}&district=${district}&endDate=${endDate}"><span>Báo cáo BH tuần</span></a></li>
  <li class=""><a href="${pageContext.request.contextPath}/report/radio/district/mn/bh.htm?province=${province}&district=${district}"><span>Báo cáo BH tháng</span></a></li>
	...
	<display:table style = "width: 150%" name="${vRpDyDistrictBhList}" id="vRpDyDistrictBh" requestURI="" pagesize="100" class="simple2" export="true">
		<display:column property ="day" format="{0,date,dd/MM/yyyy}" title="DAY"/>
		<display:column title="BH">
			${vRpDyDistrictBh.bh}:00
		</display:column>
	    <display:column property="region" title="TT"/>
	    <display:column property="province" titleKey="PROVINCE" headerClass="hide" class="hide"/>  
		<display:column title="PROVINCE" media="html" style = "width: 120px">
	    	<a href="${pageContext.request.contextPath}/report/radio/province/dy/bh.htm?province=${vRpDyDistrictBh.province}&endDate=<fmt:formatDate pattern="dd/MM/yyyy" value="${vRpDyDistrictBh.day}"/>">${vRpDyDistrictBh.province}</a>
	    </display:column>
	    <display:column property="district" titleKey="DISTRICT" headerClass="hide" class="hide"/>  
	    <display:column title="DISTRICT" media="html" class="margin" headerClass="margin" style = "width: 120px">
	    	<a href="${pageContext.request.contextPath}/report/radio/district/hr/detail.htm?province=${vRpDyDistrictBh.province}&district=${vRpDyDistrictBh.district}&endDate=<fmt:formatDate pattern="dd/MM/yyyy" value="${vRpDyDistrictBh.day}"/>">${vRpDyDistrictBh.district}</a>
	    </display:column>
