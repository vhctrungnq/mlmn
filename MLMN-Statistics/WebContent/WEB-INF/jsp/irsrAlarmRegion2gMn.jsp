...
<content tag="heading">REGION IRSR 2G MONTHLY LIST</content>
<ul class="ui-tabs-nav">
	...
	<li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio/irsr/by-region/mn/list.htm"><span>IRSR by Center</span></a></li>
</ul>
<div class="ui-tabs-panel">
	...
	<a href="${pageContext.request.contextPath}/report/radio/irsr/by-region/qr/list.htm"><span><b>Theo quý</b></span></a>&nbsp;
	...
	<div  style="overflow: auto;">
		<display:table name="${mnIrsrAlarmRegion2gList}" id="mnIrsrAlarmRegion2g" requestURI="" pagesize="100" class="simple3" export="true">		
