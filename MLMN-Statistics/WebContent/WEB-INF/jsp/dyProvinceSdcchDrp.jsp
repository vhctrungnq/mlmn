...
<title>province sdcch drop qos</title>
<content tag="heading">PROVINCE SDCCH DROP QOS REPORT</content>
<ul class="ui-tabs-nav">
  <li class=""><a href="${pageContext.request.contextPath}/report/radio/province/sdrop/hr.htm?province=${province}&endDate=${endDate}"><span>Báo cáo giờ</span></a></li>
  <li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio/province/sdrop/dy.htm?province=${province}&endDate=${endDate}"><span>Báo cáo ngày</span></a></li>
</ul>
<div class="ui-tabs-panel">
		...
		<div style="overflow: auto;">
			<display:table name="${dyProvinceDcrsQos}" id="dyProvinceDcrsQos" requestURI="" pagesize="100" class="simple2" export="true" sort="list">
			    ...
			    <display:column titleKey="PROVINCE" media="html" sortable="true" sortProperty="province">
			    	<a href="${pageContext.request.contextPath}/report/radio/province/sdrop/hr.htm?province=${dyProvinceDcrsQos.province}&startDate=<fmt:formatDate pattern="dd/MM/yyyy" value="${dyProvinceDcrsQos.day}"/>&endDate=<fmt:formatDate pattern="dd/MM/yyyy" value="${dyProvinceDcrsQos.day}"/>">${dyProvinceDcrsQos.province}</a>
			    </display:column>
