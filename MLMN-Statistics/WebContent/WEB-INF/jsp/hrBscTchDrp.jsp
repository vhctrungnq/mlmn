...
<title>bsc tch Drop hourly report</title>
<content tag="heading">TCH DROP BSC ${bscid} REPORT</content>
<ul class="ui-tabs-nav">
  <li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio/bsc/tdrop/hr.htm?bscid=${bscid}&endDate=${endDate}"><span>Báo cáo giờ</span></a></li>
  <li class=""><a href="${pageContext.request.contextPath}/report/radio/bsc/tdrop/dy.htm?bscid=${bscid}&endDate=${endDate}"><span>Báo cáo ngày</span></a></li>
</ul>
...
<display:table name="${hrBscDcrtQosList}" id="hrBscDcrtQos" requestURI="" pagesize="100" class="simple2" export="true">
