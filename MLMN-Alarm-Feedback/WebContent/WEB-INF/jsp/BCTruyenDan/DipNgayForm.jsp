...
<form:form commandName="alDyRpDip" name="checkform" id="myform" method="post" action="form.htm"> 
	<form:hidden path="id"/>
	<input type="hidden" name="type" id="type" value="${type}">
	<table class="simple2"> 
      <tr>
           <td style="width: 120px;"><fmt:message key="alDyRpDip.bscid"/><font color="red">(*)</font></td>
           <td style="width: 200px;">
           		<form:input type ="text" path="bscid" maxlength="18" style="width:160px;" rows="3"/>
           		<font color="red"><form:errors path="bscid"/></font>
           </td>
           <td style="width: 120px;"><fmt:message key="alDyRpDip.dip"/><font color="red">(*)</font></td>
           <td>
      ...
      <tr>
           <td ><fmt:message key="alDyRpDip.day"/><font color="red">(*)</font></td>
           <td >
		...
		<tr>
           <td><fmt:message key="alDyRpDip.teamProcess"/></td>
           <td>
           ...
           <td><fmt:message key="alDyRpDip.userProcess"/></td>
           <td style="border:0;">
           		<select name="userProcess" id="userProcess" multiple="multiple" style="width:160px;"></select>
           </td>
       </tr>
       <tr>
           <td><fmt:message key="alDyRpDip.causebyContent"/></td>
           <td colspan="3"> 
            	<form:input type ="text" path="causebyContent" maxlength="250" style="width:100%;" rows="3" name="causebyContent" id="causebyContent"/>
          </td>
       </tr>
        <tr>
           <td><fmt:message key="alDyRpDip.resultContent"/></td>
           <td colspan="3"> 
           <textarea style="font-family:tahoma;width:100%; font-size:12px;height:30px;" rows="10"  name="resultContent" id="resultContent" maxlength="250" >${alDyRpDip.resultContent}</textarea>	
          </td>
       </tr>
       <tr>
           <td></td>
           <td colspan="3">
               <input type="submit" class="button" value="<fmt:message key="button.save"/>" />
           	   <input type="button" class="button" value="<fmt:message key="button.cancel"/>" onClick='window.location="list.htm?type=${type}"'>
...
<script type="text/javascript">
	$(function(){
		...
		var userProcess = '<c:out value="${alDyRpDip.userProcess}"/>';
		var $widget;
