...
<title>NO SUCCESS BSC GPRS DAILY REPORT</title>
<content tag="heading">NO SUCCESS BSC GPRS DAILY REPORT</content>
...
<ul class="ui-tabs-nav">
  ...
  <li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio/bsc-gprs-no-succ/dy/list.htm?bscid=${bsc.bscid}&startDate=${startDate}&endDate=${endDate}"><span>Báo cáo ngày</span></a></li>
