...
<ul class="ui-tabs-nav">
  <li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio/district-data/hr/detail.htm?province=${province}&district=${district}&endDate=${endDate}"><span>Báo cáo giờ</span></a></li>
  <li class=""><a href="${pageContext.request.contextPath}/report/radio/district-data/dy/detail.htm?province=${province}&district=${district}&endDate=${endDate}"><span>Báo cáo ngày</span></a></li>
	...
	<br/>
		...
		<br/>
			...
			<display:table style = "width: 150%" name="${vRpHrDistrictList}" id="vRpHrDistrict" requestURI="" pagesize="100" class="simple2" export="true" sort="list">
			    ...
			    <display:column property="district" titleKey="DISTRICT" headerClass="master-header-1" sortable="true" style = "width: 120px"/>
