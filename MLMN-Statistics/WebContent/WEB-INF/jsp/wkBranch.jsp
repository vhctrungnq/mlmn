...
<ul class="ui-tabs-nav">
  <li class="ui-tabs-selected"><a href="${pageContext.request.contextPath}/report/radio/branch/traffic/wk.htm?branch=${branch}"><span>Báo cáo tuần</span></a></li>
  <li class=""><a href="${pageContext.request.contextPath}/report/radio/branch/traffic/mn.htm?branch=${branch}"><span>Báo cáo tháng</span></a></li>
</ul>
